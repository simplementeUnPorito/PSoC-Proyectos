...
void efectoArcoiris() {
    ...
    for (int i = 0; i < 255; i++) {
        setRGB(255, i, 0);  // Rojo a amarillo
        CyDelay(DELAY_ARCOIRIS);
    }

    for (int i = 255; i >= 0; i--) {
        setRGB(i, 255, 0);  // Amarillo a verde
        CyDelay(DELAY_ARCOIRIS);
    }

    for (int i = 0; i < 255; i++) {
        setRGB(0, 255, i);  // Verde a cian
        CyDelay(DELAY_ARCOIRIS);
    }

    for (int i = 255; i >= 0; i--) {
        setRGB(0, i, 255);  // Cian a azul
        CyDelay(DELAY_ARCOIRIS);
    }

    for (int i = 0; i < 255; i++) {
        setRGB(i, 0, 255);  // Azul a magenta
        CyDelay(DELAY_ARCOIRIS);
    }

    for (int i = 255; i >= 0; i--) {
        setRGB(255, 0, i);  // Magenta a rojo
        CyDelay(DELAY_ARCOIRIS);
    }
}
...
void updateDisplay(){
    ...
    switch(ventana){
        ...
        case MENU:
            ...
            setRGB(255, 255, 255);  // Cambiar el color a azul
            ...
            case BIEN:
                if(flag.cambio.bit.desensibilizacion== TRUE){
                    switch(flag.config.bit.desensibilizacion){
                        case 0:
                            setRGB(0, 0, 50);  // Color azul oscuro
                            break;
                        case 1:
                            setRGB(0, 0, 255);  // Azul oscuro más brillante
                            break;
                        case 2:
                            setRGB(50, 150, 255);  // Celeste intermedio
                            break;
                        case 3:
                            setRGB(100, 200, 255);  // Celeste brillante
                            break;
                        default:
                            setRGB(150, 220, 255);  // Celeste claro aún más brillante
                            break;
                    ...
                    {
                        case ANGLE:
                            setRGB(255, 255, 0);  // Color azul oscuro
                            break;
                        case PERCENTAGE:
                            setRGB(0, 255, 255);  // Color azul oscuro
                            break;
                    }
                else if(flag.cambio.bit.pot == TRUE)
                {
                    ...
                    {
                        case PERILLA:
                            setRGB(255, 100, 255);  // Color azul oscuro
                            break;
                        #ifdef _3D
                        case _3D:
                    ...
                    setRGB(0, 255, 0);  // Cambiar el color a verde
                break;
            case MAL:
                setRGB(255, 0, 0);  // Cambiar el color a rojo
                break;
            default:
                setRGB(255, 255, 255);  // Cambiar el color a blanco
        }
    }
    else
        setRGB(255, 255, 255);  // Cambiar el color a blanco
