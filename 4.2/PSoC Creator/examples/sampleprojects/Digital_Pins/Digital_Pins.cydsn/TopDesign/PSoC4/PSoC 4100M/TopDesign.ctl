...
-- === RGB LED ===
attribute port_location of OutputPinHW(0) : label is "PORT(0,6)"; -- RED LED
attribute port_location of OutputPinSW(0) : label is "PORT(2,6)"; -- GREEN LED
attribute port_location of REPLACE_WITH_ACTUAL_PIN_NAME(0) : label is "PORT(6,5)"; -- BLUE LED

-- === USER SWITCH ===
attribute port_location of InputPin(0) : label is "PORT(0,7)";