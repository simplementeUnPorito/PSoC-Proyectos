...
#if !defined(CY_THERMOCOUPLE_CALC_`$INSTANCE_NAME`_H)
#define CY_THERMOCOUPLE_CALC_`$INSTANCE_NAME`_H
...
#define     `$INSTANCE_NAME`_IN_NORMALIZATION_VT        (24)
#define     `$INSTANCE_NAME`_IN_NORMALIZATION_TV        (24u)
#define     `$INSTANCE_NAME`_24BIT_SHIFTING             (24u)
#define     `$INSTANCE_NAME`_16BIT_SHIFTING             (16u)
#define     `$INSTANCE_NAME`_8BIT_SHIFTING              (8u)
#define     `$INSTANCE_NAME`_24BIT_CUTTING              (0xFFFFFFlu)
...
#endif /* CY_THERMOCOUPLE_CALC_`$INSTANCE_NAME`_H */
