...
namespace OpAmp_v1_90
{
    ...
    public class CyCustomizer : ICyParamEditHook_v1, ICyDRCProvider_v1
    {
        ...
        const string VerifyPSOC5PowerModeErrMsg = "DRC CHECK: The selected power mode is not supported on PSoC 5. Select 'High Power Mode' instead.";
        ...
        CyCustErr VerifyPowerMode(ICyDRCProviderArgs_v1 drcQuery)
        {
                ...
                if ((drcQuery.DeviceQueryV1.IsPSoC5 == true) && (drcQuery.DeviceQueryV1.ArchFamilyMember == PSOC5A))
                {
                    ...
                    {
                        return new CyCustErr(OpAmp_v1_90.Properties.Resources.VerifyPSOC5PowerModeErrMsg);
                    }
                }
                return CyCustErr.OK;
        }
