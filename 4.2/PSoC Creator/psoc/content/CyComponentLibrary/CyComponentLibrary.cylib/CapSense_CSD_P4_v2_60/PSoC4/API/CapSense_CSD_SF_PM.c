...
*
* Description:
*  This file provides Sleep APIs for the CapSense CSD Component.
*
* Note:
*
********************************************************************************
...
*
* Global Variables:
*  `$INSTANCE_NAME`_backup - used to save a component state before entering the  sleep
...
void `$INSTANCE_NAME`_Sleep(void)
{
    ...
    `$INSTANCE_NAME`_CSD_CFG_REG &= ~(`$INSTANCE_NAME`_CSD_CFG_SENSE_COMP_EN | `$INSTANCE_NAME`_CSD_CFG_ENABLE);
...
*  bits for a number of the component used within CapSense.
*
* Parameters:
*  None
*
