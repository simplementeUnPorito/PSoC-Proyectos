...
__STATIC_INLINE void `$INSTANCE_NAME`_SetInterruptTriggerMode(uint32 intType);
...
__STATIC_INLINE void `$INSTANCE_NAME`_Enable(void)
{
    Cy_LPComp_Enable(`$INSTANCE_NAME`_HW, `$INSTANCE_NAME`_CHANNEL);
}
...
__STATIC_INLINE void `$INSTANCE_NAME`_SetInterruptTriggerMode(uint32 intType)
{
    Cy_LPComp_SetInterruptTriggerMode(`$INSTANCE_NAME`_HW, `$INSTANCE_NAME`_CHANNEL, (cy_en_lpcomp_int_t)intType);
}
