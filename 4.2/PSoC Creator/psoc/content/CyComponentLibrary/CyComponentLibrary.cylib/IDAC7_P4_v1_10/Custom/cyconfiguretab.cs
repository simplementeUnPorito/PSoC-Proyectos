...
namespace IDAC7_P4_v1_10
{
    public partial class CyConfigureTab : UserControl, ICyParamEditingControl
    {
        ...
        public void UpdateUI()
        {
            ...
            else if (m_params.IDACRange == CyEIDACRangeType.RNG_152_4UA)
                rbRange_152_4.Checked = true;
        ...
        {
            if (m_params.IsS8CSDV2_Ver2) // S8CSDV2_Ver2
            {
                rbRange_152_4.Enabled = true;
                m_errorProvider.SetError(rbRange_152_4, String.Empty);
            }
            else
            {
                rbRange_152_4.Enabled = false;
                m_errorProvider.SetError(rbRange_152_4, rbRange_152_4.Checked ?
                                Resources.ErrMsgrRange_152_4 : String.Empty);
            }
        }
        #endregion
        ...
        private void rbRange_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else if (rbSender == rbRange_152_4)
            {
                m_params.IDACRange = CyEIDACRangeType.RNG_152_4UA;
            }
            ...
            if (rbRange_152_4.Enabled == false)
            {
                UpdateRangeVisibility();
            }
