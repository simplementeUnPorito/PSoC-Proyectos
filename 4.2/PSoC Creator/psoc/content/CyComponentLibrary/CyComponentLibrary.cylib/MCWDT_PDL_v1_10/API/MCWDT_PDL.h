...
__STATIC_INLINE uint32_t `$INSTANCE_NAME`_GetCountCascaded(void);
/** @} general */
...
/*******************************************************************************
* Function Name: `$INSTANCE_NAME`_GetCountCascaded
****************************************************************************//**
...
__STATIC_INLINE uint32_t `$INSTANCE_NAME`_GetCountCascaded(void)
{
    return (Cy_MCWDT_GetCountCascaded(`$INSTANCE_NAME`_HW));
}
