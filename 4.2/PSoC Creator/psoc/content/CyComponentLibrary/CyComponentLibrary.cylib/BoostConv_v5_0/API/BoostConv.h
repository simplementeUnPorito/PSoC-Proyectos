...
#define `$INSTANCE_NAME`_VOLTAGE_MASK              ((uint8) (0x1Fu << `$INSTANCE_NAME`_VOLTAGE_SHIFT))

#define `$INSTANCE_NAME`_MODE_SHIFT                (0x05u)
#define `$INSTANCE_NAME`_MODE_MASK                 ((uint8) (0x03u << `$INSTANCE_NAME`_MODE_SHIFT))

#define `$INSTANCE_NAME`_MANUAL_THUMP_ENABLE_SHIFT (0x07u)
#define `$INSTANCE_NAME`_MANUAL_THUMP_ENABLE       ((uint8) (0x01u << `$INSTANCE_NAME`_AUTO_THUMP_ENABLE_SHIFT))

/* Boost.CR1 */
#define `$INSTANCE_NAME`_FREQ_SHIFT                (0x00u)
#define `$INSTANCE_NAME`_FREQ_MASK                 ((uint8) (0x03u << `$INSTANCE_NAME`_FREQ_SHIFT))

#if (CY_PSOC3)
    #define `$INSTANCE_NAME`_PWMEXT_ENABLE_SHIFT   (0x02u)
    #define `$INSTANCE_NAME`_PWMEXT_ENABLE         ((uint8) (0x01u << `$INSTANCE_NAME`_PWMEXT_ENABLE_SHIFT))
#endif /* CY_PSOC3 */

#define `$INSTANCE_NAME`_BOOST_ENABLE_SHIFT        (0x03u)
#define `$INSTANCE_NAME`_BOOST_ENABLE              ((uint8) (0x01u << `$INSTANCE_NAME`_BOOST_ENABLE_SHIFT))

/* Boost.CR2 */
#define `$INSTANCE_NAME`_AUTO_THUMP_ENABLE_SHIFT   (0x00u)
#define `$INSTANCE_NAME`_AUTO_THUMP_ENABLE         ((uint8) (0x01u << `$INSTANCE_NAME`_AUTO_THUMP_ENABLE_SHIFT))

/* enables external precision 800mv referance */
#define `$INSTANCE_NAME`_PRECISION_REF_ENABLE_SHIFT (0x03u)
#define `$INSTANCE_NAME`_PRECISION_REF_ENABLE       ((uint8) (0x01u << `$INSTANCE_NAME`_PRECISION_REF_ENABLE_SHIFT))

/* disables auto battery connect to output when Vin=Vsel */
#define `$INSTANCE_NAME`_AUTO_BATTERY_DISABLE_SHIFT (0x01u)
#define `$INSTANCE_NAME`_AUTO_BATTERY_DISABLE       ((uint8) (0x01u << `$INSTANCE_NAME`_AUTO_BATTERY_DISABLE_SHIFT))

/* Boost.SR */
#define `$INSTANCE_NAME`_RDY_SHIFT                 (0x07u)
#define `$INSTANCE_NAME`_RDY                       ((uint8) (0x01u << `$INSTANCE_NAME`_RDY_SHIFT))
#define `$INSTANCE_NAME`_START_SHIFT               (0x06u)
#define `$INSTANCE_NAME`_START                     ((uint8) (0x01u << `$INSTANCE_NAME`_START_SHIFT))
#define `$INSTANCE_NAME`_OV_SHIFT                  (0x04u)
#define `$INSTANCE_NAME`_OV                        ((uint8) (0x01u << `$INSTANCE_NAME`_OV_SHIFT))
#define `$INSTANCE_NAME`_VHI_SHIFT                 (0x03u)
#define `$INSTANCE_NAME`_VHI                       ((uint8) (0x01u << `$INSTANCE_NAME`_VHI_SHIFT))
#define `$INSTANCE_NAME`_VNOM_SHIFT                (0x02u)
#define `$INSTANCE_NAME`_VNOM                      ((uint8) (0x01u << `$INSTANCE_NAME`_VNOM_SHIFT))
#define `$INSTANCE_NAME`_VLO_SHIFT                 (0x01u)
#define `$INSTANCE_NAME`_VLO                       ((uint8) (0x01u << `$INSTANCE_NAME`_VLO_SHIFT))
#define `$INSTANCE_NAME`_UV_SHIFT                  (0x00u)
#define `$INSTANCE_NAME`_UV                        ((uint8) (0x01u << `$INSTANCE_NAME`_UV_SHIFT))

/* Boost.CR4 */
#define `$INSTANCE_NAME`_INT_ENABLE_SHIFT          (0x00u)
#define `$INSTANCE_NAME`_INT_ENABLE_MASK           ((uint8) (0x01u << `$INSTANCE_NAME`_INT_ENABLE_SHIFT))

#if (CY_PSOC3)
    #define `$INSTANCE_NAME`_EXTCLK_SRC_SHIFT      (0x01u)
    #define `$INSTANCE_NAME`_EXTCLK_SRC_MASK       ((uint8) (0x03u << `$INSTANCE_NAME`_EXTCLK_SRC_SHIFT))
#endif /* CY_PSOC3 */

/* Boost.SR2 */
#define `$INSTANCE_NAME`_INT_SHIFT                 (0x00u)
#define `$INSTANCE_NAME`_INT                       ((uint8) (0x01u << `$INSTANCE_NAME`_INT_SHIFT))
