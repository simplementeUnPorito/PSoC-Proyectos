...
namespace PowerMonitor_v1_60
{
    ...
    public class CyParamNames
    {
        ...
        public const string EOC_CONFIGURATION = "EocConfiguration";
    ...
    public class CyParameters
    {
        ...
        public CyEEOCConfiguration EOCConfiguration
        {
            get { return GetValue<CyEEOCConfiguration>(CyParamNames.EOC_CONFIGURATION); }
            set { SetValue(CyParamNames.EOC_CONFIGURATION, value); }
        }
        ...
        public void LoadAllParametersFromFile(string fileContent)
        {
            ...
            else
            {
                try
                {
                    ...
                    CurrentsTable = imported.CurrentsTable;
                    AuxTable = imported.AuxTable;
                    ...
                    m_currentsTab.UpdateUIFromTable();
                    m_currentsTab.ValidateAllCells();
                    m_currentsTab.UpdateColumnsVisibility();
        ...
        public static bool IsCellValueValid(DataGridView dgv, int rowIndex, int colIndex, double min,
            double max, string errorMessage)
        {
            ...
            try
            {
                ...
                if ((cell != null) && (dgv[colIndex, rowIndex].ReadOnly == false) && (cell.ToString() != string.Empty))
                {
