            ...
            try
            {
                ...
                else if (dataGridView1.Columns[colIndex].Name == colOVFaultThreshold.Name && m_params.FaultSourcesOV)
                {
                    if (ovFaultThreshold != null)
                    {
                        ...
                        double seVoltageRange = (m_params.LowVoltageMode == CyELowVoltageMode.Range_2048mV) ?
                            CyParamRanges.OV_FAULT_MULT_SCALE_2048 : CyParamRanges.OV_FAULT_MULT_SCALE_4096;
