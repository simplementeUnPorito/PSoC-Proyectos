...
float `$INSTANCE_NAME`_adcGainCfg2;             /* nominally 0.03125 mV/ct @ 64 mV range */
...
int16 `$INSTANCE_NAME`_adcSeAdjCfg3;            /* nominally 1024 mV        */

/* Variables to hold filtered ADC raw data */
CYBIT `$INSTANCE_NAME`_iirInit;
...
static int32 CYXDATA `$INSTANCE_NAME`_filtSCAdjRaw3;
...
*******************************************************************************/
static void  `$INSTANCE_NAME`_RequestAdcCal(uint8 iirInit) `=ReentrantKeil($INSTANCE_NAME . "_RequestAdcCal")`;
static float `$INSTANCE_NAME`_iirFiltAdc(uint8 iirInit, int16 newData, int32 CYXDATA *filtVal)
                                                           `=ReentrantKeil($INSTANCE_NAME . "_iirFiltAdc")`;
...
*   `$INSTANCE_NAME`_adcGainCalRawCfg3  = -2048;    Vref on +/-1024 mV range.
*   `$INSTANCE_NAME`_adcSCCalRawCfg3    = -2048;    Vref
*
...
void `$INSTANCE_NAME`_Calibrate(void) `=ReentrantKeil($INSTANCE_NAME . "_Calibrate")`
{
    ...
    ***************************************************************************/
    ...
    `$INSTANCE_NAME`_RequestAdcCal(`$INSTANCE_NAME`_iirInit);
    ...
    ***************************************************************************/
    `$INSTANCE_NAME`_calType = `$INSTANCE_NAME`_CAL_PGA1Z;
    `$INSTANCE_NAME`_RequestAdcCal(`$INSTANCE_NAME`_iirInit);
    ...
    ***************************************************************************/
    ...
    `$INSTANCE_NAME`_RequestAdcCal(`$INSTANCE_NAME`_iirInit);
    `$INSTANCE_NAME`_calType = `$INSTANCE_NAME`_CAL_PGA3Z;
    `$INSTANCE_NAME`_RequestAdcCal(`$INSTANCE_NAME`_iirInit);
    ...
    ***************************************************************************/
    switch (`$INSTANCE_NAME`_calType)
    {
        ...
        case `$INSTANCE_NAME`_CAL_CFG1Z:
            `$INSTANCE_NAME`_adcZeroCfg1 = (int16)`$INSTANCE_NAME`_iirFiltAdc(iirInit,
                                                            `$INSTANCE_NAME`_adcZeroCalRawCfg1,
        ...
        case `$INSTANCE_NAME`_CAL_CFG1G:
            ...
            *                b) Cfg #1 zero offset
            ***********************************************************************/
            tmpInt  = (int16)`$INSTANCE_NAME`_iirFiltAdc(iirInit,`$INSTANCE_NAME`_adcGainCalRawCfg1,
        ...
        case `$INSTANCE_NAME`_CAL_PGA1Z:
            ...
            *                b) Cfg #1 zero offset
            ***********************************************************************/
            tmpInt  = (int16)`$INSTANCE_NAME`_iirFiltAdc(iirInit, `$INSTANCE_NAME`_adcSCCalRawCfg1,
                                                         &`$INSTANCE_NAME`_filtSCAdjRaw1);
            tmpInt  = -tmpInt;
            tmpInt -= `$INSTANCE_NAME`_adcZeroCfg1;
            `$INSTANCE_NAME`_adcSeAdjCfg1 = (int16)(tmpInt * `$INSTANCE_NAME`_adcGainCfg1);
            break;
        ...
        ***************************************************************************/
        case `$INSTANCE_NAME`_CAL_CFG2Z:
            `$INSTANCE_NAME`_adcZeroCfg2 = (int16)`$INSTANCE_NAME`_iirFiltAdc(iirInit,
                                                                      `$INSTANCE_NAME`_adcZeroCalRawCfg2,
        ...
        case `$INSTANCE_NAME`_CAL_CFG2Gb:
            ...
            ***********************************************************************/
            tmpInt  = (int16)`$INSTANCE_NAME`_iirFiltAdc(iirInit, `$INSTANCE_NAME`_adcGainCalRawCfg2b,
        ...
        ***************************************************************************/
        case `$INSTANCE_NAME`_CAL_CFG3Z:
            `$INSTANCE_NAME`_adcZeroCfg3 = (int16)`$INSTANCE_NAME`_iirFiltAdc(iirInit,
                                                            `$INSTANCE_NAME`_adcZeroCalRawCfg3,
        ...
        case `$INSTANCE_NAME`_CAL_CFG3G:
            ...
            *                b) Cfg #3 zero offset
            ***********************************************************************/
            tmpInt  = (int16)`$INSTANCE_NAME`_iirFiltAdc(iirInit, `$INSTANCE_NAME`_adcGainCalRawCfg3,
        ...
        case `$INSTANCE_NAME`_CAL_PGA3Z:
            ...
            *                b) Cfg #1 zero offset
            ***********************************************************************/
            tmpInt  = (int16)`$INSTANCE_NAME`_iirFiltAdc(iirInit, `$INSTANCE_NAME`_adcSCCalRawCfg3,
                                                  &`$INSTANCE_NAME`_filtSCAdjRaw3);
            tmpInt  = -tmpInt;
            tmpInt -= `$INSTANCE_NAME`_adcZeroCfg3;
            `$INSTANCE_NAME`_adcSeAdjCfg3 = (int16)(tmpInt * `$INSTANCE_NAME`_adcGainCfg3);
            break;
        default:
            break;
    }
                                                            ...
                                                            `=ReentrantKeil($INSTANCE_NAME . "_iirFiltAdc")`
{
    ...
    {
          tmpFilt = *filtVal;
          junk = (tmpFilt + `$INSTANCE_NAME`_SCALE_VAL / 2);
          junk /= `$INSTANCE_NAME`_SCALE_VAL;
