...
void  `$INSTANCE_NAME`_WriteTxByte(uint8 wrData, uint8 channelSelect)  \
                                                                 `=ReentrantKeil($INSTANCE_NAME . "_WriteTxByte")`;
void  `$INSTANCE_NAME`_WriteCstByte(uint8 wrData, uint8 channelSelect) \
                                                                 `=ReentrantKeil($INSTANCE_NAME . "_WriteCstByte")`;
...
#define `$INSTANCE_NAME`_CST_0_ISR_NUMBER           ((uint8) `$INSTANCE_NAME`_Cst0Interrupt__INTC_NUMBER)
#define `$INSTANCE_NAME`_CST_1_ISR_NUMBER           ((uint8) `$INSTANCE_NAME`_Cst1Interrupt__INTC_NUMBER)
#define `$INSTANCE_NAME`_CST_0_ISR_PRIORITY         ((uint8) `$INSTANCE_NAME`_Cst0Interrupt__INTC_PRIOR_NUM)
#define `$INSTANCE_NAME`_CST_1_ISR_PRIORITY         ((uint8) `$INSTANCE_NAME`_Cst1Interrupt__INTC_PRIOR_NUM)
...
#define `$INSTANCE_NAME`_CONTROL_REG \
                                (* (reg8 *) `$INSTANCE_NAME`_bSPDIF_Tx_`$CtlModeReplacementString`_CtlReg__CONTROL_REG)
...
#define `$INSTANCE_NAME`_IS_DISABLED    (0u == (`$INSTANCE_NAME`_CONTROL_REG & `$INSTANCE_NAME`_ENBL))
