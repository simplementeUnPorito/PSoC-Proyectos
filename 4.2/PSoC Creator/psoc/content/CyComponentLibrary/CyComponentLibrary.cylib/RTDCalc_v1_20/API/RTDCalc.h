...
#define `$INSTANCE_NAME`_ZERO_VAL_PT100             (100000lu)
#define `$INSTANCE_NAME`_ZERO_VAL_PT500             (500000lu)
#define `$INSTANCE_NAME`_ZERO_VAL_PT1000            (1000000lu)
...
#define `$INSTANCE_NAME`_IN_NORMALIZATION           (14)
