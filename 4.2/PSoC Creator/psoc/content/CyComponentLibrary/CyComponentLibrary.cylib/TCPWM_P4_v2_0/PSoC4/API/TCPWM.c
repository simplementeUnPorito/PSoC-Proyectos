...
*   Values:
*     - `$INSTANCE_NAME`_CMD_CAPTURE    - Trigger Capture command
*     - `$INSTANCE_NAME`_CMD_RELOAD     - Trigger Reload command
*     - `$INSTANCE_NAME`_CMD_STOP       - Trigger Stop command
*     - `$INSTANCE_NAME`_CMD_START      - Trigger Start command
*
* Return:
*  None
*
