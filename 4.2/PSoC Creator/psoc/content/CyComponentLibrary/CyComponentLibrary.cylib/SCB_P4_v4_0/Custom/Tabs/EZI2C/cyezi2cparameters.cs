...
namespace SCB_P4_v4_0
{
    ...
    public partial class CyParamNames
    {
        ...
        public const string EZI2C_SHOW_TERMINALS = "EzI2cShowTerminals";
    }
    #endregion
    ...
    public partial class CyParameters
    {
        ...
        #region Pins (Advanced) tab properties
        ...
        public bool EZI2C_ShowTerminals
        {
            get { return GetValue<bool>(CyParamNames.EZI2C_SHOW_TERMINALS); }
            set { SetValue(CyParamNames.EZI2C_SHOW_TERMINALS, value); }
        }
        #endregion
