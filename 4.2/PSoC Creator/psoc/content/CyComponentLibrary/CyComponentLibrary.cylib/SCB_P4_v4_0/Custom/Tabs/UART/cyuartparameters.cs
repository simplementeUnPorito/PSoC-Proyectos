...
namespace SCB_P4_v4_0
{
    ...
    public partial class CyParamNames
    {
        ...
        public const string UART_INTR_RX_BREAK_DETECTED = "UartIntrRxBreakDetected";
        public const string UART_RX_BREAK_WIDTH = "UartRxBreakWidth";
    ...
    public partial class CyParamRanges
    {
        ...
        public const byte UART_RX_BREAK_WIDTH_MIN = 1;
        public const byte UART_RX_BREAK_WIDTH_MAX = 16;
    ...
    public partial class CyParameters
    {
        ...
        public bool UART_InterruptOnRXBreakDetected
        {
            get { return GetValue<bool>(CyParamNames.UART_INTR_RX_BREAK_DETECTED); }
            set { SetValue(CyParamNames.UART_INTR_RX_BREAK_DETECTED, value); }
        }

        public byte UART_RXBreakWidth
        {
            get { return GetValue<byte>(CyParamNames.UART_RX_BREAK_WIDTH); }
            set { SetValue(CyParamNames.UART_RX_BREAK_WIDTH, value); }
        }
        ...
        /// <summary>
        /// Event fired when UART Show Terminals is changed.
        /// </summary>
        public event EventHandler<EventArgs> UartShowTerminalsChanged;
        ...
        /// <summary>
        /// Called when UART Show Terminals is changed.
        /// </summary>
        public void OnUartShowTerminalsChanged(object sender, EventArgs e)
        {
            EventHandler<EventArgs> handler = UartShowTerminalsChanged;
            if (handler != null)
                handler(sender, e);
        }
