...
namespace SCB_P4_v4_0
{
    ...
    public partial class CyParamNames
    {
        ...
        public const string I2C_SHOW_TERMINALS = "I2cShowTerminals";
    ...
    public partial class CyParameters
    {
        ...
        public bool I2C_ShowTerminals
        {
            get { return GetValue<bool>(CyParamNames.I2C_SHOW_TERMINALS); }
            set { SetValue(CyParamNames.I2C_SHOW_TERMINALS, value); }
        }
        ...
        /// <summary>
        /// Show Terminals is not applicable for Master modes for PSoC 4100 and PSoC 4200 devices
        /// </summary>
        public static string GetShowTerminalsError(CyParameters parameters)
        {
            string errMsg = String.Empty;
            if (parameters.I2cMode.Value != CyEI2CModeType.I2C_SLAVE && parameters.IsScbIPV0 &&
                parameters.I2C_ShowTerminals)
            {
                errMsg = Resources.I2CShowTerminalsError;
            }
            return errMsg;
        }
        ...
        public List<CyCustErr> GetI2cDrcErrors()
        {
            ...
            if (IsScbIPV0 || IsScbIPV1)
            {
                ...
                if (IsScbIPV0)
                {
                    ...
                    // Show Terminals
                    errorMessage = GetShowTerminalsError(this);
                    if (String.IsNullOrEmpty(errorMessage) == false)
                    {
                        errorList.Add(new CyCustErr(errorMessage));
                    }
