...
namespace SCB_P4_v4_0
{
    public partial class CyEZI2CAdvancedTab : CyTabControlWrapper
    {
        ...
        {
            m_chbShowTerminals.Checked = m_params.EZI2C_ShowTerminals;
        ...
        {
            m_params.EZI2C_ShowTerminals = m_chbShowTerminals.Checked;
            UpdateControlsEnableState();
        }
        #endregion
        ...
        {
            m_panelSlewRate.Enabled = (m_params.EZI2C_ShowTerminals == false);
