...
#define `$INSTANCE_NAME`_I2C_SLAVE_ADDRESS          (`= IntToHexString(`$I2cSlaveAddress`)`u)
#define `$INSTANCE_NAME`_I2C_SLAVE_ADDRESS_MASK     (`= IntToHexString(`$I2cSlaveAddressMask`)`u)
...
#define `$INSTANCE_NAME`_I2C_MSTR_ERR_TIMEOUT       (`$INSTANCE_NAME`_I2C_MASTER_TIMEOUT) /* Operation timeout        */
...
#define `$INSTANCE_NAME`_I2C_MASTER_TIMEOUT_POS (31u)
#define `$INSTANCE_NAME`_I2C_MASTER_TIMEOUT     ((uint32) 0x01u << `$INSTANCE_NAME`_I2C_MASTER_TIMEOUT_POS)

/* Slave address match or general call */
#define `$INSTANCE_NAME`_SLAVE_INTR_I2C_ADDR    (`$INSTANCE_NAME`_INTR_SLAVE_I2C_ADDR_MATCH | \
                                                 `$INSTANCE_NAME`_INTR_SLAVE_I2C_GENERAL)

/* Send byte condition: used by */
#define `$INSTANCE_NAME`_INTR_MASTER_SEND_BYTE   (`$INSTANCE_NAME`_INTR_MASTER_I2C_ACK      | \
...
#define `$INSTANCE_NAME`_INTR_MASTER_RECEIVE_BYTE   (`$INSTANCE_NAME`_INTR_MASTER_I2C_ARB_LOST | \
                                                     `$INSTANCE_NAME`_INTR_MASTER_I2C_BUS_ERROR)
/* Stop condition */
#define `$INSTANCE_NAME`_INTR_MASTER_SEND_STOP  (`$INSTANCE_NAME`_INTR_MASTER_I2C_STOP     | \
                                                 `$INSTANCE_NAME`_INTR_MASTER_I2C_ARB_LOST | \
                                                 `$INSTANCE_NAME`_INTR_MASTER_I2C_BUS_ERROR)
...
#define `$INSTANCE_NAME`_I2C_PHASE_GEN_TIMEOUT      (20000u)
...
#define `$INSTANCE_NAME`_I2C_CONVERT_TIMEOUT_TO_US(timeoutMs)   ((timeoutMs) * 1000u)
...
***************************************/
    ...
    #define `$INSTANCE_NAME`_I2C_DEFAULT_INTR_MASTER_MASK   (`$INSTANCE_NAME`_NO_INTR_SOURCES)
