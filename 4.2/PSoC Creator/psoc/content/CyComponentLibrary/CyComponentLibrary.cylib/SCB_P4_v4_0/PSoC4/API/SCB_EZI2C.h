...
#define `$INSTANCE_NAME`_EZI2C_PRIMARY_SLAVE_ADDRESS    (`= IntToHexString(`$EzI2cPrimarySlaveAddress`)`u)
#define `$INSTANCE_NAME`_EZI2C_SECONDARY_SLAVE_ADDRESS  (`= IntToHexString(`$EzI2cSecondarySlaveAddress`)`u)
...
#define `$INSTANCE_NAME`_EZI2C_SLAVE_ADDRESS_MASK       (`= IntToHexString(`$EzI2cSlaveAddressMask`)`u)
