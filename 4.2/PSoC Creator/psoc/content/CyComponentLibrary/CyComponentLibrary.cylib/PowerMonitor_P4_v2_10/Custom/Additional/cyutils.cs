...
namespace PowerMonitor_P4_v2_10.Additional
{
    class cyutils
    {
        /// <summary>
        ...
        /// <summary>
        /// Return true if the project uses SRSS-Lite. 
        ...
        public static bool IsSrssLite(ICyInstQuery_v1 inst)
        {
            return (inst.DeviceQuery.GetFeatureCount("s8srsslt") > 0);            
        }
