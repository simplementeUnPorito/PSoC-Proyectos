...
namespace LUT_v1_60
{
    ...
    public class CyCustomizer : ICyParamEditHook_v1, ICyVerilogCustomize_v1
    {
        ...
        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery, ICyExpressMgr_v1 mgr)
        {
            ...
            CyParameters parameters = new CyParameters(edit, edit);
            ...
            CyBitfieldControl configureTab = new CyBitfieldControl(parameters);
            ...
            editor.AddCustomPage(configureTab.TabDisplayName, configureTab, paramCommitted, configureTab.TabName);
            // This is a standard page that is added to all customizers
            editor.AddDefaultPage(ResourceMsg.TabDisplayNameBuiltin, "Built-in");
