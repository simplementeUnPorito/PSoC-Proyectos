...
namespace Comp_v2_0
{
    public partial class CyComparatorControl : UserControl
    {
        ...
        public void UpdateFormFromParams(ICyInstEdit_v1 inst)
        {
            ...
            // If PSoC5A silicon is selected, disable the PowerDown override
            // enable or disable group box as it is not supported for PSoC5A. 
            
            if (inst.DeviceQuery.IsPSoC5 && inst.DeviceQuery.ArchFamilyMember == PSOC5A)
            {
        ...
        private void m_rbHysteresis_Enable_CheckedChanged(object sender, EventArgs e)
        {
            if (m_rbHysteresis_Enable.Checked)
            {
                ...
                if (m_rbPolarity_NonInve.Checked && m_rbSync_Norm.Checked)
                    pictureBox2.Image = Comp_v2_0.Properties.Resources.hy_ninv_sync;
                if (m_rbHysteresis_Enable.Checked && m_rbPolarity_NonInve.Checked && m_rbSync_Bypass.Checked)
                    pictureBox2.Image = Comp_v2_0.Properties.Resources.hysteresis;
                if (m_rbPolarity_Inve.Checked && m_rbSync_Norm.Checked)
                    pictureBox2.Image = Comp_v2_0.Properties.Resources.hy_inv_syn;
                if (m_rbPolarity_Inve.Checked && m_rbSync_Bypass.Checked)
                    pictureBox2.Image = Comp_v2_0.Properties.Resources.hy_inv;
                UpdateDrawing(prms);
             }
        }
        ...
        private void m_rbHysteresis_Disable_CheckedChanged(object sender, EventArgs e)
        {
            if (m_rbHysteresis_Disable.Checked)
            {
                ...
                if (m_rbPolarity_NonInve.Checked && m_rbSync_Norm.Checked)
                    pictureBox2.Image = Comp_v2_0.Properties.Resources.sync;
                if (m_rbPolarity_NonInve.Checked && m_rbSync_Bypass.Checked)
                    pictureBox2.Image = Comp_v2_0.Properties.Resources.comp;
                if (m_rbPolarity_Inve.Checked && m_rbSync_Norm.Checked)
                    pictureBox2.Image = Comp_v2_0.Properties.Resources.inv_sync;
                if (m_rbPolarity_Inve.Checked && m_rbSync_Bypass.Checked)
                    pictureBox2.Image = Comp_v2_0.Properties.Resources.inverting;
                UpdateDrawing(prms);
            }
        }
