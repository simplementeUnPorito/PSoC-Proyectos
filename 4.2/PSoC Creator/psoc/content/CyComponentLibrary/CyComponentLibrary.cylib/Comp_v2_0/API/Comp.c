...
static void `$INSTANCE_NAME`_trimAdjust(uint8 nibble) `=ReentrantKeil($INSTANCE_NAME . "_trimAdjust")`;
...
void `$INSTANCE_NAME`_Init(void) `=ReentrantKeil($INSTANCE_NAME . "_Init")`
{
    ...
    #else
        `$INSTANCE_NAME`_CR &= (uint8)(~`$INSTANCE_NAME`_HYST_OFF);
    #endif /* `$INSTANCE_NAME`_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
        ...
        /* Set default Power Down Override */
            ...
            `$INSTANCE_NAME`_CR &= (uint8)(~`$INSTANCE_NAME`_PWRDWN_OVRD);
        #else 
            `$INSTANCE_NAME`_CR |= `$INSTANCE_NAME`_PWRDWN_OVRD;
        #endif /* `$INSTANCE_NAME`_DEFAULT_PWRDWN_OVRD == 0u */
    ...
    /* Set default sync */
    `$INSTANCE_NAME`_CLK &= (uint8)(~`$INSTANCE_NAME`_SYNCCLK_MASK);
    ...
    #endif /* `$INSTANCE_NAME`_DEFAULT_BYPASS_SYNC == 0u */
}
...
void `$INSTANCE_NAME`_SetSpeed(uint8 speed) `=ReentrantKeil($INSTANCE_NAME . "_SetSpeed")`
{
    ...
    `$INSTANCE_NAME`_CR = (`$INSTANCE_NAME`_CR & (uint8)(~`$INSTANCE_NAME`_PWR_MODE_MASK)) |
...
uint16 `$INSTANCE_NAME`_ZeroCal(void) `=ReentrantKeil($INSTANCE_NAME . "_ZeroCal")`
{
    ...
    `$INSTANCE_NAME`_SW3 = tmpSW3 & (uint8)(~`$INSTANCE_NAME`_CMP_SW3_INPCTL_MASK);
    ...
    */
    ...
    {
        `$INSTANCE_NAME`_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        `$INSTANCE_NAME`_trimAdjust(1u);
		`$INSTANCE_NAME`_trimAdjust(0u);
    }
    ...
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)`$INSTANCE_NAME`_TR1 << 8u) | (`$INSTANCE_NAME`_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}
