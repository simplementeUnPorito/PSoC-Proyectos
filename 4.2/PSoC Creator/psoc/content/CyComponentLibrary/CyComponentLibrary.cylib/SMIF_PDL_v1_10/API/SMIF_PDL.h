...
/* DMA Trigger Output */
#define `$INSTANCE_NAME`_RX_FIFO_DMA_TRIGGER            (`$rxFifoDmaTrigger`UL)
#define `$INSTANCE_NAME`_TX_FIFO_DMA_TRIGGER            (`$txFifoDmaTrigger`UL)
...
#define `$INSTANCE_NAME`_EN_DMA_READ        `$INSTANCE_NAME`_RX_FIFO_DMA_TRIGGER
#define `$INSTANCE_NAME`_EN_DMA_WRITE       `$INSTANCE_NAME`_TX_FIFO_DMA_TRIGGER
