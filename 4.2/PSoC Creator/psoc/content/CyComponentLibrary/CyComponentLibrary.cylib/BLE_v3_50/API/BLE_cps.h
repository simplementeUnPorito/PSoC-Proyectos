...
/**
 \addtogroup group_service_api_CPS_definitions
 @{
*/
...
CYBLE_CYPACKED typedef struct
{
    ...
    uint8  month;                                           /**< Month */
    uint8  day;                                             /**< Day */
    uint8  hours;                                           /**< Time - hours */
    uint8  minutes;                                         /**< Time - minutes */
    uint8  seconds;                                         /**< Time - seconds */
}CYBLE_CYPACKED_ATTR CYBLE_CPS_DATE_TIME_T;

/** CPS Adjustment structure */
CYBLE_CYPACKED typedef struct
{
...
/** \addtogroup group_service_api_CPS_server_client 
@{ 
*/
...
/**
 \addtogroup group_service_api_CPS_server
 @{
*/
...
#ifdef CYBLE_CPS_CLIENT
/**
 \addtogroup group_service_api_CPS_client
 @{
*/
...
#ifdef CYBLE_GAP_ROLE_BROADCASTER
extern CYBLE_GAPP_DISC_PARAM_T cyBle_cpssBroadcastParam;
extern CYBLE_GAPP_DISC_DATA_T cyBle_cpssBroadcastData;
#endif /* (CYBLE_GAP_ROLE_BROADCASTER) */
