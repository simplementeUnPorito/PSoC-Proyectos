...
#define CYBLE_HIDSS_SERVICE_COUNT            (`$HidsSCount`)
#define CYBLE_HIDSS_REPORT_COUNT             (`$HidsSReportCount`)
...
/* Maximum supported count of HID services and reports */
#define CYBLE_HIDSC_SERVICE_COUNT            (`$HidsCCount`)
#define CYBLE_HIDSC_REPORT_COUNT             (`$HidsCReportCount`)
#define CYBLE_HIDSC_HOST_ROLE                (`$HidsHostRole`)
