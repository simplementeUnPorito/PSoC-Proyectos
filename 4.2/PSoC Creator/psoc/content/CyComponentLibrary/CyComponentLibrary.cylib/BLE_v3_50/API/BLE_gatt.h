...
#define CYBLE_GATT_ROLE                              (`$GATT_ROLE`)
...
#define CYBLE_GATT_DB_INDEX_COUNT                    (`$GattDBSize`)
#define CYBLE_GATT_DB_ATT_VAL_COUNT                  (`$AttValuesLenArraySize`)
#define CYBLE_GATT_DB_MAX_VALUE_LEN                  (`$GattDBMaxValueLen`)

#endif /* CYBLE_GATT_ROLE_SERVER */

#define CYBLE_GATT_DB_CCCD_COUNT                     (`$AttValueCCCDArraySize`)
