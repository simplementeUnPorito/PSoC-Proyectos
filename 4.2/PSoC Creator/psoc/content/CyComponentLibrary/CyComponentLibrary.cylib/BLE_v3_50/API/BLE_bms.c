...
* 
*  \param callbackFunc: An application layer event callback function to 
*                       receive events from the BLE Component. The definition 
*                       of CYBLE_CALLBACK_T for BM Service is:\n
...
*  callback function.
* 
* Note: Writing the attribute into GATT DB (if needed) is on the user's 
*  responsibility after the Authorization Code check in the registered BMS 
*  application callback function.
* 
*  \param eventParam: The pointer to the data structure specified by the event.
* 
* \return
*  CYBLE_GATT_ERR_CODE_T - A function return state if the it succeeded 
...
* 
*  \param CYBLE_GATTS_PREP_WRITE_REQ_PARAM_T *eventParam: The pointer to the 
*         data that came with a prepare write request.
*  
******************************************************************************/
...
* 
*  \param CYBLE_GATTS_EXEC_WRITE_REQ_T *eventParam: The pointer to the data 
*            that came with a write request.
* 
******************************************************************************/
...
***************************************************************************//**
* 
*  This function is used to perform a reliable write command for the Bond
*  Management Control Point characteristic (identified by charIndex) value
