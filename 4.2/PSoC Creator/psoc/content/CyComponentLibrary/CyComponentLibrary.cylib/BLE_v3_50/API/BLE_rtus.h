...
/**
 \addtogroup group_service_api_RTUS_definitions
 @{
*/
...
typedef struct
{
    ...
    uint8 result;                     /**< Result of Time update */
} CYBLE_RTUS_TIME_UPDATE_STATE_T;
...
/** 
  \addtogroup group_service_api_RTUS_server_client 
  @{ 
*/
...
#if defined(CYBLE_RTUS_SERVER)
/** 
  \addtogroup group_service_api_RTUS_server 
  @{ 
*/
...
#if defined(CYBLE_RTUS_CLIENT)
/** 
  \addtogroup group_service_api_RTUS_client 
  @{ 
*/
