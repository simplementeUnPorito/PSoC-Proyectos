...
void `$INSTANCE_NAME`_Sleep(void)
{
    ...
    */
    `$INSTANCE_NAME`_backup.dftRegVal = `$INSTANCE_NAME`_SAR_DFT_CTRL_REG & (uint32)~`$INSTANCE_NAME`_ADFT_OVERRIDE;
...
{
    `$INSTANCE_NAME`_SAR_DFT_CTRL_REG = `$INSTANCE_NAME`_backup.dftRegVal;
