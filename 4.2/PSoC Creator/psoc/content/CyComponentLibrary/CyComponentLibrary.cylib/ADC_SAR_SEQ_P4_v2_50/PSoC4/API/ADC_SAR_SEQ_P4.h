...
#define `$INSTANCE_NAME`_DEFAULT_AVG_SAMPLES_DIV        (`$AdcAvgSamplesNum`u < 4u) ? (int16)(0x100u >> (7u - `$AdcAvgSamplesNum`u)) : (int16)(0x100u >> 4u)
...
#define `$INSTANCE_NAME`_NEG_VREF                   (0x00000E00Lu)
    ...
    #define `$INSTANCE_NAME`_NEG_OTHER              (uint16)((uint16)`$INSTANCE_NAME`_cy_psoc4_sarmux_8__VNEG0 << 9u)
#else
