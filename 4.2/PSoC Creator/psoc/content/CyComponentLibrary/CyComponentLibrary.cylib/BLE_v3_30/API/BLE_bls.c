...
*  'Handle Value Notification' which results in CYBLE_EVT_BLSC_NOTIFICATION event
...
*  results in CYBLE_EVT_BLSC_INDICATION or CYBLE_EVT_GATTC_HANDLE_VALUE_IND (if 
