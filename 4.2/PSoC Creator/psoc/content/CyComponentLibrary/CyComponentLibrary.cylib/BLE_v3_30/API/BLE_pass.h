...
#include "`$INSTANCE_NAME`_gatt.h"
 ...
 /**
 \addtogroup group_service_api_PASS_definitions
 @{
*/  
...
/** 
\addtogroup group_service_api_PASS_server_client 
@{ 
*/
...
#ifdef CYBLE_PASS_SERVER
/**
 \addtogroup group_service_api_PASS_server
 @{
*/
...
#ifdef CYBLE_PASS_CLIENT
/**
 \addtogroup group_service_api_PASS_client
 @{
*/
