...
*  'Handle Value Notification' which results in CYBLE_EVT_RSCSC_NOTIFICATION event
...
*  results in CYBLE_EVT_RSCSC_INDICATION or CYBLE_EVT_GATTC_HANDLE_VALUE_IND (if 
...
* 
*  \param CYBLE_DISC_DESCR_INFO_T * discCharInfo: The pointer to a characteristic information
*                                          structure.
* 
*******************************************************************************/
...
* 
*  \param CYBLE_GATTC_HANDLE_VALUE_NTF_PARAM_T *eventParam: The pointer to the 
...
* 
*  \param CYBLE_GATTC_HANDLE_VALUE_IND_PARAM_T *eventParam: The pointer to the 
*                                                    CYBLE_GATTC_HANDLE_VALUE_NTF_PARAM_T
...
* 
*  \param CYBLE_CONN_HANDLE_T *eventParam: The pointer to the CYBLE_CONN_HANDLE_T data 
*                                   structure.
* 
*******************************************************************************/
