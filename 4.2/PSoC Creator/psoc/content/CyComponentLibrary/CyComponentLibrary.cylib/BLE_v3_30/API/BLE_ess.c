...
*    
*  This API must be called when API CyBle_GetBleSsState() returns
...
*  'Handle Value Notification' which results in CYBLE_EVT_ESSC_NOTIFICATION event
...
*  results in CYBLE_EVT_ESSC_INDICATION or CYBLE_EVT_GATTC_HANDLE_VALUE_IND (if 
