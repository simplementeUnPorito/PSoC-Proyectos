...
*  'Handle Value Notification' which results in CYBLE_EVT_PASSC_NOTIFICATION event
...
*  * CYBLE_EVT_PASSC_WRITE_CHAR_RESPONSE - in case if the requested attribute is
*                                successfully wrote on the peer device,
*                                the details (char index, etc.) are 
*                                provided with event parameter structure
*                                of type CYBLE_PASSS_CHAR_VALUE_T.
*  .
