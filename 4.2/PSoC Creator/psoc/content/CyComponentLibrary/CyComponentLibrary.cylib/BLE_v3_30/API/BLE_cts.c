...
*  'Handle Value Notification' which results in CYBLE_EVT_CTSC_NOTIFICATION event
...
* 
*  \param eventParam: The pointer to the CYBLE_GATTC_HANDLE_VALUE_NTF_PARAM_T data
