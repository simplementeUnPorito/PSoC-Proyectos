...
*  'Handle Value Notification' which results in CYBLE_EVT_LNSC_NOTIFICATION event
...
*  results in CYBLE_EVT_LNSC_INDICATION or CYBLE_EVT_GATTC_HANDLE_VALUE_IND (if 
