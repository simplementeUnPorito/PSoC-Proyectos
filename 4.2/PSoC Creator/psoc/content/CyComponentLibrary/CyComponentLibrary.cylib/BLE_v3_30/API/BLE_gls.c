...
*  'Handle Value Notification' which results in CYBLE_EVT_GLSC_NOTIFICATION event
...
*  results in CYBLE_EVT_GLSC_INDICATION or CYBLE_EVT_GATTC_HANDLE_VALUE_IND (if 
