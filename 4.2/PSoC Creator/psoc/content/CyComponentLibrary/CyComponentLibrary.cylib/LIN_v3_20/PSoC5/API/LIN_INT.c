...
{
    #ifdef `$INSTANCE_NAME`_BLIN_ISR_ENTRY_CALLBACK
        `$INSTANCE_NAME`_BLIN_ISR_EntryCallback();
    #endif /* `$INSTANCE_NAME`_BLIN_ISR_ENTRY_CALLBACK */
    
    l_ifc_aux_`$INSTANCE_NAME`();

    #ifdef `$INSTANCE_NAME`_BLIN_ISR_EXIT_CALLBACK
        `$INSTANCE_NAME`_BLIN_ISR_ExitCallback();
    #endif /* `$INSTANCE_NAME`_BLIN_ISR_EXIT_CALLBACK */
}
