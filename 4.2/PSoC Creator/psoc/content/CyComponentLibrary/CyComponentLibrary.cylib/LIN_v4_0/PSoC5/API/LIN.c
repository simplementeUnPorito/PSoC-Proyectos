                                ...
                                (`$INSTANCE_NAME`_nodeState == `$INSTANCE_NAME`_TX_PHY_RESPONSE))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            * the current frame is SF, otherwise it is the last CF frame. Fill the Frame
                                            * PCI field properly.
                                            */
        ...
        ***********************************************************************/
        case `$INSTANCE_NAME`_UART_ISR_STATE_3_RX:
            ...
            if(0u != (`$INSTANCE_NAME`_FSM_FRAMING_ERROR_FLAG & `$INSTANCE_NAME`_fsmFlags))
            {
                ...
                if((0u == `$INSTANCE_NAME`_bytesTransferred) && (0u == `$INSTANCE_NAME`_frameErrorAfterPID))
                {
    ...
    static l_u8 `$INSTANCE_NAME`_ProcessMrf(l_u8 frame[])`=ReentrantKeil($INSTANCE_NAME . "_ProcessMrf")`
    {
                        ...
                        (`$INSTANCE_NAME`_NAD_FUNCTIONAL == frame[`$INSTANCE_NAME`_PDU_NAD_IDX]))
        {
                            ...
                            case `$INSTANCE_NAME`_NCS_READ_BY_ID:
                                ...
                                if(`$INSTANCE_NAME`_NCS_READ_BY_ID_ID == frame[`$INSTANCE_NAME`_PDU_D1_IDX])
                                {
                                    if(1u == tempStatus)
                                    {
                                        /* Fill SRF Buffer with response to service */
                                        /* NAD field should contain current NAD */
                                        `$INSTANCE_NAME`_srfBuffer[`$INSTANCE_NAME`_PDU_NAD_IDX] = `$INSTANCE_NAME`_nad;
                ...
                if(frame[`$INSTANCE_NAME`_PDU_LEN_IDX] >= `$INSTANCE_NAME`_FRAME_DATA_SIZE_7)
                {
                        ...
                        */
                           ...
                           (`$INSTANCE_NAME`_TL_BUF_LEN_MAX >= tmpWord))
                        {
                            ...
                            `$INSTANCE_NAME`_rxMessageLength = (l_u16)((((l_u16) frame[`$INSTANCE_NAME`_PDU_PCI_IDX]) &
                                    ((l_u16) ((l_u8) ~`$INSTANCE_NAME`_PDU_PCI_TYPE_MASK))) << 8u);

                            `$INSTANCE_NAME`_rxMessageLength |= ((l_u16) frame[`$INSTANCE_NAME`_PDU_LEN_IDX]);
                    ...
                    `$INSTANCE_NAME`_PDU_PCI_TYPE_CF)
            {
                ...
                * PCI is valid.
                */
                if((tmpPci == `$INSTANCE_NAME`_PDU_PCI_TYPE_FF) || (tmpPci == `$INSTANCE_NAME`_PDU_PCI_TYPE_CF))
                {
                    /* Store the result of condition check operand in temporary
        ...
        if(`$INSTANCE_NAME`_NAD_FUNCTIONAL != `$INSTANCE_NAME`_mrfBuffer[`$INSTANCE_NAME`_PDU_NAD_IDX])
        {
