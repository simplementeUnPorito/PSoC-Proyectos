...
/* Internal APIs */
static l_u8    `$INSTANCE_NAME`_FindPidIndex(l_u8 pid) `=ReentrantKeil($INSTANCE_NAME . "_FindPidIndex")`;
static void    `$INSTANCE_NAME`_EndFrame(l_u8 status) `=ReentrantKeil($INSTANCE_NAME . "_EndFrame")`;
...
static l_u8 `$INSTANCE_NAME`_TransmitTLFrame(l_u8 stimulus) `=ReentrantKeil($INSTANCE_NAME . "_TransmitTLFrame")`;
static void `$INSTANCE_NAME`_ClrRxBuffer(l_u8 stimulus)  `=ReentrantKeil($INSTANCE_NAME . "_ClrRxBuffer")`;
static void `$INSTANCE_NAME`_ClrTxBuffer(l_u8 stimulus)   `=ReentrantKeil($INSTANCE_NAME . "_ClrTxBuffer")`;
static void `$INSTANCE_NAME`_CheckNodeState(l_u8 stimulus)   `=ReentrantKeil($INSTANCE_NAME . "_CheckNodeState")`;
static l_u8 `$INSTANCE_NAME`_ProcessMrf(l_u8 frame[]) `=ReentrantKeil($INSTANCE_NAME . "_ProcessMrf")`;
            ...
            static l_bool `$INSTANCE_NAME`_LinProductId(volatile const l_u8 frameData[])
                                        `=ReentrantKeil($INSTANCE_NAME . "_LinProductId")`;
    ...
    /* Free-running timer */
    static l_u8    `$INSTANCE_NAME`_periodCounter;
...
*****************************************************/
    ...
    static volatile l_u8 `$INSTANCE_NAME`_nodeState = `$INSTANCE_NAME`_IDLE;
...
void `$INSTANCE_NAME`_Stop(void) `=ReentrantKeil($INSTANCE_NAME . "_Stop")`
{
    ...
    `$INSTANCE_NAME`_CONTROL_REG &= (l_u8) ~`$INSTANCE_NAME`_CONTROL_ENABLE;

    /* Disable interrupts */
    (void)l_sys_irq_disable_`$INSTANCE_NAME`();
}
...
l_bool l_ifc_init_`$INSTANCE_NAME`(void) `=ReentrantKeil("l_ifc_init_" . $INSTANCE_NAME)`
{
    ...
    (void) CyIntSetVector(`$INSTANCE_NAME`_BLIN_ISR_NUMBER, &`$INSTANCE_NAME`_BLIN_ISR);
    ...
    (void) CyIntSetVector(`$INSTANCE_NAME`_UART_ISR_NUMBER, &`$INSTANCE_NAME`_UART_ISR);

    /* Start UART */
    `$INSTANCE_NAME`_UART_Start();

    /* Set Break Detection Threshold in counts */
    `$INSTANCE_NAME`_BREAK_THRESHOLD_REG = (l_u8) `$INSTANCE_NAME`_BREAK_THRESHOLD_VALUE;
...
void l_ifc_wake_up_`$INSTANCE_NAME`(void) `=ReentrantKeil("l_ifc_wake_up_" . $INSTANCE_NAME)`
{
    ...
    `$INSTANCE_NAME`_CONTROL_REG &= ((l_u8) ~`$INSTANCE_NAME`_CONTROL_TX_DIS);
}
...
*
*******************************************************************************/
l_u16 l_ifc_ioctl_`$INSTANCE_NAME`(l_ioctl_op op, void* pv) `=ReentrantKeil("l_ifc_ioctl_")`
{
        ...
        ***********************************************************************/
        case L_IOCTL_WAKEUP:
            ...
            for(i = 0u; i < `$INSTANCE_NAME`_NUM_FRAMES; i++)
            {
                ...
                ld_init_`$INSTANCE_NAME`();

            #endif /* (1u == `$INSTANCE_NAME`_TL_ENABLED) */

            if(0u != `$INSTANCE_NAME`_backup.enableState)
            {
                l_sys_irq_restore_`$INSTANCE_NAME`(`$INSTANCE_NAME`_ALL_IRQ_ENABLE);
            }
...
void l_ifc_rx_`$INSTANCE_NAME`(void) `=ReentrantKeil("l_ifc_rx_" . $INSTANCE_NAME)`
{
    ...
    static volatile l_u8* `$INSTANCE_NAME`_frameData = NULL;  /* Pointer to frame data. Points to the byte to be sent.*/
    ...
    switch(`$INSTANCE_NAME`_uartFsmState)
    {
                                        ...
                                        else
                                        {
                                            ...
                                            */
                                            ...
                                            else
                                            {
                                                ...
                                                /* Update the user buffer pointer */
                                                `$INSTANCE_NAME`_txTlDataCount += `$INSTANCE_NAME`_FRAME_DATA_SIZE_6;
                                            ...
                                            if(`$INSTANCE_NAME`_txMessageLength > `$INSTANCE_NAME`_FRAME_DATA_SIZE_6)
                                            {
                                                `$INSTANCE_NAME`_txMessageLength -= `$INSTANCE_NAME`_FRAME_DATA_SIZE_6;
                                            }
                                            else
                                            {
                                 ...
                                 `$INSTANCE_NAME`_pidInfoTable[`$INSTANCE_NAME`_pidIndex].param))
                        {
                            ...
                            /* SAE J2602 is disabled */
                                          ...
                                          `$INSTANCE_NAME`_pidInfoTable[`$INSTANCE_NAME`_pidIndex].param))
                                {
                                    ...
                                    `$INSTANCE_NAME`_tmpData = `$INSTANCE_NAME`_parityTable[
                                        `$INSTANCE_NAME`_pidInfoTable[`$INSTANCE_NAME`_pidIndex].associatedPID];
        ...
        ***********************************************************************/
        case `$INSTANCE_NAME`_UART_ISR_STATE_2_TX:
            ...
            if((`$INSTANCE_NAME`_tmpData != (l_u8)`$INSTANCE_NAME`_UART_ReadRxData()) ||
        ...
        case `$INSTANCE_NAME`_UART_ISR_STATE_3_RX:
            ...
            if(0u  != (`$INSTANCE_NAME`_FSM_FRAMING_ERROR_FLAG & `$INSTANCE_NAME`_fsmFlags))
            {
                    ...
                    (0u == `$INSTANCE_NAME`_frameErrorAfterPID))
                {
                    ...
                    (void)`$INSTANCE_NAME`_UART_ReadRxData();
            ...
            else
            {
                ...
                /* Clear response error signal if frame contains RESPONSE ERROR signal */
                    ...
                    if(`$INSTANCE_NAME`_FRAME_PID_MRF == `$INSTANCE_NAME`_framePid)
                    {
                        ...
                        else if(`$INSTANCE_NAME`_NAD_FUNCTIONAL == 
    ...
    ***************************************************************************/
    ...
    #ifdef L_IFC_RX_`$INSTANCE_NAME`_CALLBACK
        l_ifc_rx_`$INSTANCE_NAME`_Callback();
    #endif /* L_IFC_RX_`$INSTANCE_NAME`_CALLBACK */
}
...
void l_ifc_aux_`$INSTANCE_NAME`(void) `=ReentrantKeil("l_ifc_aux_" . $INSTANCE_NAME)`
{
    ...
    ***************************************************************************/
    if(0u != (`$INSTANCE_NAME`_auxStatus & `$INSTANCE_NAME`_STATUS_BREAK_DETECTED))
    {
        ...
        ***********************************************************************/
        `$INSTANCE_NAME`_CONTROL_REG &= ((l_u8) ~`$INSTANCE_NAME`_CONTROL_RX_DIS);
        ...
        {           
            ...
            if(`$INSTANCE_NAME`_syncCounts != `$INSTANCE_NAME`_EXPECTED_TIME_COUNTS)
            {
                if(`$INSTANCE_NAME`_ABS(((int32)`$INSTANCE_NAME`_syncCounts -
                    (int32)`$INSTANCE_NAME`_EXPECTED_TIME_COUNTS)) < (int32)`$INSTANCE_NAME`_TIME_COUNTS_MAX_DEVIATION)
                {
                    /* As BR_COUNTER uses 0x80 as base for frequency measuring
                    *  divide its contant on 0x80 and round off result checking last thrown bit */

                    tmp = ((uint32)`$INSTANCE_NAME`_initialClockDivider * (uint32)`$INSTANCE_NAME`_syncCounts);

                    `$INSTANCE_NAME`_correctedClockDivider = (uint32)(tmp >> `$INSTANCE_NAME`_BR_BASE_SHIFT);

                    `$INSTANCE_NAME`_correctedClockDivider += (l_u16)
                        (( 0u != (tmp & (l_u8)(1u <<(`$INSTANCE_NAME`_BR_BASE_SHIFT-1u)))) ? 1u : 0u);

                    `$INSTANCE_NAME`_IntClk_SetDividerRegister((uint16)`$INSTANCE_NAME`_correctedClockDivider, 0u);
            ...
            `$INSTANCE_NAME`_UART_RX_FIFO_REG &= ((l_u8) ~`$INSTANCE_NAME`_UART_RX_FIFO_CLEAR);
    ...
    ***************************************************************************/
    ...
    #ifdef L_IFC_AUX_`$INSTANCE_NAME`_CALLBACK
        l_ifc_aux_`$INSTANCE_NAME`_Callback();
    #endif /* L_IFC_AUX_`$INSTANCE_NAME`_CALLBACK */
...
*
*******************************************************************************/
l_irqmask l_sys_irq_disable_`$INSTANCE_NAME`(void)`=ReentrantKeil("l_sys_irq_disable")`
{
...
*
*******************************************************************************/
void l_sys_irq_restore_`$INSTANCE_NAME`(l_irqmask previous)`=ReentrantKeil("l_sys_irq_restore")`
{
...
static void `$INSTANCE_NAME`_EndFrame(l_u8 status) `=ReentrantKeil($INSTANCE_NAME . "_EndFrame")`
{
    ...
    else if((status == `$INSTANCE_NAME`_HANDLING_RESET_FSM_ERR) || (status == `$INSTANCE_NAME`_HANDLING_DONT_SAVE_PID))
    {
        ...
        *******************************************************************/
        ...
        `$INSTANCE_NAME`_UART_ClearTxBuffer();
...
/* SAE J2602 is disabled */
    ...
    *
    *******************************************************************************/
    void ld_init_`$INSTANCE_NAME`(void) `=ReentrantKeil("ld_init")`
    {
        l_u8 interruptState;
    ...
    *  l_ifc_read_status_`$INSTANCE_NAME`).
    ...
    *******************************************************************************/
    l_u8 ld_read_configuration_`$INSTANCE_NAME`(l_u8* pData, l_u8* const length)
                                                `=ReentrantKeil("ld_read_configuration")`
    {
        l_u8 i;
    ...
    *******************************************************************************/
    l_u8 ld_set_configuration_`$INSTANCE_NAME`(const l_u8* const pData, l_u16 length)
                                                     `=ReentrantKeil("ld_set_configuration")`
    {
        l_u8 i;
        ...
        return(result);
            ...
            *******************************************************************************/
            l_u8 ld_read_by_id_callout_`$INSTANCE_NAME`(l_u8 id, l_u8* frameData)
                                                        `=ReentrantKeil("ld_read_by_id_callout_" . $INSTANCE_NAME)`
            {
                ...
                #ifdef LD_READ_BY_ID_CALLOUT_`$INSTANCE_NAME`_CALLBACK
                    ld_read_by_id_callout_`$INSTANCE_NAME`_Callback();
                #endif /* LD_READ_BY_ID_CALLOUT_`$INSTANCE_NAME`_CALLBACK */
    ...
    *******************************************************************************/
    static void `$INSTANCE_NAME`_ClrRxBuffer(l_u8 stimulus)`=ReentrantKeil($INSTANCE_NAME . "_ClrRxBuffer")`
    {
        ...
        #if(1u == `$INSTANCE_NAME`_TL_API_FORMAT)
            if (`$INSTANCE_NAME`_tlLengthPointer != NULL)
            {
                /* Clear length of erroneous frame */
                *`$INSTANCE_NAME`_tlLengthPointer = 0u;
            }
        #endif /* (1u == `$INSTANCE_NAME`_TL_API_FORMAT) */
        ...
        `$INSTANCE_NAME`_rxFrameCounter = 0u;
            ...
            else if(stimulus == `$INSTANCE_NAME`_MRF_ALIEN_NAD)
            {
                `$INSTANCE_NAME`_rxTlStatus = LD_FAILED;
            }
            else
            {
                if((`$INSTANCE_NAME`_rxTlStatus != LD_FAILED)   &&
    ...
    *******************************************************************************/
    static void `$INSTANCE_NAME`_ClrTxBuffer(l_u8 stimulus)`=ReentrantKeil($INSTANCE_NAME . "_ClrTxBuffer")`
    {
        ...
        `$INSTANCE_NAME`_txPrevPci = `$INSTANCE_NAME`_PDU_PCI_TYPE_UNKNOWN;
            ...
            {
                if((`$INSTANCE_NAME`_txTlStatus != LD_FAILED)   &&
                   (`$INSTANCE_NAME`_txTlStatus != LD_N_AS_TIMEOUT))
                {
    ...
    *******************************************************************************/
    static l_u8 `$INSTANCE_NAME`_ProcessMrf(l_u8 frame[])`=ReentrantKeil($INSTANCE_NAME . "_ProcessMrf")`
    {
                            ...
                            case `$INSTANCE_NAME`_NCS_READ_BY_ID:
                                    ...
                                    (frame[`$INSTANCE_NAME`_PDU_D1_IDX] <= 63u))     /* User defined identification */
                                {
                                    if(1u == tempStatus)
                                    {
                                        ...
                                        */
                                        tempStatus =
                                            ld_read_by_id_callout_`$INSTANCE_NAME`(frame[`$INSTANCE_NAME`_PDU_D1_IDX],
                            ...
                            case `$INSTANCE_NAME`_NCS_COND_CHANGE_NAD:
                                ...
                                else if(`$INSTANCE_NAME`_NCS_READ_BY_ID_SERIAL == frame[`$INSTANCE_NAME`_PDU_D1_ID_IDX])
                                {
                                    if((5u < frame[`$INSTANCE_NAME`_PDU_D2_BYTE_IDX]) &&
                                        (0u != frame[`$INSTANCE_NAME`_PDU_D2_BYTE_IDX]))
                                    {
                                        /* Byte = 1 corresponds to the first byte (`$INSTANCE_NAME`_serialNumber[0]) */
                                        if(0u == ((
      ...
      return(return_value);
        ...
        *
        *******************************************************************************/
        void ld_receive_message_`$INSTANCE_NAME`(l_u16* const length, l_u8* const nad, l_u8* const ld_data)
        ...
        *
        *******************************************************************************/
        l_u8 ld_tx_status_`$INSTANCE_NAME`(void) `=ReentrantKeil("ld_tx_status")`
        {
            l_u8 status = `$INSTANCE_NAME`_txTlStatus;
        ...
        *
        *******************************************************************************/
        l_u8 ld_rx_status_`$INSTANCE_NAME`(void) `=ReentrantKeil("ld_rx_status")`
        {
            l_u8 status = `$INSTANCE_NAME`_rxTlStatus;
        ...
        *
        *******************************************************************************/
        void ld_put_raw_`$INSTANCE_NAME`( const l_u8* const ld_data) `=ReentrantKeil("ld_put_raw")`
        {
            l_u8 interruptState;
            l_u8 i;
        ...
        *
        *******************************************************************************/
        void ld_get_raw_`$INSTANCE_NAME`(l_u8* const ld_data) `=ReentrantKeil("ld_get_raw")`
        {
            l_u8 interruptState;
            l_u8 i;
        ...
        *
        *******************************************************************************/
        l_u8 ld_raw_tx_status_`$INSTANCE_NAME`(void) `=ReentrantKeil("ld_raw_tx_status")`
        {
        ...
        *
        *******************************************************************************/
        l_u8 ld_raw_rx_status_`$INSTANCE_NAME`(void) `=ReentrantKeil("ld_raw_rx_status")`
        {
