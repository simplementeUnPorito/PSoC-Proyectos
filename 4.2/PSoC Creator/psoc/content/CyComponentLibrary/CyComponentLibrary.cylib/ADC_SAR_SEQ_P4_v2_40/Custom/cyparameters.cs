...
using ADC_SAR_SEQ_P4_v2_40.Tabs;
...
namespace ADC_SAR_SEQ_P4_v2_40
{
    ...
    public class CyParameters
    {
        ...
        public bool IsPSoC4AS2
        {
            get { return m_instQuery.DeviceQuery.IsPSoC4 &&
                         m_instQuery.DeviceQuery.DeviceFamilyAvailable &&
                         m_instQuery.DeviceQuery.ArchFamilyMember == PSOC4AS2_ARCH_FAMILY; }
        }
        ...
        private CyEVRefSelect GetValidVrefSelectValue(CyEVRefSelect currentValue)
        {
            ...
            if ((currentValue == CyEVRefSelect.Internal1024) && IsPSoC4AS2)
            {
                validValue = CyEVRefSelect.InternalVref;
            }
            else if ((currentValue == CyEVRefSelect.InternalVref) && (IsPSoC4AS2 == false))
            {
