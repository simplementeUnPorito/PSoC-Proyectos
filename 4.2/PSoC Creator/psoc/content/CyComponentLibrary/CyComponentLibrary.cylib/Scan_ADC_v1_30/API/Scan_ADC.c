...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_StartEx
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_InitConfig
*
*******************************************************************************/
...
* 
* \param restart Determines if the `$INSTANCE_NAME` should be  restarted after 
* selecting the configuration.
**
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_SelectConfig
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_StartConvert
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_StopConvert
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_SetConvertMode
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_IRQ_Enable
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_IRQ_Disable
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_SetEosMask
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_SetChanMask
*
*******************************************************************************/
...
* | `$INSTANCE_NAME`_RETURN_STATUS_INJ   | Immediately returns the conversion status for the injection channel. If the value returned is zero, the conversion is not complete, and this function should be retried until a nonzero result is returned. |
* | `$INSTANCE_NAME`_WAIT_FOR_RESULT_INJ | Does not return a result until the `$INSTANCE_NAME` completes injection channel conversion. |
* 
...
* 
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_IsEndConversion
*
*******************************************************************************/
...
* 
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_GetResult16
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_GetResult32
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_SetLowLimit
*
*******************************************************************************/
...
* 
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_SetHighLimit
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_SetLimitMask
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_SetSatMask
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_SetOffset
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_CountsTo_Volts
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_CountsTo_mVolts
*
*******************************************************************************/
...
*
* <b>Code Snippet</b>
*  \snippet main.c snippet_`$INSTANCE_NAME`_CountsTo_uVolts
*
*******************************************************************************/
...
{   
    ...
    *
    * <b>Code Snippet</b>
    *  \snippet main.c snippet_`$INSTANCE_NAME`_TrimFilterVos
    *
    *******************************************************************************/
    ...
    static uint32 `$INSTANCE_NAME`_SetOpampAndAgndTrim(uint32 opampTrim, uint32 agndTrim)
    {
        ...
        uint32 trimRegVal = `$INSTANCE_NAME`_UABH_A_OA_TRIM_REG;
        ...
        `$INSTANCE_NAME`_UABH_A_OA_TRIM_REG = trimRegVal;
