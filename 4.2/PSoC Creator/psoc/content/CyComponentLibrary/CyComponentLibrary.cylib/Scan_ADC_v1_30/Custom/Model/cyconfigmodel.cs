...
namespace Scan_ADC_v1_30
{
    ...
    public class CyConfigModel
    {
        ...
        /// </summary>
        [XmlIgnore]
        public int MinSarFrequency { get { return 1000000; } }

        /// <summary>
        /// Maximum SAR frequency in Hz for 12-bit operation.
        /// </summary>
        [XmlIgnore]
        public int MaxSarFrequency
        {
            get
            {
                switch (VrefSource)
                {
                    ...
                    default:
                        return VrefBypass ? 18000000 : 1600000;
                }
            }
        }
        ...
        public CyConfigModel(int numRows)
        {
            ...
            if (numRows > CyParamRanges.NUM_CHANNEL_MAX)
            {
                numRows = CyParamRanges.NUM_CHANNEL_MAX;
            }
        ...
        public long ComputeHighScanRateLimit(CyClockData clkDat, bool isClkExt)
        {
            ...
            scheduler.TargetScanRate_sps = 2000000;
        ...
        private void UnloadScheduler(CyScheduler scheduler)
        {
            ...
            for (int timerNum = 0; timerNum < CyParamRanges.APERTURE_TIMER_COUNT; timerNum++)
            {
                this.ApertureTimers[timerNum] = (timers[timerNum] > 0)
                    ? (int)timers[timerNum]
                    : CyParamRanges.APERTURE_TIMER_MIN;
            }
        ...
        private void LoadScheduler(CyScheduler scheduler, CyClockData clockData)
        {
            ...
            scheduler.AdcClockFreqMin_Hz = this.MinSarFrequency;
            scheduler.AdcClockFreqMax_Hz = this.MaxSarFrequency;
