...
namespace Scan_ADC_v1_30
{
    public class CyCommonTab : CyTabControlWrapper
    {
        ...
        public override string TabName
        {
            get
            {
                return global::Scan_ADC_v1_30.View.cytooltips.commonTabName;
            }
        }
        #endregion
        ...
        {
            this.m_commonToolTip.SetToolTip(this.m_lNumberOfConfigs, Scan_ADC_v1_30.View.cytooltips.numberOfConfigsToolTip);
            this.m_commonToolTip.SetToolTip(this.m_nudNumberOfConfigs, Scan_ADC_v1_30.View.cytooltips.numberOfConfigsToolTip);
            this.m_commonToolTip.SetToolTip(this.m_cbExternalClk, Scan_ADC_v1_30.View.cytooltips.clockToolTip);
