...
#define `$INSTANCE_NAME`_`$Config1_Name`_INPUT_RANGE        (`$ADC_Input_Range`u)
#define `$INSTANCE_NAME`_`$Config1_Name`_SRATE              (`$Sample_Rate`u)
#define `$INSTANCE_NAME`_`$Config1_Name`_REFERENCE          (`$ADC_Reference`u)
#define `$INSTANCE_NAME`_`$Config1_Name`_BUFFER_GAIN        (`$Input_Buffer_Gain`u)
#define `$INSTANCE_NAME`_`$Config1_Name`_CONV_MODE          (`$Conversion_Mode`u)
#define `$INSTANCE_NAME`_`$Config1_Name`_INPUT_RANGE_VALUE  (`$ADC_Input_RangeValue`)
...
#define `$INSTANCE_NAME`_MI_ENABLE                          (`$EnableModulatorInput`u)

/* Configuration constants which can be used as the "config" parameter of
*  `$INSTANCE_NAME`_SelectConfiguration() API.
*/
#define `$INSTANCE_NAME`_`$Config1_Name`                (1u)
#define `$INSTANCE_NAME`_`$Config2_Name`                (2u)
#define `$INSTANCE_NAME`_`$Config3_Name`                (3u)
#define `$INSTANCE_NAME`_`$Config4_Name`                (4u)
...
/* Trim value defines */
#define `$INSTANCE_NAME`_DEC_TRIM_VREF_DIFF_8_15        (int8)(CY_GET_XTND_REG8(`$INSTANCE_NAME`_DEC__TRIM__M5))
#define `$INSTANCE_NAME`_DEC_TRIM_VREF_DIFF_16_20       (int8)(CY_GET_XTND_REG8(`$INSTANCE_NAME`_DEC__TRIM__M1))
#define `$INSTANCE_NAME`_DEC_TRIM_VREF_2_DIFF_8_15      (int8)(CY_GET_XTND_REG8(`$INSTANCE_NAME`_DEC__TRIM__M6))
#define `$INSTANCE_NAME`_DEC_TRIM_VREF_2_DIFF_16_20     (int8)(CY_GET_XTND_REG8(`$INSTANCE_NAME`_DEC__TRIM__M2))
#define `$INSTANCE_NAME`_DEC_TRIM_VREF_4_DIFF_8_15      (int8)(CY_GET_XTND_REG8(`$INSTANCE_NAME`_DEC__TRIM__M7))
#define `$INSTANCE_NAME`_DEC_TRIM_VREF_4_DIFF_16_20     (int8)(CY_GET_XTND_REG8(`$INSTANCE_NAME`_DEC__TRIM__M3))
#define `$INSTANCE_NAME`_DEC_TRIM_VREF_16_DIFF_8_15     (int8)(CY_GET_XTND_REG8(`$INSTANCE_NAME`_DEC__TRIM__M8))
#define `$INSTANCE_NAME`_DEC_TRIM_VREF_16_DIFF_16_20    (int8)(CY_GET_XTND_REG8(`$INSTANCE_NAME`_DEC__TRIM__M4))

#define `$INSTANCE_NAME`_PRES_DELAY_TIME                (3u)        /* 3 us */

#define `$INSTANCE_NAME`_1V_COUNTS                      (1.0F)
#define `$INSTANCE_NAME`_1MV_COUNTS                     (1000)
#define `$INSTANCE_NAME`_1UV_COUNTS                     (1000000L)
#define `$INSTANCE_NAME`_DIVISOR_1                      (1)
#define `$INSTANCE_NAME`_DIVISOR_2                      (2)
#define `$INSTANCE_NAME`_DIVISOR_4                      (4)
#define `$INSTANCE_NAME`_DIVISOR_8                      (8)
#define `$INSTANCE_NAME`_DIVISOR_16                     (16)
#define `$INSTANCE_NAME`_DIVISOR_32                     (32)
#define `$INSTANCE_NAME`_DIVISOR_64                     (64)
#define `$INSTANCE_NAME`_DIVISOR_125                    (125)
#define `$INSTANCE_NAME`_DIVISOR_250                    (250)
#define `$INSTANCE_NAME`_DIVISOR_500                    (500)
...
extern volatile uint8 `$INSTANCE_NAME`_convDone;
extern volatile uint8 `$INSTANCE_NAME`_stopConversion;
extern volatile uint8 `$INSTANCE_NAME`_started;
extern volatile uint8 `$INSTANCE_NAME`_Config;
extern volatile int32 `$INSTANCE_NAME`_Offset;
extern volatile int32 `$INSTANCE_NAME`_CountsPerVolt;
...
#define `$INSTANCE_NAME`_DSM_DEM1_MASK              (0xFFu)
...
#define `$INSTANCE_NAME`_DSM_GAIN_SHIFT             (2u)
...
#define `$INSTANCE_NAME`_DEC_OCOR_EN                (0x20u) /* Offset correction enable */
...
#define `$INSTANCE_NAME`_DEC_CR_SR_16B_PTR        ( (reg16 *) `$INSTANCE_NAME`_DEC__CR )
...
#define `$INSTANCE_NAME`_DEC_SHIFT_16B_PTR        ( (reg16 *) `$INSTANCE_NAME`_DEC__SHIFT1 )
...
#define `$INSTANCE_NAME`_DEC_DR2_16B_PTR          ( (reg16 *) `$INSTANCE_NAME`_DEC__DR2 )
...
#define `$INSTANCE_NAME`_DEC_DR1_16B_PTR          ( (reg16 *) `$INSTANCE_NAME`_DEC__DR1 )
...
#define `$INSTANCE_NAME`_DEC_OCOR_16B_PTR         ( (reg16 *) `$INSTANCE_NAME`_DEC__OCOR )
...
#define `$INSTANCE_NAME`_DEC_OCORH_16B_PTR        ( (reg16 *) `$INSTANCE_NAME`_DEC__OCORH )
...
#define `$INSTANCE_NAME`_DEC_GVAL_16B_PTR         ( (reg16 *) `$INSTANCE_NAME`_DEC__GVAL )
...
#define `$INSTANCE_NAME`_DEC_GCOR_16B_PTR         ( (reg16 *) `$INSTANCE_NAME`_DEC__GCOR )
...
#define `$INSTANCE_NAME`_DEC_SAMP_16B_PTR         ( (reg16 *) `$INSTANCE_NAME`_DEC__OUTSAMP )
...
#define `$INSTANCE_NAME`_DEC_SAMPH_16B_PTR        ( (reg16 *) `$INSTANCE_NAME`_DEC__OUTSAMPH )
...
#define `$INSTANCE_NAME`_DEC_COHER_16B_PTR        ( (reg16 *) `$INSTANCE_NAME`_DEC__COHER )
...
#define `$INSTANCE_NAME`_DSM_CR0_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR0 )
#define `$INSTANCE_NAME`_DSM_CR0_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR0 )

#define `$INSTANCE_NAME`_DSM_CR1_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR1 )
#define `$INSTANCE_NAME`_DSM_CR1_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR1 )

#define `$INSTANCE_NAME`_DSM_CR2_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR2 )
#define `$INSTANCE_NAME`_DSM_CR2_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR2 )

#define `$INSTANCE_NAME`_DSM_CR3_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR3 )
#define `$INSTANCE_NAME`_DSM_CR3_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR3 )

#define `$INSTANCE_NAME`_DSM_CR4_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR4 )
#define `$INSTANCE_NAME`_DSM_CR4_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR4 )

#define `$INSTANCE_NAME`_DSM_CR5_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR5 )
#define `$INSTANCE_NAME`_DSM_CR5_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR5 )

#define `$INSTANCE_NAME`_DSM_CR6_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR6 )
#define `$INSTANCE_NAME`_DSM_CR6_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR6 )

#define `$INSTANCE_NAME`_DSM_CR7_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR7 )
#define `$INSTANCE_NAME`_DSM_CR7_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR7 )

#define `$INSTANCE_NAME`_DSM_CR8_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR8 )
#define `$INSTANCE_NAME`_DSM_CR8_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR8 )

#define `$INSTANCE_NAME`_DSM_CR9_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CR9 )
#define `$INSTANCE_NAME`_DSM_CR9_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CR9 )

#define `$INSTANCE_NAME`_DSM_CR10_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__CR10 )
#define `$INSTANCE_NAME`_DSM_CR10_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__CR10 )

#define `$INSTANCE_NAME`_DSM_CR11_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__CR11 )
#define `$INSTANCE_NAME`_DSM_CR11_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__CR11 )

#define `$INSTANCE_NAME`_DSM_CR12_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__CR12 )
#define `$INSTANCE_NAME`_DSM_CR12_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__CR12 )

#define `$INSTANCE_NAME`_DSM_CR13_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__CR13 )
#define `$INSTANCE_NAME`_DSM_CR13_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__CR13 )

#define `$INSTANCE_NAME`_DSM_CR14_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__CR14 )
#define `$INSTANCE_NAME`_DSM_CR14_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__CR14 )

#define `$INSTANCE_NAME`_DSM_CR15_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__CR15 )
#define `$INSTANCE_NAME`_DSM_CR15_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__CR15 )

#define `$INSTANCE_NAME`_DSM_CR16_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__CR16 )
#define `$INSTANCE_NAME`_DSM_CR16_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__CR16 )

#define `$INSTANCE_NAME`_DSM_CR17_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__CR17 )
#define `$INSTANCE_NAME`_DSM_CR17_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__CR17 )

#define `$INSTANCE_NAME`_DSM_REF0_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__REF0 )
#define `$INSTANCE_NAME`_DSM_REF0_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__REF0 )

#define `$INSTANCE_NAME`_DSM_REF1_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__REF1 )
#define `$INSTANCE_NAME`_DSM_REF1_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__REF1 )

#define `$INSTANCE_NAME`_DSM_REF2_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__REF2 )
#define `$INSTANCE_NAME`_DSM_REF2_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__REF2 )

#define `$INSTANCE_NAME`_DSM_REF3_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__REF3 )
#define `$INSTANCE_NAME`_DSM_REF3_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__REF3 )

#define `$INSTANCE_NAME`_DSM_DEM0_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__DEM0 )
#define `$INSTANCE_NAME`_DSM_DEM0_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__DEM0 )

#define `$INSTANCE_NAME`_DSM_DEM1_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__DEM1 )
#define `$INSTANCE_NAME`_DSM_DEM1_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__DEM1 )

#define `$INSTANCE_NAME`_DSM_MISC_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__MISC )
#define `$INSTANCE_NAME`_DSM_MISC_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__MISC )

#define `$INSTANCE_NAME`_DSM_CLK_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__CLK )
#define `$INSTANCE_NAME`_DSM_CLK_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__CLK )

#define `$INSTANCE_NAME`_DSM_TST0_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__TST0 )
#define `$INSTANCE_NAME`_DSM_TST0_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__TST0 )

#define `$INSTANCE_NAME`_DSM_TST1_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__TST1 )
#define `$INSTANCE_NAME`_DSM_TST1_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__TST1 )

#define `$INSTANCE_NAME`_DSM_BUF0_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__BUF0 )
#define `$INSTANCE_NAME`_DSM_BUF0_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__BUF0 )

#define `$INSTANCE_NAME`_DSM_BUF1_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__BUF1 )
#define `$INSTANCE_NAME`_DSM_BUF1_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__BUF1 )

#define `$INSTANCE_NAME`_DSM_BUF2_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__BUF2 )
#define `$INSTANCE_NAME`_DSM_BUF2_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__BUF2 )

#define `$INSTANCE_NAME`_DSM_BUF3_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__BUF3 )
#define `$INSTANCE_NAME`_DSM_BUF3_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__BUF3 )

#define `$INSTANCE_NAME`_DSM_OUT0_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__OUT0 )
#define `$INSTANCE_NAME`_DSM_OUT0_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__OUT0 )

#define `$INSTANCE_NAME`_DSM_OUT1_REG             (* (reg8 *) `$INSTANCE_NAME`_DSM__OUT1 )
#define `$INSTANCE_NAME`_DSM_OUT1_PTR             (  (reg8 *) `$INSTANCE_NAME`_DSM__OUT1 )

#define `$INSTANCE_NAME`_DSM_SW0_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__SW0 )
#define `$INSTANCE_NAME`_DSM_SW0_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__SW0 )

#define `$INSTANCE_NAME`_DSM_SW2_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__SW2 )
#define `$INSTANCE_NAME`_DSM_SW2_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__SW2 )

#define `$INSTANCE_NAME`_DSM_SW3_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__SW3 )
#define `$INSTANCE_NAME`_DSM_SW3_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__SW3 )

#define `$INSTANCE_NAME`_DSM_SW4_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__SW4 )
#define `$INSTANCE_NAME`_DSM_SW4_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__SW4 )

#define `$INSTANCE_NAME`_DSM_SW6_REG              (* (reg8 *) `$INSTANCE_NAME`_DSM__SW6 )
#define `$INSTANCE_NAME`_DSM_SW6_PTR              (  (reg8 *) `$INSTANCE_NAME`_DSM__SW6 )
...
#define `$INSTANCE_NAME`_`$Config1_Name`_DEC_DIV            (`$BIT_SHIFT_CFG1`)
...
#define `$INSTANCE_NAME`_`$Config1_Name`_COUNTS_PER_VOLT    (`$DFLT_COUNTS_PER_VOLT`)
...
#define `$INSTANCE_NAME`_`$Config1_Name`_ALIGNMENT          (`$ADC_Alignment`u)
#define `$INSTANCE_NAME`_`$Config1_Name`_ADC_CLK_DIVIDER    (`$DFLT_ADC_CLK_DIVIDER`u)
#define `$INSTANCE_NAME`_`$Config1_Name`_CP_CLK_DIVIDER     (`$DFLT_CP_CLK_DIVIDER`u)
...
#define `$INSTANCE_NAME`_`$Config1_Name`_BUF_GAIN           `$INSTANCE_NAME`_`$Config1_Name`_BUFFER_GAIN
#define `$INSTANCE_NAME`_`$Config1_Name`_RANGE              `$INSTANCE_NAME`_`$Config1_Name`_INPUT_RANGE
#define `$INSTANCE_NAME`_`$Config1_Name`_RANGE_VALUE        `$INSTANCE_NAME`_`$Config1_Name`_INPUT_RANGE_VALUE
...
#define `$INSTANCE_NAME`_`$Config2_Name`_DEC_DIV            (`$BIT_SHIFT_CFG2`)
...
#define `$INSTANCE_NAME`_`$Config2_Name`_COUNTS_PER_VOLT    (`$DFLT_COUNTS_PER_VOLT_CFG2`)
#define `$INSTANCE_NAME`_`$Config2_Name`_RESOLUTION         (`$ADC_Resolution_Config2`u)
#define `$INSTANCE_NAME`_`$Config2_Name`_CONV_MODE          (`$Conversion_Mode_Config2`u)
...
#define `$INSTANCE_NAME`_`$Config2_Name`_ALIGNMENT          (`$ADC_Alignment_Config2`u)
#define `$INSTANCE_NAME`_`$Config2_Name`_ADC_CLK_DIVIDER    (`$DFLT_ADC_CLK_DIVIDER_CFG2`u)
#define `$INSTANCE_NAME`_`$Config2_Name`_CP_CLK_DIVIDER     (`$DFLT_CP_CLK_DIVIDER_CFG2`u)
...
*   just to keep the component backward compatible
*/
#define `$INSTANCE_NAME`_`$Config2_Name`_CONVMODE           `$INSTANCE_NAME`_`$Config2_Name`_CONV_MODE
#define `$INSTANCE_NAME`_`$Config2_Name`_INPUT_MODE         `$INSTANCE_NAME`_DEFAULT_INPUT_MODE
...
#define `$INSTANCE_NAME`_`$Config3_Name`_DEC_DIV            (`$BIT_SHIFT_CFG3`)
...
#define `$INSTANCE_NAME`_`$Config3_Name`_COUNTS_PER_VOLT    (`$DFLT_COUNTS_PER_VOLT_CFG3`)
#define `$INSTANCE_NAME`_`$Config3_Name`_RESOLUTION         (`$ADC_Resolution_Config3`u)
#define `$INSTANCE_NAME`_`$Config3_Name`_CONV_MODE          (`$Conversion_Mode_Config3`u)
...
#define `$INSTANCE_NAME`_`$Config3_Name`_ALIGNMENT          (`$ADC_Alignment_Config3`u)
#define `$INSTANCE_NAME`_`$Config3_Name`_ADC_CLK_DIVIDER    (`$DFLT_ADC_CLK_DIVIDER_CFG3`u)
#define `$INSTANCE_NAME`_`$Config3_Name`_CP_CLK_DIVIDER     (`$DFLT_CP_CLK_DIVIDER_CFG3`u)
...
*   just to keep the component backward compatible
*/
#define `$INSTANCE_NAME`_`$Config3_Name`_CONVMODE           `$INSTANCE_NAME`_`$Config3_Name`_CONV_MODE
#define `$INSTANCE_NAME`_`$Config3_Name`_INPUT_MODE         `$INSTANCE_NAME`_DEFAULT_INPUT_MODE
...
#define `$INSTANCE_NAME`_`$Config4_Name`_DEC_DIV            (`$BIT_SHIFT_CFG4`)
...
#define `$INSTANCE_NAME`_`$Config4_Name`_COUNTS_PER_VOLT    (`$DFLT_COUNTS_PER_VOLT_CFG4`)
#define `$INSTANCE_NAME`_`$Config4_Name`_RESOLUTION         (`$ADC_Resolution_Config4`u)
#define `$INSTANCE_NAME`_`$Config4_Name`_CONV_MODE          (`$Conversion_Mode_Config4`u)
...
#define `$INSTANCE_NAME`_`$Config4_Name`_ALIGNMENT          (`$ADC_Alignment_Config4`u)
#define `$INSTANCE_NAME`_`$Config4_Name`_ADC_CLK_DIVIDER    (`$DFLT_ADC_CLK_DIVIDER_CFG4`u)
#define `$INSTANCE_NAME`_`$Config4_Name`_CP_CLK_DIVIDER     (`$DFLT_CP_CLK_DIVIDER_CFG4`u)
...
*   just to keep the component backward compatible
*/
#define `$INSTANCE_NAME`_`$Config4_Name`_CONVMODE           `$INSTANCE_NAME`_`$Config4_Name`_CONV_MODE
#define `$INSTANCE_NAME`_`$Config4_Name`_INPUT_MODE         `$INSTANCE_NAME`_DEFAULT_INPUT_MODE
