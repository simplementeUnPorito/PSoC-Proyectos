...
namespace SegLCD_v3_40
{
    public partial class CyCustomCharsEditor : CyEditingWrapperControl
    {
            ...
            : base(parameters)
        {
            ...
            listBoxChars.ItemHeight = listBoxChars.Font.Height;
        ...
        private void toolStripButtonResetAll_Click(object sender, EventArgs e)
        {
            DialogResult dres = MessageBox.Show(Properties.Resources.CHARS_RESET_MSG,
                                                Properties.Resources.QUESTION_MSG_TITLE,
        ...
        private void toolStripButtonDefaultList_Click(object sender, EventArgs e)
        {
            DialogResult dres = MessageBox.Show(Properties.Resources.USE_DEFAULT_CHAR_LIST_MSG,
                                                Properties.Resources.QUESTION_MSG_TITLE, MessageBoxButtons.YesNo,
        ...
        private void SaveCharsTemplate()
        {
            ...
            {
                saveFileDialog1.Filter = Properties.Resources.CHARS_DIALOG_FILTER;
                saveFileDialog1.Title = Properties.Resources.SAVE_CHARS_TITLE;
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                        ...
                        using (StreamWriter strw = new StreamWriter(saveFileDialog1.FileName))
                        {
                            ...
                            catch (Exception)
                            {
                                MessageBox.Show(Properties.Resources.SAVE_TEMPLATE_ERROR_MSG,
                                                Properties.Resources.ERROR_MSG_TITLE,
                    ...
                    {
                        MessageBox.Show(Properties.Resources.WRITE_FILE_ERROR_MSG, Properties.Resources.ERROR_MSG_TITLE,
                                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
        ...
        private void LoadCharsTemplate()
        {
            ...
            {
                openFileDialog1.Filter = Properties.Resources.CHARS_DIALOG_FILTER;
                openFileDialog1.Title = Properties.Resources.OPEN_CHARS_TITLE;
                if (openFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    {
                        MessageBox.Show(Properties.Resources.OPEN_FILE_ERROR_MSG, Properties.Resources.ERROR_MSG_TITLE,
                                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
