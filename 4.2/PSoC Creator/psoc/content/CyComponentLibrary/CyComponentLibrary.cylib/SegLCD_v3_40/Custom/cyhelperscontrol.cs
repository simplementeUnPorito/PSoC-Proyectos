...
namespace SegLCD_v3_40
{
    ...
    public partial class CyHelpers : CyEditingWrapperControl
    {
        ...
        private void buttonAddHelper_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(String.Format(Properties.Resources.HELPERS_LIMIT_MSG, MAX_HELPERS_NUMBER),
            ...
            if (!fitInSpace)
            {
                MessageBox.Show(Properties.Resources.NOT_ENOUGH_SEG_COM_MSG, CyLCDParameters.INFORMATION_MSG_TITLE,
        ...
        private bool AddSymbol()
        {
            ...
            if (m_symbols.Count < m_parameters.m_helpersConfig[m_currentHelperIndex].MaxSymbolsCount)
            {
                ...
                toolTip1.SetToolTip(symbol.m_pBox, Properties.Resources.TIP_PIXELS_DRAG);
        ...
        private string GetPixelNameErrorText(CyPixelNameErrors error, string text)
        {
            ...
            if (error == CyPixelNameErrors.WRONG_FORMAT)
                ...
                res = String.Format(Properties.Resources.NOT_UNIQUE_NAME_MSG, text);
        ...
        private void printDocumentPixelMap_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            catch (Exception)
            {
                ...
                m_lastPrintedRow = 0;
                e.HasMorePages = false;
                MessageBox.Show(Properties.Resources.PRINT_ERROR_MSG, CyLCDParameters.ERROR_MSG_TITLE,
