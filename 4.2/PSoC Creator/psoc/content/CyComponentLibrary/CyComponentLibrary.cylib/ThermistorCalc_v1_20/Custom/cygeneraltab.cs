...
namespace ThermistorCalc_v1_20
{
    public partial class CyGeneralTab : UserControl, ICyParamEditingControl
    {
        ...
        private void InitUI()
        {
            ...
            m_cbCalcResolution.Items.Clear();
            m_cbCalcResolution.Items.AddRange(m_params.CalculationResolution.EnumDescriptionsList);

            this.m_numRefResistor.Minimum = decimal.MinValue;
            this.m_numRefResistor.Maximum = decimal.MaxValue;

            foreach (NumericUpDown numControl in m_tempControls)
            {
                numControl.Minimum = decimal.MinValue;
                numControl.Maximum = decimal.MaxValue;
            }
            ...
            #region LUT error
            m_errorProvider.SetIconAlignment(m_lblLutError, ErrorIconAlignment.TopLeft);
            #endregion
        }
        ...
        public void UpdateUI()
        {
            ...
            m_cbCalcResolution.SelectedItem = m_params.CalculationResolution.Description;
        ...
        void m_cbCalcResolution_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                m_params.CalculationResolution.Description = m_cbCalcResolution.Text;
                ValidateLUTSize();
            }
        }
        ...
        {
            if (m_lblLutError.Visible)
            {
                m_errorProvider.SetError(m_lblLutError, Resources.LUTErrorDescription);
            }
            else
            {
                m_errorProvider.SetError(m_lblLutError, string.Empty);
            }
        }
        #endregion
        ...
        void UpdateInfoText()
        {
            ...
            m_rtbInfo.SelectAll();
            m_rtbInfo.SelectionColor = SystemColors.ControlText;
        ...
        {
            m_lblLutError.Visible = !ValidateLUT() && (m_params.Implementation == CyEImplementation.LUT);
        }
        ...
        bool ValidateLUT()
        {
            ...
            double resolution = m_params.CalculationResolution.Value;
