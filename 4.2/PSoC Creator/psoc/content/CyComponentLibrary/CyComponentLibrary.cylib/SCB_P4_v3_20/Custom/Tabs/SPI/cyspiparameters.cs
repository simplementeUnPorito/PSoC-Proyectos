...
namespace SCB_P4_v3_20
{
    ...
    public partial class CyParamRanges
    {
        ...
        public const byte SPI_OVS_MASTER_MIN = 6;
    ...
    public partial class CyParameters
    {
        ...
        public uint SpiGetMinOversampling(ref string message)
        {
            ...
            {
                message = String.Format(Resources.MsgOvsMasterError,
                    CyParamRanges.SPI_OVS_MASTER_MIN, CyParamRanges.SPI_OVS_MASTER_MAX);
                return CyParamRanges.SPI_OVS_MASTER_MIN;
            }
        }
        ...
        public List<CyCustErr> GetSpiDrcErrors()
        {
            ...
            // SmartIO support
            if(SPI_SmartioEnable && !IsSmartioCapable)
            {
