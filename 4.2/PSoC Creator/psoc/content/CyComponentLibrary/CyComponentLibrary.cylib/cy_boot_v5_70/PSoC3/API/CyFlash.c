...
static cystatus CySetTempInt(void)`=ReentrantKeil("CySetTempInt")`;
...
*
*******************************************************************************/
cystatus CyFlash_EraseRow(uint8 arrayId, uint16 rowAddress)`=ReentrantKeil("CyFlash_EraseRow")`
{
...
*
*******************************************************************************/
cystatus CyFlashGetSpcAlgorithm(void) `=ReentrantKeil("CyFlashGetSpcAlgorithm")`
{
    cystatus status;
...
*
*******************************************************************************/
cystatus CyWriteRowData(uint8 arrayId, uint16 rowAddress, const uint8 * rowData) `=ReentrantKeil("CyWriteRowData")`
{
    uint16 rowSize;
    cystatus status;
...
*******************************************************************/
    ...
    *******************************************************************************/
    ...
    `=ReentrantKeil("CyWriteRowConfig")`
    {
        cystatus status;
