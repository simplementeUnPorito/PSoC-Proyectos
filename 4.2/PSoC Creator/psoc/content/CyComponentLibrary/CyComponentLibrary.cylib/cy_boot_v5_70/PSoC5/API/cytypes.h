...
#define CY_IP_HOBTO_DEVICE      (!(`=GetFeatureCount("m0s8cpuss")` == 1))
...
*******************************************************************************/
    ...
    /* Using SRSSv2 or SRS-Lite */
        ...
        #define CY_IP_SRSSV2            (`=GetFeatureCount("m0s8srssv2")` != 0)
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #define CY_IP_CPUSSV3           (`=GetFeatureCount("m0s8cpussv3")` == 1)
        #define CY_IP_CPUSSV2           (`=GetFeatureCount("m0s8cpussv2")` == 1)
        #define CY_IP_CPUSS             (`=GetFeatureCount("m0s8cpuss")` == 1)
    #else
    ...
    /* CM0 present or CM0+ present (1=CM0, 0=CM0+) */
        ...
        #else   /* CY_IP_CPUSSV3 */
            #define CY_IP_CPUSS_CM0         (`=GetFeatureParameter("m0s8cpussv3", "CM0_PRESENT")` == 1)
        #endif  /* (CY_IP_CPUSSV2) */
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #if (CY_IP_CPUSSV2)
            #define CY_IP_FM                (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_TYPE")` == 0)
            #define CY_IP_FMLT              (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_TYPE")` == 1)
            #define CY_IP_FS                (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_TYPE")` == 2)
            #define CY_IP_FSLT              (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_TYPE")` == 3)
        #else   /* CY_IP_CPUSSV3 */
            #define CY_IP_FM                (`=GetFeatureParameter("m0s8cpussv3", "SPCIF.FLASH_TYPE")` == 0)
            #define CY_IP_FMLT              (`=GetFeatureParameter("m0s8cpussv3", "SPCIF.FLASH_TYPE")` == 1)
            #define CY_IP_FS                (`=GetFeatureParameter("m0s8cpussv3", "SPCIF.FLASH_TYPE")` == 2)
            #define CY_IP_FSLT              (`=GetFeatureParameter("m0s8cpussv3", "SPCIF.FLASH_TYPE")` == 3)
        #endif  /* (CY_IP_CPUSSV2) */
    #else
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #if (CY_IP_CPUSSV2)
            #define CY_IP_FLASH_PARALLEL_PGM_EN (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_PARALLEL_PGM_EN")` == 1)
        #else   /* CY_IP_CPUSSV3 */
            #define CY_IP_FLASH_PARALLEL_PGM_EN (`=GetFeatureParameter("m0s8cpussv3", "SPCIF.FLASH_PARALLEL_PGM_EN")` == 1)
        #endif  /* (CY_IP_CPUSSV2) */
    #else
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #if (CY_IP_CPUSSV2)
            #define CY_IP_FLASH_MACROS (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_MACROS")`u)
        #else   /* CY_IP_CPUSSV3 */
            #define CY_IP_FLASH_MACROS (`=GetFeatureParameter("m0s8cpussv3", "SPCIF.FLASH_MACROS")`u)
        #endif  /* (CY_IP_CPUSSV2) */
    #else
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #if (CY_IP_CPUSSV2)
            #define CY_IP_INT_NR            (`=GetFeatureParameter("m0s8cpussv2", "INT_NR")`u)
        #else   /* CY_IP_CPUSSV3 */
            #define CY_IP_INT_NR            (`=GetFeatureParameter("m0s8cpussv3", "INT_NR")`u)
        #endif  /* (CY_IP_CPUSSV2) */
    #else
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #define CY_IP_BLESS             (`=GetFeatureCount("m0s8bless")` != 0)
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #define CY_IP_USBDEV            (`=GetFeatureCount("m0s8usbdss")` != 0)
    #else
    ...
    ***************************************************************************/
    #if (CY_IP_HOBTO_DEVICE)
        #if (CY_IP_CPUSSV2)
            #define CY_IP_SPCIF_SYNCHRONOUS     (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.SYNCHRONOUS")` == 1)
        #else   /* CY_IP_CPUSSV3 */
            #define CY_IP_SPCIF_SYNCHRONOUS     (`=GetFeatureParameter("m0s8cpussv3", "SPCIF.SYNCHRONOUS")` == 1)
        #endif  /* (CY_IP_CPUSSV2) */
    #else
    ...
    /* Watch Crystal Oscillator (WCO) is present (32kHz) */
        ...
        #else
            #define CY_IP_WCO_BLESS         (0 != 0)
            #define CY_IP_WCO_WCO           (`=GetFeatureCount("m0s8wco")` == 1)
            #define CY_IP_WCO_WCOV2         (0 != 0)
            #define CY_IP_WCO_SRSSV2        (`=GetFeatureParameter("m0s8srssv2", "EXCO.WCO_PRESENT")` == 1)
        #endif  /* (CY_IP_BLESS) */
    #else
        #define CY_IP_WCO_BLESS             (0 != 0)
        #define CY_IP_WCO_WCO               (0 != 0)
    ...
    /* External Crystal Oscillator is present (high frequency) */
            ...
            #define CY_IP_ECO_BLESS         (0 != 0)
            #define CY_IP_ECO_BLESSV3       (0 != 0)
            #define CY_IP_ECO_SRSSV2        (`=GetFeatureParameter("m0s8srssv2", "EXCO.ECO_PRESENT")` == 1)
            #define CY_IP_ECO_SRSSLT        ((`=GetFeatureCount("m0s8exco")` != 0) && (`=GetFeatureCount("s8srsslt")` != 0))
        #endif  /* (CY_IP_BLESS) */
    #else
        #define CY_IP_ECO_BLESS             (0 != 0)
        #define CY_IP_ECO_BLESSV3           (0 != 0)
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #if(CY_IP_SRSSV2)
            #define CY_IP_PLL           ((`=GetFeatureParameter("m0s8srssv2", "EXCO.PLL0_PRESENT")` != 0) || \
                                          (`=GetFeatureParameter("m0s8srssv2", "EXCO.PLL1_PRESENT")` != 0)) 

            #define CY_IP_PLL_NR        (`=GetFeatureParameter("m0s8srssv2", "EXCO.PLL0_PRESENT")`u + \
                                          `=GetFeatureParameter("m0s8srssv2", "EXCO.PLL1_PRESENT")`u)
        
        #elif (CY_IP_SRSSLT)
            #define CY_IP_PLL           (`=GetFeatureParameter("m0s8exco", "PLL_PRESENT")` == 1)
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #if (CY_IP_CPUSSV2)
            #define CY_SYSTICK_LFCLK_SOURCE     (`=GetFeatureParameter("m0s8cpussv2", "CM0_SYST_CLKSOURCE_LF")` != 0)
        #else   /* CY_IP_CPUSSV3 */
            #define CY_SYSTICK_LFCLK_SOURCE     (`=GetFeatureParameter("m0s8cpussv3", "CM0_SYST_CLKSOURCE_LF")` != 0)
        #endif  /* (CY_IP_CPUSSV2) */
    #else
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #if (CY_IP_CPUSSV2)
            #define CY_IP_DMAC_PRESENT      (`=GetFeatureParameter("m0s8cpussv2", "DMAC_PRESENT")` == 1)
        #else
            #define CY_IP_DMAC_PRESENT      (`=GetFeatureParameter("m0s8cpussv3", "DMAC_PRESENT")` == 1)
        #endif  /* (CY_IP_CPUSSV2) */
    #else
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #define CY_IP_PASS                  (`=GetFeatureCount("m0s8pass4b")` == 1)
    #else
    ...
    #if (CY_IP_HOBTO_DEVICE)
        #if (CY_IP_CPUSSV2)
            #define CY_IP_SL_NR             (`=GetFeatureParameter("m0s8cpussv2", "SL_NR")`)
        #else
            #define CY_IP_SL_NR             (`=GetFeatureParameter("m0s8cpussv3", "SL_NR")`)
        #endif  /* (CY_IP_CPUSSV2) */
    #else
