...
*
*******************************************************************************/
void CySpcStart(void) `=ReentrantKeil("CySpcStart")`
{
...
*
*******************************************************************************/
void CySpcStop(void) `=ReentrantKeil("CySpcStop")`
{
    /* Save current global interrupt enable and disable it */
    uint8 interruptState = CyEnterCriticalSection();
...
*
*******************************************************************************/
uint8 CySpcReadData(uint8 buffer[], uint8 size) `=ReentrantKeil("CySpcReadData")`
{
    uint8 i;
...
`=ReentrantKeil("CySpcLoadMultiByte")`
{
...
*
*******************************************************************************/
cystatus CySpcLoadRow(uint8 array, const uint8 buffer[], uint16 size)`=ReentrantKeil("CySpcLoadRow")`
{
    cystatus status = CYRET_STARTED;
    uint16 i;
...
`=ReentrantKeil("CySpcLoadRowFull")`
{
    cystatus status = CYRET_STARTED;
    uint16 i;
...
*
*******************************************************************************/
cystatus CySpcEraseSector(uint8 array, uint8 sectorNumber)`=ReentrantKeil("CySpcEraseSector")`
{
    cystatus status = CYRET_STARTED;
...
*
*******************************************************************************/
cystatus CySpcGetTemp(uint8 numSamples)`=ReentrantKeil("CySpcGetTemp")`
{
    cystatus status = CYRET_STARTED;
...
*
*******************************************************************************/
cystatus CySpcLock(void)`=ReentrantKeil("CySpcLock")`
{
...
*
*******************************************************************************/
void CySpcUnlock(void)`=ReentrantKeil("CySpcUnlock")`
{
    uint8 interruptState;
...
*
*******************************************************************************/
cystatus CySpcGetAlgorithm(void)`=ReentrantKeil("CySpcGetAlgorithm")`
{
    cystatus status = CYRET_STARTED;
