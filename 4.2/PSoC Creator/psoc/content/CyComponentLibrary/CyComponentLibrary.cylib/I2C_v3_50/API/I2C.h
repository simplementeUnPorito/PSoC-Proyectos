...
#define `$INSTANCE_NAME`_RESTORE_TIMEOUT    (255u)
    ...
    #define `$INSTANCE_NAME`_CTRL_START_MASK            ((uint8) (0x01u << `$INSTANCE_NAME`_CTRL_START_SHIFT))
    #define `$INSTANCE_NAME`_CTRL_STOP_MASK             ((uint8) (0x01u << `$INSTANCE_NAME`_CTRL_STOP_SHIFT))
    #define `$INSTANCE_NAME`_CTRL_RESTART_MASK          ((uint8) (0x01u << `$INSTANCE_NAME`_CTRL_RESTART_SHIFT))
    #define `$INSTANCE_NAME`_CTRL_NACK_MASK             ((uint8) (0x01u << `$INSTANCE_NAME`_CTRL_NACK_SHIFT))
    #define `$INSTANCE_NAME`_CTRL_ANY_ADDRESS_MASK      ((uint8) (0x01u << `$INSTANCE_NAME`_CTRL_ANY_ADDRESS_SHIFT))
    #define `$INSTANCE_NAME`_CTRL_TRANSMIT_MASK         ((uint8) (0x01u << `$INSTANCE_NAME`_CTRL_TRANSMIT_SHIFT))
    #define `$INSTANCE_NAME`_CTRL_ENABLE_MASTER_MASK    ((uint8) (0x01u << `$INSTANCE_NAME`_CTRL_ENABLE_MASTER_SHIFT))
    #define `$INSTANCE_NAME`_CTRL_ENABLE_SLAVE_MASK     ((uint8) (0x01u << `$INSTANCE_NAME`_CTRL_ENABLE_SLAVE_SHIFT))
    ...
    #define `$INSTANCE_NAME`_STS_LOST_ARB_MASK          ((uint8) (0x01u << `$INSTANCE_NAME`_STS_LOST_ARB_SHIFT))
    #define `$INSTANCE_NAME`_STS_STOP_MASK              ((uint8) (0x01u << `$INSTANCE_NAME`_STS_STOP_SHIFT))
    #define `$INSTANCE_NAME`_STS_BUSY_MASK              ((uint8) (0x01u << `$INSTANCE_NAME`_STS_BUSY_SHIFT))
    #define `$INSTANCE_NAME`_STS_ADDR_MASK              ((uint8) (0x01u << `$INSTANCE_NAME`_STS_ADDR_SHIFT))
    #define `$INSTANCE_NAME`_STS_MASTER_MODE_MASK       ((uint8) (0x01u << `$INSTANCE_NAME`_STS_MASTER_MODE_SHIFT))
    #define `$INSTANCE_NAME`_STS_LRB_MASK               ((uint8) (0x01u << `$INSTANCE_NAME`_STS_LRB_SHIFT))
    #define `$INSTANCE_NAME`_STS_BYTE_COMPLETE_MASK     ((uint8) (0x01u << `$INSTANCE_NAME`_STS_BYTE_COMPLETE_SHIFT))
...
#define `$INSTANCE_NAME`_GET_SLAVE_ADDR(dataReg)   (((dataReg) >> `$INSTANCE_NAME`_SLAVE_ADDR_SHIFT) & \
    ...
    #define `$INSTANCE_NAME`_CLEAR_START_GEN        do{ \
                                                        `$INSTANCE_NAME`_MCSR_REG &=                                   \
                                                                           ((uint8) ~`$INSTANCE_NAME`_MCSR_START_GEN); \
                                                    }while(0)
    ...
    #define `$INSTANCE_NAME`_DISABLE_INT_ON_STOP    do{ \
                                                        `$INSTANCE_NAME`_CFG_REG &=                                 \
                                                                           ((uint8) ~`$INSTANCE_NAME`_CFG_STOP_IE); \
                                                    }while(0)
    ...
    #define `$INSTANCE_NAME`_DISABLE_INT_ON_STOP    do{ \
                                                        `$INSTANCE_NAME`_INT_MASK_REG &=                               \
                                                                             ((uint8) ~`$INSTANCE_NAME`_STOP_IE_MASK); \
                                                    }while(0)
