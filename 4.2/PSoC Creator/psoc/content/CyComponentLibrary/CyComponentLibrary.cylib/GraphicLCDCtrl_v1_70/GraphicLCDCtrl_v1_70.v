/*******************************************************************************
* File Name: GraphicLCDCtrl_v1_70.v
...
`include "cypress.v"
`ifdef GraphicLCDCtrl_v1_70_V_ALREADY_INCLUDED
`else
`define GraphicLCDCtrl_v1_70_V_ALREADY_INCLUDED
module GraphicLCDCtrl_v1_70 
(
    input    wire         clock,      /* Clock that operates this component  */
    input    wire [7:0]   di_lsb,     /* Lower 8 bits of the input data bus  */
    input    wire [7:0]   di_msb,     /* Upper 8 bits of the input data bus  */
    ...
    ***************************************************************************/
    ...
    begin: SyncCtl 
        /* control_0 - sync mode  */
        cy_psoc3_control #(.cy_force_order(1), .cy_ctrl_mode_1(8'h0), .cy_ctrl_mode_0(8'h1)) ControlReg
        (
            /*  input         */  .clock(op_clk),
            /* output [07:00] */  .control(ctrl)
        );
    ...
    begin
        reset <= ~ctrl[GRAPH_LCD_CTL_ENABLE];
    end    
...
`endif /* GraphicLCDCtrl_v1_70_V_ALREADY_INCLUDED */
