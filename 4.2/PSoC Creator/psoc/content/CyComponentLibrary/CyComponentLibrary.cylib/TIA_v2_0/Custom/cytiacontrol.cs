...
namespace TIA_v2_0
{
    public partial class TIAcontrol : UserControl
    {
        ...
        public TIAcontrol(ICyInstEdit_v1 inst)
        {
            ...
            // To enable only drop down selection 
            mCapFbk.DropDownStyle = ComboBoxStyle.DropDownList;
            mPowr.DropDownStyle = ComboBoxStyle.DropDownList;
            mResFbk.DropDownStyle = ComboBoxStyle.DropDownList;
