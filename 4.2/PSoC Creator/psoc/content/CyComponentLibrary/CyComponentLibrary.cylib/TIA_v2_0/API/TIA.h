...
#define `$INSTANCE_NAME`_INIT_RES_FEEDBACK          (`$Resistive_Feedback`u)
#define `$INSTANCE_NAME`_INIT_CAP_FEEDBACK          (`$Capacitive_Feedback`u)
...
#define `$INSTANCE_NAME`_MODE_TIA                   (uint8)(0x01u << 1)
...
#define `$INSTANCE_NAME`_R20_40B_MASK               (uint8)(0x01u << 1)
...
#define `$INSTANCE_NAME`_REDC_01                    (uint8)(0x02u << 2)
#define `$INSTANCE_NAME`_REDC_10                    (uint8)(0x04u << 2)
...
#define `$INSTANCE_NAME`_RVAL_60K                   (uint8)(0x03u << 4)
