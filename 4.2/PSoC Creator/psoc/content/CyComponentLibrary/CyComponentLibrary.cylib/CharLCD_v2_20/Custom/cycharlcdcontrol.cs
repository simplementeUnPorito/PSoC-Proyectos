...
namespace CharLCD_v2_20
{
    public partial class CyCharLCDControl : UserControl
    {
        ...
        internal const string CR_PARAM = "ConversionRoutines";
        internal const string CUSTOM_CHARACTER_SET_PARAM = "CustomCharacterSet";
        ...
        {
            CharLCD_v2_20.CyCustomCharacter current = (CharLCD_v2_20.CyCustomCharacter)sender;
            CharLCD_v2_20.CyBox clickedBox = current.GetBoxByLocation(e.X, e.Y);
            if (clickedBox != null)
            {
        ...
        private void custArray_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                CharLCD_v2_20.CyCustomCharacter current = (CharLCD_v2_20.CyCustomCharacter)sender;
                CharLCD_v2_20.CyBox currentBox = current.GetBoxByLocation(e.X, e.Y);
                if (currentBox != null)
                {
        ...
        {
            CharLCD_v2_20.CyCustomCharacter selectedCharacter = (CharLCD_v2_20.CyCustomCharacter)sender;
        ...
        public void CYStringToCharacter(CyCustomCharacter customCharacter, string cyCharacterString)
        {
            ...
            CharLCD_v2_20.CyBox[,] boxes = customCharacter.GetBoxArray();
        ...
        public string CharacterToCYString(CyCustomCharacter customCharacter)
        {
            ...
            CharLCD_v2_20.CyBox[,] pixelArray = customCharacter.GetBoxArray();
        ...
        private void HighlightNext()
        {
            ...
            UpdateHighlighted((CharLCD_v2_20.CyCustomCharacter)m_userDefinedCharacters[next]);
        }
        ...
        private void HighlightPrevious()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v2_20.CyCustomCharacter)m_userDefinedCharacters[previous]);
        }
        ...
        private void HighlightAbove()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v2_20.CyCustomCharacter)m_userDefinedCharacters[above]);
        }
        private void HighlightBelow()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v2_20.CyCustomCharacter)m_userDefinedCharacters[below]);
        }
        ...
        private void CustomCharactersOff()
        {
            ...
            for (int i = 0; i < this.panel1.Controls.Count; i++)
            {
                CharLCD_v2_20.CyCustomCharacter character = (CharLCD_v2_20.CyCustomCharacter)this.panel1.Controls[i];
    ...
    enum CyCustomCharacterSetTypes
    {
