...
{
    sealed partial class CyCustomizer : ICyAPICustomize_v1
    {
        #region ICyAPICustomize_v1 Members
        private const string LCD_CFILE_NAME = "CharLCD.c";
        private const string CUST_CHARS_CFILE_NAME = "CustChars.c";
        private const string BARGRAPH_CFILE_NAME = "BarGraph.c";
