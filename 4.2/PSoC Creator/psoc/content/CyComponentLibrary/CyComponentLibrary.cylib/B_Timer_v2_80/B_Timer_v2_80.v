/*******************************************************************************
*  FILENAME:  B_Timer_v2_80.v
*  UM Name:   B_Timer_v2_80
*
*  DESCRIPTION:
...
`include "cypress.v"
`ifdef B_TIMER_V_v2_80_ALREADY_INCLUDED
`else
`define B_TIMER_V_v2_80_ALREADY_INCLUDED
module B_Timer_v2_80 (
...
localparam CY_UDB_V1 = (!CY_UDB_V0);
    ...
    begin: sCTRLReg
        ...
        begin : SyncCtl
            ...
            /* The clock to operate Control Reg for PSOC3 must be synchronous and run
    ...
    ***************************************************************************/
    ...
    assign run_mode = (RunMode == TIMER_RUNMODE_CONTINUOUS)? hwEnable: hwEnable_reg;
    /* Register the tc output terminal for avoiding glitches */
    assign status_tc = (run_mode & trigger_enable & per_zero) ? 1'b1 : 1'b0;   /* Terminal Count */
...
`endif /* B_TIMER_V_v2_80_ALREADY_INCLUDED */
