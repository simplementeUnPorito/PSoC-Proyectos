...
namespace SMBusSlave_v5_20
{
    public partial class CyTabWrapper : UserControl, ICyParamEditingControl
    {
        ...
        public void ValidateAllTable()
        {
            ...
            // Here we use two separated functions, because all rows of the name and 
            // code column should be checked. Cells of these columns depend on other.
            ValidateNames();
            ValidateCodes();
            ...
            bool hex)
        {
            ...
            try
            {
                value = Convert.ToInt32(text, hex ? 16 : 10);
            }
            catch { }
        ...
        public IEnumerable<ICyRow> GetObjectsFromDataGrid()
        {
            for (int i = 0; i < m_wrapperDataGridView.RowCount; i++)
            {
                ...
                {
                    yield return (ICyRow)m_wrapperDataGridView[m_wrapperDataGridKeyColumIndex, i].Value;
                }
            }
        }
