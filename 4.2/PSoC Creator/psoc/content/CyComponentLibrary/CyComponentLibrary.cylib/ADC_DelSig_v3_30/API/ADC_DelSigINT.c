...
/* `#END`  */
    ...
    *****************************************************************************/
    ...
    {
        #ifdef `$INSTANCE_NAME`_ISR1_ENTRY_CALLBACK
            `$INSTANCE_NAME`_ISR1_EntryCallback();
        #endif /* `$INSTANCE_NAME`_ISR1_ENTRY_CALLBACK */
        ...
        */
        ...
        #ifdef `$INSTANCE_NAME`_ISR1_EXIT_CALLBACK
            `$INSTANCE_NAME`_ISR1_ExitCallback();
        #endif /* `$INSTANCE_NAME`_ISR1_EXIT_CALLBACK */
    }
    ...
    *****************************************************************************/
    ...
    {
        #ifdef `$INSTANCE_NAME`_ISR2_ENTRY_CALLBACK
            `$INSTANCE_NAME`_ISR2_EntryCallback();
        #endif /* `$INSTANCE_NAME`_ISR2_ENTRY_CALLBACK */
        ...
        */
        ...
        #ifdef `$INSTANCE_NAME`_ISR2_EXIT_CALLBACK
            `$INSTANCE_NAME`_ISR2_ExitCallback();
        #endif /* `$INSTANCE_NAME`_ISR2_EXIT_CALLBACK */
    }
    ...
    *****************************************************************************/
    ...
    {
        #ifdef `$INSTANCE_NAME`_ISR3_ENTRY_CALLBACK
            `$INSTANCE_NAME`_ISR3_EntryCallback();
        #endif /* `$INSTANCE_NAME`_ISR3_ENTRY_CALLBACK */        
        ...
        */
        ...
        #ifdef `$INSTANCE_NAME`_ISR3_EXIT_CALLBACK
            `$INSTANCE_NAME`_ISR3_ExitCallback();
        #endif /* `$INSTANCE_NAME`_ISR3_EXIT_CALLBACK */        
    }
    ...
    *****************************************************************************/
    ...
    {
        #ifdef `$INSTANCE_NAME`_ISR4_ENTRY_CALLBACK
            `$INSTANCE_NAME`_ISR4_EntryCallback();
        #endif /* `$INSTANCE_NAME`_ISR4_ENTRY_CALLBACK */            
        ...
        */
        ...
        #ifdef `$INSTANCE_NAME`_ISR4_EXIT_CALLBACK
            `$INSTANCE_NAME`_ISR4_ExitCallback();
        #endif /* `$INSTANCE_NAME`_ISR4_EXIT_CALLBACK */            
    }
