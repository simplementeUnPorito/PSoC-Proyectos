...
***************************************/
 ...
 /* Default DAC range */
#define `$INSTANCE_NAME`_DEFAULT_RANGE    `$VDAC_Range`u
 /* Default DAC speed */
#define `$INSTANCE_NAME`_DEFAULT_SPEED    `$VDAC_Speed`u
 /* Default Control */
#define `$INSTANCE_NAME`_DEFAULT_CNTL      0x00u
/* Default Strobe mode */
#define `$INSTANCE_NAME`_DEFAULT_STRB     `$Strobe_Mode`u
 /* Initial DAC value */
#define `$INSTANCE_NAME`_DEFAULT_DATA     `$Initial_Value`u
 /* Default Data Source */
#define `$INSTANCE_NAME`_DEFAULT_DATA_SRC `$Data_Source`u


/***************************************
*              Registers        
***************************************/
#define `$INSTANCE_NAME`_CR0_REG            (* (reg8 *) `$INSTANCE_NAME`_viDAC8__CR0 )
#define `$INSTANCE_NAME`_CR0_PTR            (  (reg8 *) `$INSTANCE_NAME`_viDAC8__CR0 )
#define `$INSTANCE_NAME`_CR1_REG            (* (reg8 *) `$INSTANCE_NAME`_viDAC8__CR1 )
#define `$INSTANCE_NAME`_CR1_PTR            (  (reg8 *) `$INSTANCE_NAME`_viDAC8__CR1 )
#define `$INSTANCE_NAME`_Data_REG           (* (reg8 *) `$INSTANCE_NAME`_viDAC8__D )
#define `$INSTANCE_NAME`_Data_PTR           (  (reg8 *) `$INSTANCE_NAME`_viDAC8__D )
#define `$INSTANCE_NAME`_Strobe_REG         (* (reg8 *) `$INSTANCE_NAME`_viDAC8__STROBE )
#define `$INSTANCE_NAME`_Strobe_PTR         (  (reg8 *) `$INSTANCE_NAME`_viDAC8__STROBE )
#define `$INSTANCE_NAME`_SW0_REG            (* (reg8 *) `$INSTANCE_NAME`_viDAC8__SW0 )
#define `$INSTANCE_NAME`_SW0_PTR            (  (reg8 *) `$INSTANCE_NAME`_viDAC8__SW0 )
#define `$INSTANCE_NAME`_SW2_REG            (* (reg8 *) `$INSTANCE_NAME`_viDAC8__SW2 )
#define `$INSTANCE_NAME`_SW2_PTR            (  (reg8 *) `$INSTANCE_NAME`_viDAC8__SW2 )
#define `$INSTANCE_NAME`_SW3_REG            (* (reg8 *) `$INSTANCE_NAME`_viDAC8__SW3 )
#define `$INSTANCE_NAME`_SW3_PTR            (  (reg8 *) `$INSTANCE_NAME`_viDAC8__SW3 )
#define `$INSTANCE_NAME`_SW4_REG            (* (reg8 *) `$INSTANCE_NAME`_viDAC8__SW4 )
#define `$INSTANCE_NAME`_SW4_PTR            (  (reg8 *) `$INSTANCE_NAME`_viDAC8__SW4 )
#define `$INSTANCE_NAME`_TR_REG             (* (reg8 *) `$INSTANCE_NAME`_viDAC8__TR )
#define `$INSTANCE_NAME`_TR_PTR             (  (reg8 *) `$INSTANCE_NAME`_viDAC8__TR )
/* Power manager */
#define `$INSTANCE_NAME`_PWRMGR_REG         (* (reg8 *) `$INSTANCE_NAME`_viDAC8__PM_ACT_CFG )
#define `$INSTANCE_NAME`_PWRMGR_PTR         (  (reg8 *) `$INSTANCE_NAME`_viDAC8__PM_ACT_CFG )
  /* Standby Power manager */
#define `$INSTANCE_NAME`_STBY_PWRMGR_REG    (* (reg8 *) `$INSTANCE_NAME`_viDAC8__PM_STBY_CFG )
#define `$INSTANCE_NAME`_STBY_PWRMGR_PTR    (  (reg8 *) `$INSTANCE_NAME`_viDAC8__PM_STBY_CFG )
