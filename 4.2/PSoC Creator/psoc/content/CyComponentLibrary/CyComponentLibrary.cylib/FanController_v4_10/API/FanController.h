...
#if (CY_PSOC4)
    extern uint16 `$INSTANCE_NAME`_alertMask;
    extern uint16 `$INSTANCE_NAME`_stallStatus;
#endif /* (CY_PSOC4) */
...
#define `$INSTANCE_NAME`_TACH_GLITCH_FILTER_PERIOD_REG        \
...
#if(CY_PSOC4)
    #define `$INSTANCE_NAME`_TACH_ADDR_CONTROL_REG             \
                                (* (reg8 *) `$INSTANCE_NAME`_FanTach_P4_TachAddrControl__CONTROL_REG)
    #define `$INSTANCE_NAME`_TACH_ADDR_CONTROL_PTR             \
                                (  (reg8 *) `$INSTANCE_NAME`_FanTach_P4_TachAddrControl__CONTROL_REG)
    #define `$INSTANCE_NAME`_TACH_CUNTER_AUX_CTL_REG           \
                                (* (reg16 *) `$INSTANCE_NAME`_FanTach_FanTachCounter_u0__16BIT_DP_AUX_CTL_REG)
    #define `$INSTANCE_NAME`_TACH_CUNTER_AUX_CTL_PTR           \
                                (  (reg16 *) `$INSTANCE_NAME`_FanTach_FanTachCounter_u0__16BIT_DP_AUX_CTL_REG)
    
    #define `$INSTANCE_NAME`_TACH_STORED_ACT_PERIOD_REG         \
                                ( *(reg16 *) `$INSTANCE_NAME`_FanTach_FanTachCounter_u0__16BIT_F0_REG)
    #define `$INSTANCE_NAME`_TACH_STORED_ACT_PERIOD_PTR         \
                                (  (reg16 *) `$INSTANCE_NAME`_FanTach_FanTachCounter_u0__16BIT_F0_REG)
#else
    
    /* Alert Mask LSB Control register */
    #define `$INSTANCE_NAME`_ALERT_MASK_LSB_CONTROL_REG            \
                                        (* (reg8 *) `$INSTANCE_NAME`_B_FanCtrl_HwCtl_AlertMaskLSB__CONTROL_REG)
    #define `$INSTANCE_NAME`_ALERT_MASK_LSB_CONTROL_PTR            \
        ...
        #define `$INSTANCE_NAME`_ALERT_MASK_MSB_CONTROL_REG        \
                               (* (reg8 *) `$INSTANCE_NAME`_B_FanCtrl_HwCtl_MSB_AlertMaskMSB__CONTROL_REG)
        #define `$INSTANCE_NAME`_ALERT_MASK_MSB_CONTROL_PTR        \
                               (  (reg8 *) `$INSTANCE_NAME`_B_FanCtrl_HwCrl_MSB_AlertMaskMSB__CONTROL_REG)
    #endif /* (`$INSTANCE_NAME`_NUMBER_OF_FANS > 8u) */

    /* Stall Status register */
    #define `$INSTANCE_NAME`_STALL_ERROR_LSB_STATUS_REG            \
                                        (* (reg8 *) `$INSTANCE_NAME`_B_FanCtrl_StallStatus_StallError_LSB__STATUS_REG)
    #define `$INSTANCE_NAME`_STALL_ERROR_LSB_STATUS_PTR            \
        ...
        #define `$INSTANCE_NAME`_STALL_ERROR_MSB_STATUS_REG        \
                                    (* (reg8 *) `$INSTANCE_NAME`_B_FanCtrl_StallStatus_MSB_StallError_MSB__STATUS_REG)
        #define `$INSTANCE_NAME`_STALL_ERROR_MSB_STATUS_PTR        \
                                    (  (reg8 *) `$INSTANCE_NAME`_B_FanCtrl_StallStatus_MSB_StallError_MSB__STATUS_REG)
    #endif /* (`$INSTANCE_NAME`_NUMBER_OF_FANS > 8u) */

    #define `$INSTANCE_NAME`_TACH_FAN_COUNTER_REG               \
                                (* (reg8 *) `$INSTANCE_NAME`_FanTach_P3_P5_FanCounter__COUNT_REG)
    #define `$INSTANCE_NAME`_TACH_FAN_COUNTER_PTR               \
                                (  (reg8 *) `$INSTANCE_NAME`_FanTach_P3_P5_FanCounter__COUNT_REG)
    #define `$INSTANCE_NAME`_TACH_FAN_COUNTR_AUX_CTL_REG        \
                                (* (reg8 *) `$INSTANCE_NAME`_FanTach_P3_P5_FanCounter__CONTROL_AUX_CTL_REG)
    #define `$INSTANCE_NAME`_TACH_FAN_COUNTR_AUX_CTL_PTR        \
                                (  (reg8 *) `$INSTANCE_NAME`_P3_P5_FanTach_FanCounter__CONTROL_AUX_CTL_REG)
#endif /* (CY_PSOC4) */
...
#define `$INSTANCE_NAME`_COUNT7_PERIOD_MASK         (0x7Fu)
    ...
    #endif /* (!`$INSTANCE_NAME`_IS_AUTO_HARDWARE_MODE) */
#else    
    #define `$INSTANCE_NAME`_TACH_COUNTER_FIFO_CLR      (0x0101u)
    #define `$INSTANCE_NAME`_TACH_CNTL_NUM_FANS_MASK    ((uint8)(0x0Fu))
    #define `$INSTANCE_NAME`_TACH_EOM                   ((uint8)(0x80u))
    #define `$INSTANCE_NAME`_SW_EOC                     ((uint8)(0x08u))
    #define `$INSTANCE_NAME`_SW_STALL                   ((uint8)(0x80u))
#endif /* (!CY_PSOC4) */
...
#if (!`$INSTANCE_NAME`_IS_MANUAL_MODE)
    #define `$INSTANCE_NAME`_SW_SPEED_ERROR_SHIFT   (0x04u)    
#endif /* (!`$INSTANCE_NAME`_IS_MANUAL_MODE) */
...
#define `$INSTANCE_NAME`_OVERRIDE                   (uint8)(0x01u << `$INSTANCE_NAME`_OVERRIDE_SHIFT)
#if (!`$INSTANCE_NAME`_IS_MANUAL_MODE)
    #define `$INSTANCE_NAME`_SW_SPEED_ERROR         (uint8)(0x01u << `$INSTANCE_NAME`_SW_SPEED_ERROR_SHIFT)
#endif /* (!`$INSTANCE_NAME`_IS_MANUAL_MODE) */
