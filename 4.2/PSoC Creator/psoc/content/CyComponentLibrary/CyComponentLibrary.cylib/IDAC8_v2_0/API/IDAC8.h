...
#define `$INSTANCE_NAME`_DEFAULT_SPEED     ((uint8)(((`$IDAC_Speed`u != 0u) ? 1u : 0u) << 1u))   /* Default DAC speed */
...
#define `$INSTANCE_NAME`_PWRMGR_REG      (* (reg8 *) `$INSTANCE_NAME`_viDAC8__PM_ACT_CFG )  /* Power manager */
#define `$INSTANCE_NAME`_PWRMGR_PTR      (  (reg8 *) `$INSTANCE_NAME`_viDAC8__PM_ACT_CFG )  /* Power manager */
#define `$INSTANCE_NAME`_STBY_PWRMGR_REG (* (reg8 *) `$INSTANCE_NAME`_viDAC8__PM_STBY_CFG )  /* Standby Power manager */
#define `$INSTANCE_NAME`_STBY_PWRMGR_PTR (  (reg8 *) `$INSTANCE_NAME`_viDAC8__PM_STBY_CFG )  /* Standby Power manager */
