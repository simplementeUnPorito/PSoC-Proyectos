...
#if (CY_PSOC5A)
    static uint8 `$INSTANCE_NAME`_restoreReg = 0u;
#endif /* CY_PSOC5A */
...
void `$INSTANCE_NAME`_Init(void) `=ReentrantKeil($INSTANCE_NAME . "_Init")`
{
    ...
    #endif /* (`$INSTANCE_NAME`_DEFAULT_DATA_SRC != 0u ) */
    
    /*Controls polarity from UDB Control*/
    #if(`$INSTANCE_NAME`_DEFAULT_POLARITY == `$INSTANCE_NAME`_HARDWARE_CONTROLLED)
        `$INSTANCE_NAME`_CR1 |= `$INSTANCE_NAME`_IDIR_SRC_UDB;
    #else
        `$INSTANCE_NAME`_CR1 |= `$INSTANCE_NAME`_DEFAULT_POLARITY;
    #endif/* (`$INSTANCE_NAME`_DEFAULT_POLARITY == `$INSTANCE_NAME`_HARDWARE_CONTROLLED) */
    /*Controls Current Source from UDB Control*/
    #if(`$INSTANCE_NAME`_HARDWARE_ENABLE != 0u ) 
        `$INSTANCE_NAME`_CR1 |= `$INSTANCE_NAME`_IDIR_CTL_UDB;
    #endif /* (`$INSTANCE_NAME`_HARDWARE_ENABLE != 0u ) */ 
    
    /* Set default strobe mode */
    #if(`$INSTANCE_NAME`_DEFAULT_STRB != 0u)
        `$INSTANCE_NAME`_Strobe |= `$INSTANCE_NAME`_STRB_EN;
    #endif /* (`$INSTANCE_NAME`_DEFAULT_STRB != 0u) */
...
void `$INSTANCE_NAME`_Enable(void) `=ReentrantKeil($INSTANCE_NAME . "_Enable")`
{
    ...
    /* This is to restore the value of register CR0 which is saved 
      in prior to the modification in stop() API */
        ...
        {
            `$INSTANCE_NAME`_CR0 = `$INSTANCE_NAME`_lowPowerBackup.DACCR0Reg;
...
void `$INSTANCE_NAME`_Stop(void) `=ReentrantKeil($INSTANCE_NAME . "_Stop")`
{
    ...
    `$INSTANCE_NAME`_STBY_PWRMGR &= (uint8)(~`$INSTANCE_NAME`_STBY_PWR_EN);
        ...
        `$INSTANCE_NAME`_lowPowerBackup.DACCR0Reg = `$INSTANCE_NAME`_CR0;
...
*******************************************************************************/
    ...
    {
        `$INSTANCE_NAME`_CR1 &= (uint8)(~`$INSTANCE_NAME`_IDIR_MASK);                /* clear polarity bit */
...
void `$INSTANCE_NAME`_DacTrim(void) `=ReentrantKeil($INSTANCE_NAME . "_DacTrim")`
{
    ...
    mode = ((`$INSTANCE_NAME`_CR0 & `$INSTANCE_NAME`_RANGE_MASK) >> 1u);
