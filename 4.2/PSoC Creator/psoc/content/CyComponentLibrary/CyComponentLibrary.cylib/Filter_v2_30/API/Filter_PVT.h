...
extern const uint8 CYCODE `$INSTANCE_NAME`_control[`$INSTANCE_NAME`_CSA_RAM_SIZE_CUR]; 
extern const uint8 CYCODE `$INSTANCE_NAME`_data_a[`$INSTANCE_NAME`_DA_RAM_SIZE_CUR];
extern const uint8 CYCODE `$INSTANCE_NAME`_data_b[`$INSTANCE_NAME`_DB_RAM_SIZE_CUR];
extern const uint8 CYCODE `$INSTANCE_NAME`_cfsm[`$INSTANCE_NAME`_CFSM_RAM_SIZE_CUR];
extern const uint8 CYCODE `$INSTANCE_NAME`_acu[`$INSTANCE_NAME`_ACU_RAM_SIZE_CUR];
...
#if (CY_PSOC3)
    #define `$INSTANCE_NAME`_DA_RAM_SIZE            ((int16)0x0200)
    #define `$INSTANCE_NAME`_DB_RAM_SIZE            ((int16)0x0200)
    #define `$INSTANCE_NAME`_CSA_RAM_SIZE           ((int16)0x0100)
    #define `$INSTANCE_NAME`_CSB_RAM_SIZE           ((int16)0x0100)
    #define `$INSTANCE_NAME`_CFSM_RAM_SIZE          ((int16)0x0100)
    #define `$INSTANCE_NAME`_ACU_RAM_SIZE           ((int16)0x0040)
#else
    #define `$INSTANCE_NAME`_DA_RAM_SIZE            ((uint16)0x0200u)
    #define `$INSTANCE_NAME`_DB_RAM_SIZE            ((uint16)0x0200u)
    #define `$INSTANCE_NAME`_CSA_RAM_SIZE           ((uint16)0x0100u)
    #define `$INSTANCE_NAME`_CSB_RAM_SIZE           ((uint16)0x0100u)
    #define `$INSTANCE_NAME`_CFSM_RAM_SIZE          ((uint16)0x0100u)
    #define `$INSTANCE_NAME`_ACU_RAM_SIZE           ((uint16)0x0040u)
#endif /* (CY_PSOC3) */
...
#endif /* End `$INSTANCE_NAME`_PVT_H Header File */
