...
namespace USBFS_v3_10
{
    public partial class CyReportNumber : CyReportBase
    {
        ...
        public override bool Apply()
        {
            ...
            {
                MessageBox.Show(errorProvider.GetError(textBoxValue), Properties.Resources.MSG_TITLE_ERROR,
            ...
            {
                MessageBox.Show(Properties.Resources.MSG_INCORRECT_VALUE, Properties.Resources.MSG_TITLE_ERROR,
                                MessageBoxButtons.OK, MessageBoxIcon.Error);
                res = false;
            }
            return res;
        ...
        private void SetErrProvider()
        {
            ...
            else if ((m_item.Name == CyHidReportItem.RPTITEM_REPORT_ID) &&
