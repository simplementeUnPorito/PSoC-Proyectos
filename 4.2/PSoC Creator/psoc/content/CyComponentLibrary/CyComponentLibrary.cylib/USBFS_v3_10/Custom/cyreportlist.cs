...
namespace USBFS_v3_10
{
    ...
    {
        private const string VENDOR_VALUE_TEXT = CyHIDReportItemTables.VENDOR_STR;
        ...
        public override bool Apply()
        {
            ...
            {
                MessageBox.Show(String.Format(Properties.Resources.MSG_INCORRECT_VALUE_RANGE, MIN, MAX),
                                 Properties.Resources.MSG_TITLE_WARNING, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                res = false;
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString(), Properties.Resources.MSG_TITLE_WARNING, MessageBoxButtons.OK,
