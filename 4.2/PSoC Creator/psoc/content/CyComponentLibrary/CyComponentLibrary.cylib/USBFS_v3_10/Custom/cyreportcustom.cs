...
namespace USBFS_v3_10
{
    public partial class CyReportCustom : CyReportBase
    {
        ...
        protected override void InitValues()
        {
            ...
            if (tmpArr.Count > 0)
                tmpArr.RemoveAt(0);
            Int64 val = CyUSBFSParameters.ConvertByteArrayToInt(tmpArr, m_item.IsUnsigned());
            
            textBoxValue.Text = val.ToString();

            numUpDownPrefix.Value = m_item.m_prefix >> CyHidReportItem.PREFIX_SHIFT;
        }
        ...
        public override bool Apply()
        {
            ...
            try
            {
                if (textBoxValue.Text == "")
                {
                    ...
                    m_item.m_prefix = (byte)(Convert.ToByte(numUpDownPrefix.Value) << CyHidReportItem.PREFIX_SHIFT);
                ...
                else
                {
                    ...
                    List<byte> byteList = CyUSBFSParameters.ConvertIntToByteArray(val, m_item.IsUnsigned());
            ...
            {
                MessageBox.Show(Properties.Resources.MSG_INCORRECT_VALUE, Properties.Resources.MSG_TITLE_WARNING,
