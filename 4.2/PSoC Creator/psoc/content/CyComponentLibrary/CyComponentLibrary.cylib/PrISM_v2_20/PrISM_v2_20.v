...
`include "cypress.v"
`ifdef PrISM_v2_20_V_ALREADY_INCLUDED
`else
`define PrISM_v2_20_V_ALREADY_INCLUDED
...
(
    ...
    */ 
    ...
    generate
    if( (PulseTypeHardcoded == 1'd0) & CY_UDB_V0 )
    begin: AsyncCtl
...
endmodule   /* PrISM_v2_20 */
`endif      /* PrISM_v2_20_V_ALREADY_INCLUDED */
