...
static `$INSTANCE_NAME`_BACKUP_STRUCT  `$INSTANCE_NAME`_backup = 
{
    ...
    /* cr */
       ...
       (((`$INSTANCE_NAME`_GREATERTHAN_OR_EQUAL == `$INSTANCE_NAME`_COMPARE0) ? \
                                                `$INSTANCE_NAME`_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL : 0u) |
        ((`$INSTANCE_NAME`_GREATERTHAN_OR_EQUAL == `$INSTANCE_NAME`_COMPARE1) ? \
                                                `$INSTANCE_NAME`_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL : 0u)),
