...
#endif /* CYBLE_AIOS */
#ifdef CYBLE_ANCS
    #include "`$INSTANCE_NAME`_ancs.h"
#endif /* CYBLE_ANCS */
#ifdef CYBLE_ANS
    #include "`$INSTANCE_NAME`_ans.h"
#endif /* CYBLE_ANS */
#ifdef CYBLE_BAS
    #include "`$INSTANCE_NAME`_bas.h"
#endif /* CYBLE_BAS */
#ifdef CYBLE_BLS
    #include "`$INSTANCE_NAME`_bls.h"
#endif /* CYBLE_BLS */
#ifdef CYBLE_BCS
    #include "`$INSTANCE_NAME`_bcs.h"
#endif /* CYBLE_BCS */
#ifdef CYBLE_BMS
    #include "`$INSTANCE_NAME`_bms.h"
#endif /* CYBLE_BMS */
#ifdef CYBLE_BTS
    #include "`$INSTANCE_NAME`_bts.h"
#endif /* CYBLE_BTS */
#ifdef CYBLE_CGMS
    #include "`$INSTANCE_NAME`_cgms.h"
#endif /* CYBLE_CGMS */
#ifdef CYBLE_CPS
    #include "`$INSTANCE_NAME`_cps.h"
#endif /* CYBLE_CPS */
#ifdef CYBLE_CSCS
    #include "`$INSTANCE_NAME`_cscs.h"
#endif /* CYBLE_CSCS */
#ifdef CYBLE_CTS
    #include "`$INSTANCE_NAME`_cts.h"
#endif /* CYBLE_CTS */
#ifdef CYBLE_CUSTOM
    #include "`$INSTANCE_NAME`_custom.h"
#endif /* CYBLE_CUSTOM */
#ifdef CYBLE_DIS
    #include "`$INSTANCE_NAME`_dis.h"
#endif /* CYBLE_DIS */
#ifdef CYBLE_ESS
    #include "`$INSTANCE_NAME`_ess.h"
#endif /* CYBLE_ESS */
#ifdef CYBLE_GLS
    #include "`$INSTANCE_NAME`_gls.h"
#endif /* CYBLE_GLS */
#ifdef CYBLE_HIDS
    #include "`$INSTANCE_NAME`_hids.h"
#endif /* CYBLE_HIDS */
#ifdef CYBLE_HPS
    #include "`$INSTANCE_NAME`_hps.h"
#endif /* CYBLE_HPS */
#ifdef CYBLE_HRS
    #include "`$INSTANCE_NAME`_hrs.h"
#endif /* CYBLE_HRS */
#ifdef CYBLE_HTS
    #include "`$INSTANCE_NAME`_hts.h"
#endif /* CYBLE_HTS */
#ifdef CYBLE_IAS
    #include "`$INSTANCE_NAME`_ias.h"
#endif /* CYBLE_IAS */
#ifdef CYBLE_IPS
    #include "`$INSTANCE_NAME`_ips.h"
#endif /* CYBLE_IPS */
#ifdef CYBLE_LLS
    #include "`$INSTANCE_NAME`_lls.h"
#endif /* CYBLE_LLS */
#ifdef CYBLE_LNS
    #include "`$INSTANCE_NAME`_lns.h"
#endif /* CYBLE_LNS */
#ifdef CYBLE_NDCS
    #include "`$INSTANCE_NAME`_ndcs.h"
#endif /* CYBLE_NDCS */
#ifdef CYBLE_PASS
    #include "`$INSTANCE_NAME`_pass.h"
#endif /* CYBLE_PASS */
#ifdef CYBLE_PLXS
    #include "`$INSTANCE_NAME`_plxs.h"
#endif /* CYBLE_PLXS */
#ifdef CYBLE_RSCS
    #include "`$INSTANCE_NAME`_rscs.h"
#endif /* CYBLE_RSCS */
#ifdef CYBLE_RTUS
    #include "`$INSTANCE_NAME`_rtus.h"
#endif /* CYBLE_RTUS */
#ifdef CYBLE_SCPS
    #include "`$INSTANCE_NAME`_scps.h"
#endif /* CYBLE_SCPS */
#ifdef CYBLE_TPS
    #include "`$INSTANCE_NAME`_tps.h"
#endif /* CYBLE_TPS */
#ifdef CYBLE_UDS
    #include "`$INSTANCE_NAME`_uds.h"
#endif /* CYBLE_UDS */
#ifdef CYBLE_WPTS
    #include "`$INSTANCE_NAME`_wpts.h"
#endif /* CYBLE_WPTS */
#ifdef CYBLE_WSS
    #include "`$INSTANCE_NAME`_wss.h"
#endif /* CYBLE_WSS */
