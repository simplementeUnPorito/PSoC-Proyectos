...
*  CYBLE_EVT_CGMSC_NOTIFICATION event at the GATT Client's end.
* 
...
*  which results in CYBLE_EVT_CGMSC_INDICATION or 
...
* 
* \return
*  CYBLE_GATT_ERR_CODE_T - A function return state if its succeeded 
