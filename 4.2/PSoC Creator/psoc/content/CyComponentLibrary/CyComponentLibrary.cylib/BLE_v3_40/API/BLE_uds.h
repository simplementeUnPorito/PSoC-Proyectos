...
#define CYBLE_UDS_LONG_CHAR_COUNT (3u) /* Count of long UDS characteristics */

/**
 \addtogroup group_service_api_UDS_definitions
 @{
*/
...
/** \addtogroup group_service_api_UDS_server_client 
@{ 
*/
...
#ifdef CYBLE_UDS_SERVER
/**
 \addtogroup group_service_api_UDS_server
 @{
*/
...
#ifdef CYBLE_UDS_CLIENT
/**
 \addtogroup group_service_api_UDS_client
 @{
*/
...
#define CYBLE_UDS_IS_PROCEDURE_IN_PROGRESS  (0u != (CYBLE_UDS_FLAG_PROCESS & cyBle_udsFlag))
