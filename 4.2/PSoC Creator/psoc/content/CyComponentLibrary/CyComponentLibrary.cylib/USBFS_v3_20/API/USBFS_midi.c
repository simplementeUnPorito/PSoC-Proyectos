...
***************************************/
    ...
    volatile uint8 `$INSTANCE_NAME`_midi_in_ep;
    ...
    volatile uint8 `$INSTANCE_NAME`_MIDI1_InqFlags;                                 /* Device inquiry flag */
        ...
        /** See description of \ref `$INSTANCE_NAME`_MIDI1_InqFlags*/
...
* \globalvars
*
*  \ref `$INSTANCE_NAME`_midiInBuffer: This buffer is used for saving and combining
...
*
*  \ref `$INSTANCE_NAME`_midiOutBuffer: This buffer is used by the
*    `$INSTANCE_NAME`_MIDI_OUT_Service() function for saving the received
*    from the PC data, then the data are parsed and transferred to UART(s)
*    buffer and to the internal processing by the
*
*  \ref `$INSTANCE_NAME`_callbackLocalMidiEvent function.
*
*  \ref `$INSTANCE_NAME`_midi_out_ep: Used as an OUT endpoint number.
*
*  \ref `$INSTANCE_NAME`_midi_in_ep: Used as an IN endpoint number.
*
*   \ref `$INSTANCE_NAME`_midiInPointer: Initialized to zero.
*
* \sideeffect
...
void `$INSTANCE_NAME`_MIDI_Init(void) `=ReentrantKeil($INSTANCE_NAME . "_MIDI_Init")`
{
...
#if (`$INSTANCE_NAME`_MIDI_EXT_MODE >= `$INSTANCE_NAME`_ONE_EXT_INTRF)
    `$INSTANCE_NAME`_MIDI_InitInterface();
#endif /* (`$INSTANCE_NAME`_MIDI_EXT_MODE >= `$INSTANCE_NAME`_ONE_EXT_INTRF) */
}
...
#if (`$INSTANCE_NAME`_MIDI_OUT_BUFF_SIZE > 0)
    /*******************************************************************************
    * Function Name: `$INSTANCE_NAME`_MIDI_OUT_Service
    ****************************************************************************//**
    *
    ...
    * \globalvars
    *
    *  \ref `$INSTANCE_NAME`_midiOutBuffer: Used as temporary buffer between USB
    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_MIDI_OUT_Service(void) `=ReentrantKeil($INSTANCE_NAME . "_MIDI_OUT_Service")`
    {
        ...
        if (`$INSTANCE_NAME`_OUT_BUFFER_FULL == `$INSTANCE_NAME`_GetEPState(`$INSTANCE_NAME`_midi_out_ep))
        {
        #if (`$INSTANCE_NAME`_MIDI_OUT_BUFF_SIZE >= 256)
            ...
            outLength = (uint8)`$INSTANCE_NAME`_GetEPCount(`$INSTANCE_NAME`_midi_out_ep);
                ...
                while (`$INSTANCE_NAME`_OUT_BUFFER_FULL == `$INSTANCE_NAME`_GetEPState(`$INSTANCE_NAME`_midi_out_ep))
                {
                }
            ...
            if (outLength >= `$INSTANCE_NAME`_EVENT_LENGTH)
            {
                ...
                /* Route USB MIDI to the External connection */
                    ...
                    else
                    {
                        ...
                        #ifdef `$INSTANCE_NAME`_MIDI_OUT_EP_SERVICE_CALLBACK
                            `$INSTANCE_NAME`_MIDI_OUT_EP_Service_Callback();
                        #endif /* `$INSTANCE_NAME`_MIDI_OUT_EP_SERVICE_CALLBACK */
                    }
                #endif /* (`$INSTANCE_NAME`_MIDI_EXT_MODE >= `$INSTANCE_NAME`_ONE_EXT_INTRF) */

                    /* Process any local MIDI output functions */
                    `$INSTANCE_NAME`_callbackLocalMidiEvent(`$INSTANCE_NAME`_midiOutBuffer[outPointer] & `$INSTANCE_NAME`_CABLE_MASK,
    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_MIDI_IN_Service(void) `=ReentrantKeil($INSTANCE_NAME . "_MIDI_IN_Service")`
    {
        ...
        */
        ...
        if (0u == `$INSTANCE_NAME`_midiInPointer)
        {
            do
            {
            ...
            while((`$INSTANCE_NAME`_midiInPointer <= (`$INSTANCE_NAME`_MIDI_IN_BUFF_SIZE - `$INSTANCE_NAME`_EVENT_LENGTH)) &&
                  ((m1 != 0u) || (m2 != 0u)));
        }
    #endif /* (`$INSTANCE_NAME`_MIDI_EXT_MODE >= `$INSTANCE_NAME`_ONE_EXT_INTRF) */
    ...
    *  The `$INSTANCE_NAME`_MIDI_IN_Service() function should also be called to
    ...
    *   ----------------------|-----------------------------------------
    *  `$INSTANCE_NAME`_TRUE  | Host is not ready to receive this message
    *  `$INSTANCE_NAME`_FALSE | Success transfer
    *
    * \globalvars
    *
    *  \ref `$INSTANCE_NAME`_midi_in_ep: MIDI IN endpoint number used for
    *        sending data.
    *
    *  \ref `$INSTANCE_NAME`_midiInPointer: Checked this variable to see if
                    ...
                    (`$INSTANCE_NAME`_EP[`$INSTANCE_NAME`_midi_in_ep].bufferSize - `$INSTANCE_NAME`_EVENT_LENGTH))
        {
            ...
            else /* Only SysEx message is greater than 4 bytes */
            {
                ...
                do
                {
                    ...
                    `$INSTANCE_NAME`_PrepareInBuffer(`$INSTANCE_NAME`_MIDI_SYSEX, &midiMsg[idx],
                                                     `$INSTANCE_NAME`_EVENT_BYTE3, cable);

                    /* Move to next 3 bytes of message */
                    ic  -= `$INSTANCE_NAME`_EVENT_BYTE3;
                    idx += `$INSTANCE_NAME`_EVENT_BYTE3;
                ...
                if (retError == `$INSTANCE_NAME`_FALSE)
                {
                    ...
                    `$INSTANCE_NAME`_PrepareInBuffer(`$INSTANCE_NAME`_MIDI_EOSEX, &midiMsg[idx], ic, cable);
                }
            }
        }
        else
    ...
    *******************************************************************************/
                                                                 ...
                                                                 `=ReentrantKeil($INSTANCE_NAME . "_PrepareInBuffer")`
    {
        ...
        else if (ic == `$INSTANCE_NAME`_MIDI_EOSEX)
        {
            ...
            {
                case 0u:
                    `$INSTANCE_NAME`_midiInBuffer[`$INSTANCE_NAME`_midiInPointer] = `$INSTANCE_NAME`_SYSEX_ENDS_WITH1 | cable;
                    `$INSTANCE_NAME`_midiInPointer++;
                    ...
                    break;
                case 1u:
                    `$INSTANCE_NAME`_midiInBuffer[`$INSTANCE_NAME`_midiInPointer] = `$INSTANCE_NAME`_SYSEX_ENDS_WITH2 | cable;
                    `$INSTANCE_NAME`_midiInPointer++;
                    `$INSTANCE_NAME`_midiInBuffer[`$INSTANCE_NAME`_midiInPointer] = srcBuffZero;
                    `$INSTANCE_NAME`_midiInPointer++;
                    `$INSTANCE_NAME`_midiInBuffer[`$INSTANCE_NAME`_midiInPointer] = `$INSTANCE_NAME`_MIDI_EOSEX;
                    ...
                    break;
                case 2u:
                    `$INSTANCE_NAME`_midiInBuffer[`$INSTANCE_NAME`_midiInPointer] = `$INSTANCE_NAME`_SYSEX_ENDS_WITH3 | cable;
                    `$INSTANCE_NAME`_midiInPointer++;
                    `$INSTANCE_NAME`_midiInBuffer[`$INSTANCE_NAME`_midiInPointer] = srcBuffZero;
                    `$INSTANCE_NAME`_midiInPointer++;
                    `$INSTANCE_NAME`_midiInBuffer[`$INSTANCE_NAME`_midiInPointer] = srcBuffOne;
...
*/
#if (`$INSTANCE_NAME`_MIDI_EXT_MODE >= `$INSTANCE_NAME`_ONE_EXT_INTRF)
    /*******************************************************************************
    * Function Name: `$INSTANCE_NAME`_MIDI_InitInterface
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    #ifdef `$INSTANCE_NAME`_MIDI_INIT_CALLBACK
        `$INSTANCE_NAME`_MIDI_Init_Callback();
    #endif /* (`$INSTANCE_NAME`_MIDI_INIT_CALLBACK) */
    }
    ...
    *******************************************************************************/
    ...
    #ifdef `$INSTANCE_NAME`_MIDI1_PROCESS_USB_OUT_ENTRY_CALLBACK
        `$INSTANCE_NAME`_MIDI1_ProcessUsbOut_EntryCallback();
    #endif /* (`$INSTANCE_NAME`_MIDI1_PROCESS_USB_OUT_ENTRY_CALLBACK) */
    ...
    #ifdef `$INSTANCE_NAME`_MIDI1_PROCESS_USB_OUT_EXIT_CALLBACK
        `$INSTANCE_NAME`_MIDI1_ProcessUsbOut_ExitCallback();
    #endif /* (`$INSTANCE_NAME`_MIDI1_PROCESS_USB_OUT_EXIT_CALLBACK) */
    }
    ...
    *******************************************************************************/
    ...
    #ifdef `$INSTANCE_NAME`_MIDI2_PROCESS_USB_OUT_ENTRY_CALLBACK
        `$INSTANCE_NAME`_MIDI2_ProcessUsbOut_EntryCallback();
    #endif /* (`$INSTANCE_NAME`_MIDI2_PROCESS_USB_OUT_ENTRY_CALLBACK) */
    ...
    #ifdef `$INSTANCE_NAME`_MIDI2_PROCESS_USB_OUT_EXIT_CALLBACK
        `$INSTANCE_NAME`_MIDI2_ProcessUsbOut_ExitCallback();
    #endif /* (`$INSTANCE_NAME`_MIDI2_PROCESS_USB_OUT_EXIT_CALLBACK) */
    }
#endif /* (`$INSTANCE_NAME`_MIDI_EXT_MODE >= `$INSTANCE_NAME`_TWO_EXT_INTRF) */
#endif /* (`$INSTANCE_NAME`_MIDI_EXT_MODE >= `$INSTANCE_NAME`_ONE_EXT_INTRF) */
