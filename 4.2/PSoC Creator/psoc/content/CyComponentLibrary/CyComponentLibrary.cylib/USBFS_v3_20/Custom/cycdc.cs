...
namespace USBFS_v3_20
{
    ...
    public class CyCDCInterfaceDescriptor : CyInterfaceDescriptor
    {
        public override string ToString()
        {
            ...
            return string.Format("{0}Alternate Settings {1}", interfaceName, bAlternateSetting);
        }
    }
    ...
    public class CyCommunicationsInterfaceDescriptor : CyCDCInterfaceDescriptor
    {
        ...
        [DefaultValue(typeof(CyUSBOtherTypes.CyCommunicationSubclassCodes), "0")]
        [XmlIgnore]
        ...
        [TypeConverter(typeof(CyEnumConverter))]
        [DefaultValue(typeof(CyUSBOtherTypes.CyCommunicationProtocolCodes), "0")]
        [XmlIgnore]
    ...
    public class CyDataInterfaceDescriptor : CyCDCInterfaceDescriptor
    {
        ...
        [DisplayName("bInterfaceProtocol")]
        [TypeConverter(typeof(CyEnumConverter))]
        [DefaultValue(typeof(CyUSBOtherTypes.CyDataProtocolCodes), "0")]
        [XmlIgnore]
    ...
    public class CyCDCUnionDescriptor : CyCDCClassDescriptor
    {
        ...
        {
            // plus 4 because the next fields are present all time:
            // 1. Union Descriptor Lenght
            // 2. Descriptor Type
            // 3. Descriptor Subtype
            // 4. bControlInterface
    ...
    public class CyCDCCountrySelectionDescriptor : CyCDCClassDescriptor
    {
        ...
        {
            // plus 4 because the next fields are present all time:
            // 1. Country Selection Descriptor Length 
            // 2. DescriptorType
            // 3. bDescriptorSubtype
            // 4. iCountryCodeRelDate
