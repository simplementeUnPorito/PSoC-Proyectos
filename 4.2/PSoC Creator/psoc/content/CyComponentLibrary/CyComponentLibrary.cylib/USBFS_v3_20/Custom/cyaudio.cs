...
namespace USBFS_v3_20
{
    ...
    class CyStringDescConverter : StringConverter
    {
            ...
            if (destinationType == typeof(string))
            {
                ...
                switch ((byte)value)
                {
                    ...
                    case (byte)CyUSBOtherTypes.CyInterfaceClassCodes.CLASS_DATA:
                        res = "DATA";
                        break;
                    case (byte)CyUSBOtherTypes.CyInterfaceClassCodes.CLASS_APPLICATION_SPECIFIC:
                        res = "APPLICATION SPECIFIC";
                        break;
