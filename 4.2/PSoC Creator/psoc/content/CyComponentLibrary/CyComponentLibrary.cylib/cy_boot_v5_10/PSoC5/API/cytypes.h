...
*******************************************************************************/
    ...
    #else
        #define CY_IP_FMLT              (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FMLT")`u != 0u)
        #define CY_IP_FM                (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FM")`u != 0u)
        #define CY_IP_S8FS              (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FMLT_OR_S8FS")`u != 0u)
    #endif  /* (CY_PSOC4_4100 || CY_PSOC4_4200) */
