...
*******************************************************************************/
    ...
    #else
        #define CY_IP_SRSSV2            (`=GetFeatureCount("m0s8srssv2")`u != 0u)
        #define CY_IP_SRSSLT            (!CY_IP_SRSSV2)
    ...
    #else
        #define CY_IP_CPUSSV2           (`=GetFeatureCount("m0s8cpussv2")`u != 0u)
    ...
    #else
        #define CY_IP_FM                (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_TYPE")`u == 0u)
        #define CY_IP_FMLT              (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_TYPE")`u == 1u)
        #define CY_IP_FS                (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_TYPE")`u == 2u)
        #define CY_IP_FSLT              (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.FLASH_TYPE")`u == 3u)
    #endif  /* (CY_PSOC4_4100 || CY_PSOC4_4200) */
    ...
    #else
        #define CY_IP_BLESS             (`=GetFeatureCount("m0s8bless")`u != 0u)
    #endif  /* (CY_PSOC4_4100 || CY_PSOC4_4200) */
    ...
    ***************************************************************************/
    ...
    #else
        #define CY_IP_SPCIF_SYNCHRONOUS     (`=GetFeatureParameter("m0s8cpussv2", "SPCIF.SYNCHRONOUS")`u != 0u)
    #endif  /* (CY_PSOC4_4100 || CY_PSOC4_4200) */
    ...
    /* Watch Crystal Oscillator (WCO) is present (32kHz) */
        ...
        #define CY_IP_WCO               (0u == 0u)
    #elif (CY_IP_SRSSV2)
        #define CY_IP_WCO               (`=GetFeatureParameter("m0s8srssv2", "EXCO.WCO_PRESENT")`u)
    #else
        #define CY_IP_WCO               (0u != 0u)
...
#define CY_BOOT_VERSION         (CY_BOOT_5_10)
