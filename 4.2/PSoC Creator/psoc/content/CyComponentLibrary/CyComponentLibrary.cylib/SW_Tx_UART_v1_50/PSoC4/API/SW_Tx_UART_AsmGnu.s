...
.global `$INSTANCE_NAME`_pinNumber
.global `$INSTANCE_NAME`_pinPortNumber
...
.global `$INSTANCE_NAME`_PutChar
.func `$INSTANCE_NAME`_PutChar, `$INSTANCE_NAME`_PutChar
.type `$INSTANCE_NAME`_PutChar, %function
.thumb_func
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word `$INSTANCE_NAME`_pinNumber
PORT_NUMBER:
    .word `$INSTANCE_NAME`_pinPortNumber
PORT_DR_ADDRESS:
    .word `$INSTANCE_NAME`_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word `$BaudRate`
