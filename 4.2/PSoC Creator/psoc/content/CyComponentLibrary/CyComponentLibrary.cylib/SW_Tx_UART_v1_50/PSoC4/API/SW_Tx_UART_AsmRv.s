;==============================================================================
; File Name: `$INSTANCE_NAME`_AsmGnu.s
...
;==============================================================================
    ...
    IMPORT `$INSTANCE_NAME`_pinNumber
    IMPORT `$INSTANCE_NAME`_pinPortNumber
    IMPORT `$INSTANCE_NAME`_pinDrAdress
...
; void `$INSTANCE_NAME`_PutChar(uint8 txDataByte)
    ALIGN 8
`$INSTANCE_NAME`_PutChar FUNCTION
    EXPORT `$INSTANCE_NAME`_PutChar
...
PIN_NUMBER DCD `$INSTANCE_NAME`_pinNumber
PORT_NUMBER DCD `$INSTANCE_NAME`_pinPortNumber
PORT_DR_ADDRESS DCD `$INSTANCE_NAME`_pinDrAdress
FREQ DCD cydelayFreqHz
BAUD_RATE DCD `$BaudRate`
    ENDFUNC
