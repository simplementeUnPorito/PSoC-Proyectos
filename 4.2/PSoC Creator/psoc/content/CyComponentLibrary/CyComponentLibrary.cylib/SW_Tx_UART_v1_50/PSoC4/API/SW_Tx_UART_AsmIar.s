;==============================================================================
;
; File Name: `$INSTANCE_NAME`_AsmIar.s
...
bitTxLoop:
    ...
    DATA
PIN_NUMBER dc32 `$INSTANCE_NAME`_pinNumber
PORT_NUMBER dc32 `$INSTANCE_NAME`_pinPortNumber
PORT_DR_ADDRESS dc32 `$INSTANCE_NAME`_pinDrAdress
FREQ dc32 cydelayFreqHz
BAUD_RATE dc32 `$BaudRate`
