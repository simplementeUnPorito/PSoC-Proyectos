...
/* Function Prototypes */
static void `$INSTANCE_NAME`_EverySecondHandler(void);
static void `$INSTANCE_NAME`_EveryMinuteHandler(void);
static void `$INSTANCE_NAME`_EveryHourHandler(void);
static void `$INSTANCE_NAME`_EveryDayHandler(void);
static void `$INSTANCE_NAME`_EveryWeekHandler(void);
static void `$INSTANCE_NAME`_EveryMonthHandler(void);
static void `$INSTANCE_NAME`_EveryYearHandler(void);
...
static void `$INSTANCE_NAME`_EverySecondHandler(void)
{
    ...
    #ifdef `$INSTANCE_NAME`_EVERY_SECOND_HANDLER_CALLBACK
        `$INSTANCE_NAME`_EverySecondHandler_Callback();
    #endif /* `$INSTANCE_NAME`_EVERY_SECOND_HANDLER_CALLBACK */
}
...
static void `$INSTANCE_NAME`_EveryMinuteHandler(void)
{
    ...
    #ifdef `$INSTANCE_NAME`_EVERY_MINUTE_HANDLER_CALLBACK
        `$INSTANCE_NAME`_EveryMinuteHandler_Callback();
    #endif /* `$INSTANCE_NAME`_EVERY_MINUTE_HANDLER_CALLBACK */    
}
...
static void `$INSTANCE_NAME`_EveryHourHandler(void)
{
    ...
    #ifdef `$INSTANCE_NAME`_EVERY_HOUR_HANDLER_CALLBACK
        `$INSTANCE_NAME`_EveryHourHandler_Callback();
    #endif /* `$INSTANCE_NAME`_EVERY_HOUR_HANDLER_CALLBACK */
}
...
static void `$INSTANCE_NAME`_EveryDayHandler(void)
{
    ...
    #ifdef `$INSTANCE_NAME`_EVERY_DAY_HANDLER_CALLBACK
        `$INSTANCE_NAME`_EveryDayHandler_Callback();
    #endif /* `$INSTANCE_NAME`_EVERY_DAY_HANDLER_CALLBACK */
}
...
static void `$INSTANCE_NAME`_EveryWeekHandler(void)
{
    ...
    #ifdef `$INSTANCE_NAME`_EVERY_WEEK_HANDLER_CALLBACK
        `$INSTANCE_NAME`_EveryWeekHandler_Callback();
    #endif /* `$INSTANCE_NAME`_EVERY_WEEK_HANDLER_CALLBACK */
}
...
static void `$INSTANCE_NAME`_EveryMonthHandler(void)
{
    ...
    #ifdef `$INSTANCE_NAME`_EVERY_MONTH_HANDLER_CALLBACK
        `$INSTANCE_NAME`_EveryMonthHandler_Callback();
    #endif /* `$INSTANCE_NAME`_EVERY_MONTH_HANDLER_CALLBACK */
}
...
static void `$INSTANCE_NAME`_EveryYearHandler(void)
{
    ...
    #ifdef `$INSTANCE_NAME`_EVERY_YEAR_HANDLER_CALLBACK
        `$INSTANCE_NAME`_EveryYearHandler_Callback();
    #endif /* `$INSTANCE_NAME`_EVERY_YEAR_HANDLER_CALLBACK */    
}
...
CY_ISR(`$INSTANCE_NAME`_ISR)
{
    ...
    if(`$INSTANCE_NAME`_currentTimeDate.Sec > `$INSTANCE_NAME`_MINUTE_ELAPSED)
    {
        ...
        if(`$INSTANCE_NAME`_currentTimeDate.Min > `$INSTANCE_NAME`_HOUR_ELAPSED)
        {
            ...
            if(`$INSTANCE_NAME`_currentTimeDate.Hour > `$INSTANCE_NAME`_DAY_ELAPSED)
            {
                ...
                */
                if(((0u != (`$INSTANCE_NAME`_statusDateTime & `$INSTANCE_NAME`_STATUS_LY)) &&
                    ...
                    (`$INSTANCE_NAME`_currentTimeDate.DayOfMonth >
                             (`$INSTANCE_NAME`_daysInMonths[`$INSTANCE_NAME`_currentTimeDate.Month - 1u] + 1u))) ||
                                    ...
                                    `$INSTANCE_NAME`_daysInMonths[`$INSTANCE_NAME`_currentTimeDate.Month - 1u])))
                {
                    ...
                    if(`$INSTANCE_NAME`_currentTimeDate.Month > `$INSTANCE_NAME`_YEAR_ELAPSED)
                    {
                        ...
                        /* Alarm YEAR */
                        if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask,
                                                             `$INSTANCE_NAME`_ALARM_YEAR_MASK))
                        {
                            /* Years match */
                        ...
                        `$INSTANCE_NAME`_tmp = `$INSTANCE_NAME`_alarmCfgMask;
                        `$INSTANCE_NAME`_SET_ALARM(`$INSTANCE_NAME`_tmp,
                                                   `$INSTANCE_NAME`_alarmCurStatus,
                                                   `$INSTANCE_NAME`_statusDateTime);

                        /* Every Year */
                        if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_intervalCfgMask,
                    ...
                    /* Alarm MONTH */
                    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask,
                                                         `$INSTANCE_NAME`_ALARM_MONTH_MASK))
                    {
                ...
                /* Alarm DAYOFWEEK */
                if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask,
                                                     `$INSTANCE_NAME`_ALARM_DAYOFWEEK_MASK))
                {
                ...
                /* Alarm DAYOFYEAR */
                if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask,
                                                     `$INSTANCE_NAME`_ALARM_DAYOFYEAR_MASK))
                {
                ...
                /* Every Day */
                if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_intervalCfgMask,
                         `$INSTANCE_NAME`_INTERVAL_DAY_MASK))
                {
            ...
            else
            {
                ...
                if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_dstModeType, `$INSTANCE_NAME`_DST_ENABLE))
                {
                    ...
                    {
                        if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_dstStopStatus, `$INSTANCE_NAME`_DST_HOUR |
            ...
            /* Every Hour */
            if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_intervalCfgMask, `$INSTANCE_NAME`_INTERVAL_HOUR_MASK))
            {
        ...
        /* Every Min */
        if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_intervalCfgMask, `$INSTANCE_NAME`_INTERVAL_MIN_MASK))
        {
    ...
    /* Set Alarm flag event */
    `$INSTANCE_NAME`_tmp = `$INSTANCE_NAME`_alarmCfgMask;
    `$INSTANCE_NAME`_SET_ALARM(`$INSTANCE_NAME`_tmp, `$INSTANCE_NAME`_alarmCurStatus, `$INSTANCE_NAME`_statusDateTime);

    /* Execute every second handler if needed */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_intervalCfgMask, `$INSTANCE_NAME`_INTERVAL_SEC_MASK))
    {
