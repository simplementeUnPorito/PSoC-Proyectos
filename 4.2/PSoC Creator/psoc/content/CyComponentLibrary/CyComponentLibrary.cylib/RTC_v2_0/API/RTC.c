...
/* Function Prototypes */
static void  `$INSTANCE_NAME`_SetInitValues(void)     `=ReentrantKeil($INSTANCE_NAME . "_SetInitValues")`;
static uint8 `$INSTANCE_NAME`_DayOfWeek(uint8 dayOfMonth, uint8 month, uint16 year)
                                                      `=ReentrantKeil($INSTANCE_NAME . "_DayOfWeek")`;
#if (1u == `$INSTANCE_NAME`_DST_FUNC_ENABLE)
    static void  `$INSTANCE_NAME`_DSTDateConversion(void) `=ReentrantKeil($INSTANCE_NAME . "_DSTDateConversion")`;
...
`$INSTANCE_NAME`_TIME_DATE `$INSTANCE_NAME`_alarmCfgTimeDate = {0u, 0u, 0u, 1u, 1u, 1u, 1u, 1900u};
    ...
    volatile uint8 `$INSTANCE_NAME`_dstModeType = 0u;
    ...
    volatile uint8 `$INSTANCE_NAME`_dstOffsetMin = 0u;
    volatile uint8 `$INSTANCE_NAME`_dstStartStatus = 0u;
    volatile uint8 `$INSTANCE_NAME`_dstStopStatus = 0u;

#endif /* 1u == `$INSTANCE_NAME`_DST_FUNC_ENABLE*/

/* Mask Registers */
volatile uint8 `$INSTANCE_NAME`_alarmCfgMask = 0u;
volatile uint8 `$INSTANCE_NAME`_alarmCurStatus = 0u;
volatile uint8 `$INSTANCE_NAME`_intervalCfgMask = 0u;

/* Status & Control Variables */
volatile uint8 `$INSTANCE_NAME`_statusDateTime = 0u;
...
void `$INSTANCE_NAME`_Stop(void) `=ReentrantKeil($INSTANCE_NAME . "_Stop")`
{
    ...
    `$INSTANCE_NAME`_OPPS_CFG_REG &= (uint8)(~(`$INSTANCE_NAME`_OPPSIE_EN_MASK | `$INSTANCE_NAME`_OPPS_EN_MASK));
...
*
* Parameters:
*  timeDate: Pointer to `$INSTANCE_NAME`_TIME_DATE global structure where new
...
void `$INSTANCE_NAME`_WriteAlarmSecond(uint8 second) `=ReentrantKeil($INSTANCE_NAME . "_WriteAlarmSecond")`
{
    ...
    {
        /* Clear second alarm */
        `$INSTANCE_NAME`_alarmCurStatus &= (uint8)(~`$INSTANCE_NAME`_ALARM_SEC_MASK);
    }
}
...
void `$INSTANCE_NAME`_WriteAlarmMinute(uint8 minute) `=ReentrantKeil($INSTANCE_NAME . "_WriteAlarmMinute")`
{
    ...
    {
        /* Clear minute alarm */
        `$INSTANCE_NAME`_alarmCurStatus &= (uint8)(~`$INSTANCE_NAME`_ALARM_MIN_MASK);
    }
}
...
void `$INSTANCE_NAME`_WriteAlarmHour(uint8 hour) `=ReentrantKeil($INSTANCE_NAME . "_WriteAlarmHour")`
{
    ...
    {
        /* Clear hour alarm */
        `$INSTANCE_NAME`_alarmCurStatus &= (uint8)(~`$INSTANCE_NAME`_ALARM_HOUR_MASK);
    }
}
...
void `$INSTANCE_NAME`_WriteAlarmDayOfMonth(uint8 dayOfMonth) `=ReentrantKeil($INSTANCE_NAME . "_WriteAlarmDayOfMonth")`
{
    ...
    else /* no day of month alarm */
    {
        ...
        `$INSTANCE_NAME`_alarmCurStatus &= (uint8)(~`$INSTANCE_NAME`_ALARM_DAYOFMONTH_MASK);
    }
}
...
void `$INSTANCE_NAME`_WriteAlarmMonth(uint8 month) `=ReentrantKeil($INSTANCE_NAME . "_WriteAlarmMonth")`
{
    ...
    {
        /* Clear month alarm */
        `$INSTANCE_NAME`_alarmCurStatus &= (uint8)(~`$INSTANCE_NAME`_ALARM_MONTH_MASK);
    }
}
...
void `$INSTANCE_NAME`_WriteAlarmYear(uint16 year) `=ReentrantKeil($INSTANCE_NAME . "_WriteAlarmYear")`
{
   `$INSTANCE_NAME`_alarmCfgTimeDate.Year = year;
    ...
    {
        /* Set year alarm */
        `$INSTANCE_NAME`_alarmCurStatus &= (uint8)(~`$INSTANCE_NAME`_ALARM_YEAR_MASK);
    }
}
...
void `$INSTANCE_NAME`_WriteAlarmDayOfWeek(uint8 dayOfWeek) `=ReentrantKeil($INSTANCE_NAME . "_WriteAlarmDayOfWeek")`
{
    ...
    {
        /* Set day of week alarm */
        `$INSTANCE_NAME`_alarmCurStatus &= (uint8)(~`$INSTANCE_NAME`_ALARM_DAYOFWEEK_MASK);
    }
}
...
void `$INSTANCE_NAME`_WriteAlarmDayOfYear(uint16 dayOfYear) `=ReentrantKeil($INSTANCE_NAME . "_WriteAlarmDayOfYear")`
{
  `$INSTANCE_NAME`_alarmCfgTimeDate.DayOfYear = dayOfYear;
    ...
    {
        /* Set day of year alarm */
        `$INSTANCE_NAME`_alarmCurStatus &= (uint8)(~`$INSTANCE_NAME`_ALARM_DAYOFYEAR_MASK);
    }
}
...
uint8 `$INSTANCE_NAME`_ReadStatus(void) `=ReentrantKeil($INSTANCE_NAME . "_ReadStatus")`
{
    ...
    `$INSTANCE_NAME`_statusDateTime &= (uint8)(~`$INSTANCE_NAME`_STATUS_AA);
...
`=ReentrantKeil($INSTANCE_NAME . "_DayOfWeek")`
{
    ...
    static const uint8 CYCODE `$INSTANCE_NAME`_monthTemplate[`$INSTANCE_NAME`_MONTHS_IN_YEAR] =
    ...
    */
    ...
    (((uint16)`$INSTANCE_NAME`_monthTemplate[month - 1u]) + ((uint16) dayOfMonth))) % `$INSTANCE_NAME`_DAYS_IN_WEEK));
}
...
{
    uint8 i;
    uint8 `$INSTANCE_NAME`_alarmCfgMaskTemp;
    ...
    {
        /* Clear LP Year flag */
        `$INSTANCE_NAME`_statusDateTime &= (uint8)(~`$INSTANCE_NAME`_STATUS_LY);
    ...
    /* Leap year check */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_statusDateTime, `$INSTANCE_NAME`_STATUS_LY))
    {
        /* Leap day check */
        if(`$INSTANCE_NAME`_currentTimeDate.Month > `$INSTANCE_NAME`_FEBRUARY)
        {
            /* Add leap day */
    ...
    else
    {
        ...
        if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_dstModeType, `$INSTANCE_NAME`_DST_RELDATE))
        {
        ...
        {
            `$INSTANCE_NAME`_statusDateTime &= (uint8)(~`$INSTANCE_NAME`_STATUS_DST);
        }
        ...
        */
        ...
        {
            `$INSTANCE_NAME`_dstStopStatus &= (uint8)(~`$INSTANCE_NAME`_DST_MONTH);
        }
        ...
        */
        ...
        {
            `$INSTANCE_NAME`_dstStartStatus &= (uint8)(~`$INSTANCE_NAME`_DST_MONTH);
        }
        ...
        */
        ...
        {
            `$INSTANCE_NAME`_dstStopStatus &= (uint8)(~`$INSTANCE_NAME`_DST_DAYOFMONTH);
        }
        ...
        */
        ...
        {
            `$INSTANCE_NAME`_dstStartStatus &= (uint8)(~`$INSTANCE_NAME`_DST_DAYOFMONTH);
        }
        ...
        */
        ...
        {
            `$INSTANCE_NAME`_dstStopStatus &= (uint8)(~`$INSTANCE_NAME`_DST_HOUR);
        }
        ...
        */
        ...
        {
            `$INSTANCE_NAME`_dstStartStatus &= (uint8)(~`$INSTANCE_NAME`_DST_HOUR);
        }

        /* DST Enable ? */
        if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_dstModeType, `$INSTANCE_NAME`_DST_ENABLE))
        {
            if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_statusDateTime, `$INSTANCE_NAME`_STATUS_DST))
            {
                if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_dstStartStatus,
                        (`$INSTANCE_NAME`_DST_HOUR | `$INSTANCE_NAME`_DST_DAYOFMONTH | `$INSTANCE_NAME`_DST_MONTH)))
                {
                    ...
                    */
                    if(`$INSTANCE_NAME`_currentTimeDate.Min > `$INSTANCE_NAME`_HOUR_ELAPSED)
                    {
                        ...
                        `$INSTANCE_NAME`_currentTimeDate.Min = `$INSTANCE_NAME`_HOUR_ELAPSED -
                                                               ((uint8)(~`$INSTANCE_NAME`_currentTimeDate.Min));
                    ...
                    */
                    ...
                    if(`$INSTANCE_NAME`_currentTimeDate.Hour > `$INSTANCE_NAME`_DAY_ELAPSED)
                    {
                        ...
                        `$INSTANCE_NAME`_currentTimeDate.Hour = `$INSTANCE_NAME`_DAY_ELAPSED -
                                                                ((uint8)(~`$INSTANCE_NAME`_currentTimeDate.Hour));
            ...
            {
                if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_dstStartStatus, `$INSTANCE_NAME`_DST_HOUR |
                                                     `$INSTANCE_NAME`_DST_DAYOFMONTH | `$INSTANCE_NAME`_DST_MONTH))
                {
                    /* Add Hour and Min */
    ...
    if(`$INSTANCE_NAME`_currentTimeDate.Hour < `$INSTANCE_NAME`_HALF_OF_DAY_ELAPSED)
    {
        ...
        `$INSTANCE_NAME`_statusDateTime &= (uint8)(~`$INSTANCE_NAME`_STATUS_AM_PM);
    }
    else
    {
    ...
    /* Alarm SEC */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask, `$INSTANCE_NAME`_ALARM_SEC_MASK))
    {
        if(`$INSTANCE_NAME`_alarmCfgTimeDate.Sec == `$INSTANCE_NAME`_currentTimeDate.Sec)
        {
            /* Set second alarm */
    ...
    /* Alarm MIN */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask, `$INSTANCE_NAME`_ALARM_MIN_MASK))
    {
        if(`$INSTANCE_NAME`_alarmCfgTimeDate.Min == `$INSTANCE_NAME`_currentTimeDate.Min)
        {
            /* Set minute alarm */
    ...
    /* Alarm HOUR */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask, `$INSTANCE_NAME`_ALARM_HOUR_MASK))
    {
        if(`$INSTANCE_NAME`_alarmCfgTimeDate.Hour == `$INSTANCE_NAME`_currentTimeDate.Hour)
        {
            /* Set hour alarm */
    ...
    /* Alarm DAYOFWEEK */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask, `$INSTANCE_NAME`_ALARM_DAYOFWEEK_MASK))
    {
        if(`$INSTANCE_NAME`_alarmCfgTimeDate.DayOfWeek == `$INSTANCE_NAME`_currentTimeDate.DayOfWeek)
        {
            /* Set day of week alarm */
    ...
    /* Alarm DAYOFYEAR */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask, `$INSTANCE_NAME`_ALARM_DAYOFYEAR_MASK))
    {
        if(`$INSTANCE_NAME`_alarmCfgTimeDate.DayOfYear == `$INSTANCE_NAME`_currentTimeDate.DayOfYear)
        {
            /* Set day of year alarm */
    ...
    /* Alarm DAYOFMONTH */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask, `$INSTANCE_NAME`_ALARM_DAYOFMONTH_MASK))
    {
        if(`$INSTANCE_NAME`_alarmCfgTimeDate.DayOfMonth == `$INSTANCE_NAME`_currentTimeDate.DayOfMonth)
        {
            /* Set day of month alarm */
    ...
    /* Alarm MONTH */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask, `$INSTANCE_NAME`_ALARM_MONTH_MASK))
    {
        if(`$INSTANCE_NAME`_alarmCfgTimeDate.Month == `$INSTANCE_NAME`_currentTimeDate.Month)
        {
            /* Set month alarm */
    ...
    /* Alarm YEAR */
    if(0u != `$INSTANCE_NAME`_IS_BIT_SET(`$INSTANCE_NAME`_alarmCfgMask, `$INSTANCE_NAME`_ALARM_YEAR_MASK))
    {
        if(`$INSTANCE_NAME`_alarmCfgTimeDate.Year == `$INSTANCE_NAME`_currentTimeDate.Year)
        {
            /* Set year alarm */
    ...
    `$INSTANCE_NAME`_alarmCfgMaskTemp = `$INSTANCE_NAME`_alarmCfgMask;
    /* Set Alarm flag event */
    `$INSTANCE_NAME`_SET_ALARM(`$INSTANCE_NAME`_alarmCfgMaskTemp,
    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_WriteDSTMode(uint8 mode) `=ReentrantKeil($INSTANCE_NAME . "_WriteDSTMode")`
    {
        ...
        if(0u != `$INSTANCE_NAME`_IS_BIT_SET(mode, `$INSTANCE_NAME`_DST_RELDATE))
        {
            /* Convert DST date */
            `$INSTANCE_NAME`_DSTDateConversion();
        }
