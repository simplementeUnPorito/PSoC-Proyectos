...
void `$INSTANCE_NAME`_ISR(void)
{
    ...
    intr_status = Cy_SAR_GetInterruptStatus(`$INSTANCE_NAME`_SAR__HW);
    ...
    *************************************************************************/
    ...
    Cy_SAR_ClearInterrupt(`$INSTANCE_NAME`_SAR__HW, intr_status);
    /* Read interrupt status register to ensure write completed due to buffered writes */
    (void)Cy_SAR_GetInterruptStatus(`$INSTANCE_NAME`_SAR__HW);
}
