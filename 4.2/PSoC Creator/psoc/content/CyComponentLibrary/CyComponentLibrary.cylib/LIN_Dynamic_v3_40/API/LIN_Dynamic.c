...
l_bool l_sys_init(void)
{
    ...
    if(`$INSTANCE_1_NAME`_initVar == 0u)
    {
            ...
            `$INSTANCE_1_NAME`_initialClockDivider =
    		    ...
    		    /* Save original clock divider */
                `$INSTANCE_2_NAME`_initialClockDivider = (uint16) (`$INSTANCE_2_NAME`_IntClk_GetDividerRegister() + 1u);
...
l_u8 ld_read_configuration(l_ifc_handle iii, l_u8* pData, l_u8* const length)
{
    l_u8 returnValue = `$INSTANCE_1_NAME`_LD_READ_OK;
       ...
       ((0u == `$INSTANCE_1_NAME`_IS_MULTI_INSTANCE) || (1u != `$INSTANCE_2_NAME`_TL_ENABLED)))
...
l_u8 ld_read_by_id_callout(l_ifc_handle iii, l_u8 id, l_u8* frameData)
{
    l_u8 returnValue = LD_NEGATIVE_RESPONSE;
    ...
    #if( ((1u != `$INSTANCE_1_NAME`_TL_ENABLED) || \
          (1u != `$INSTANCE_1_NAME`_CS_ENABLED) || \
          ((0u == (`$INSTANCE_1_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_1_NAME`_NCS_0xB2_SEL)) && \
           (0u == (`$INSTANCE_1_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_1_NAME`_NCS_0xB3_SEL)))) \
         && \
         ((0u == `$INSTANCE_1_NAME`_IS_MULTI_INSTANCE) || \
          (1u != `$INSTANCE_2_NAME`_TL_ENABLED) || \
          (1u != `$INSTANCE_2_NAME`_CS_ENABLED) || \
          ((0u == (`$INSTANCE_2_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_2_NAME`_NCS_0xB2_SEL)) && \
           (0u == (`$INSTANCE_2_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_2_NAME`_NCS_0xB3_SEL)))) )
        ...
        switch(iii)
        {
                    ...
                    #if((0u != (`$INSTANCE_1_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_1_NAME`_NCS_0xB2_SEL)) || \
                        (0u != (`$INSTANCE_1_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_1_NAME`_NCS_0xB3_SEL)))
                        case `$INSTANCE_1_NAME`_IFC_HANDLE:
                            returnValue = ld_read_by_id_callout_`$INSTANCE_1_NAME`(id,frameData);
                        break;
                    #endif /* ((0u != (`$INSTANCE_1_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_1_NAME`_NCS_0xB2_SEL)) || \
                              (0u != (`$INSTANCE_1_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_1_NAME`_NCS_0xB3_SEL))) */
                ...
                /* Go here is interface 2 is specified */
                        ...
                        #if((0u != (`$INSTANCE_2_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_2_NAME`_NCS_0xB2_SEL)) || \
                            (0u != (`$INSTANCE_2_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_2_NAME`_NCS_0xB3_SEL)))
                                case `$INSTANCE_2_NAME`_IFC_HANDLE:
                                    returnValue = ld_read_by_id_callout_`$INSTANCE_2_NAME`(id,frameData);
                                break;
                        #endif /* ((0u != (`$INSTANCE_2_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_2_NAME`_NCS_0xB2_SEL)) || \
                            (0u != (`$INSTANCE_2_NAME`_CS_SEL_SERVICES01 & `$INSTANCE_2_NAME`_NCS_0xB3_SEL))) */
...
void ld_send_message(l_ifc_handle iii, l_u16 length, l_u8 nad, const l_u8* const ld_data)
{
    ...
    */
    ...
    #if( ((1u != `$INSTANCE_1_NAME`_TL_ENABLED) || (1u != `$INSTANCE_1_NAME`_TL_API_FORMAT)) && \
         ((0u == `$INSTANCE_1_NAME`_IS_MULTI_INSTANCE) || (1u != `$INSTANCE_2_NAME`_TL_ENABLED) || \
