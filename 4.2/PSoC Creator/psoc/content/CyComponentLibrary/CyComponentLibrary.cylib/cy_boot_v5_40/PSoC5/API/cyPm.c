...
/* Function Prototypes */
static void CyPmHibSaveSet(void)`=ReentrantKeil("CyPmHibSaveSet")`;
static void CyPmHibRestore(void) `=ReentrantKeil("CyPmHibRestore")`;

static void CyPmHibSlpSaveSet(void) `=ReentrantKeil("CyPmHibSlpSaveSet")`;
static void CyPmHibSlpRestore(void) `=ReentrantKeil("CyPmHibSlpRestore")`;

static void CyPmHviLviSaveDisable(void) `=ReentrantKeil("CyPmHviLviSaveDisable")`;
static void CyPmHviLviRestore(void) `=ReentrantKeil("CyPmHviLviRestore")`;
...
*
*******************************************************************************/
void CyPmSaveClocks(void) `=ReentrantKeil("CyPmSaveClocks")`
{
...
*
*******************************************************************************/
void CyPmRestoreClocks(void) `=ReentrantKeil("CyPmRestoreClocks")`
{
...
*
*******************************************************************************/
void CyPmAltAct(uint16 wakeupTime, uint16 wakeupSource) `=ReentrantKeil("CyPmAltAct")`
{
    #if(CY_PSOC5)
...
*
*******************************************************************************/
void CyPmSleep(uint8 wakeupTime, uint16 wakeupSource) `=ReentrantKeil("CyPmSleep")`
{
...
*
*******************************************************************************/
void CyPmHibernate(void) `=ReentrantKeil("CyPmHibernate")`
{
...
*
*******************************************************************************/
void CyPmHibernateEx(uint16 wakeupSource) `=ReentrantKeil("CyPmHibernateEx")`
{
    uint8 interruptState;
...
*
*******************************************************************************/
uint8 CyPmReadStatus(uint8 mask) `=ReentrantKeil("CyPmReadStatus")`
{
...
*
*******************************************************************************/
void CyPmCtwSetInterval(uint8 ctwInterval) `=ReentrantKeil("CyPmCtwSetInterval")`
{
...
*
*******************************************************************************/
void CyPmOppsSet(void) `=ReentrantKeil("CyPmOppsSet")`
{
...
*
*******************************************************************************/
void CyPmFtwSetInterval(uint8 ftwInterval) `=ReentrantKeil("CyPmFtwSetInterval")`
{
