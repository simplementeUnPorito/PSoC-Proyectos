...
*/
#define `$INSTANCE_NAME`_12_HOURS_FORMAT    (`$INSTANCE_NAME`__HOUR_12) /**< The 24 hour format */
#define `$INSTANCE_NAME`_24_HOURS_FORMAT    (`$INSTANCE_NAME`__HOUR_24) /**< The 12 hour (AM/PM) format */
