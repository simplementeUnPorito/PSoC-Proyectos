...
*/
     ...
     *  @{
     */
    #define `$INSTANCE_NAME`_GAIN_1_00          ((uint32)`$INSTANCE_NAME`__GAIN_1)
    #define `$INSTANCE_NAME`_GAIN_1_42          ((uint32)`$INSTANCE_NAME`__GAIN_1_4)
    #define `$INSTANCE_NAME`_GAIN_2_00          ((uint32)`$INSTANCE_NAME`__GAIN_2)
    #define `$INSTANCE_NAME`_GAIN_2_78          ((uint32)`$INSTANCE_NAME`__GAIN_2_8)
    #define `$INSTANCE_NAME`_GAIN_4_00          ((uint32)`$INSTANCE_NAME`__GAIN_4)
    #define `$INSTANCE_NAME`_GAIN_5_82          ((uint32)`$INSTANCE_NAME`__GAIN_5_8)
    #define `$INSTANCE_NAME`_GAIN_8_00          ((uint32)`$INSTANCE_NAME`__GAIN_8)
    #define `$INSTANCE_NAME`_GAIN_10_7          ((uint32)`$INSTANCE_NAME`__GAIN_10_7)
    #define `$INSTANCE_NAME`_GAIN_16_0          ((uint32)`$INSTANCE_NAME`__GAIN_16)
    #define `$INSTANCE_NAME`_GAIN_21_3          ((uint32)`$INSTANCE_NAME`__GAIN_21_3)
    #define `$INSTANCE_NAME`_GAIN_32_0          ((uint32)`$INSTANCE_NAME`__GAIN_32)
    /** @} gain */
/** @} group_constants */

/* The next gain constants are not recommended to use in new projects,
   they are legacy provided for backward compatibility */
    #define `$INSTANCE_NAME`_GAIN_1             (`$INSTANCE_NAME`_GAIN_1_00)
    #define `$INSTANCE_NAME`_GAIN_1_4           (`$INSTANCE_NAME`_GAIN_1_42)
    #define `$INSTANCE_NAME`_GAIN_2             (`$INSTANCE_NAME`_GAIN_2_00)
    #define `$INSTANCE_NAME`_GAIN_2_8           (`$INSTANCE_NAME`_GAIN_2_78)
    #define `$INSTANCE_NAME`_GAIN_4             (`$INSTANCE_NAME`_GAIN_4_00)
    #define `$INSTANCE_NAME`_GAIN_5_8           (`$INSTANCE_NAME`_GAIN_5_82)
    #define `$INSTANCE_NAME`_GAIN_8             (`$INSTANCE_NAME`_GAIN_8_00)    
    #define `$INSTANCE_NAME`_GAIN_16            (`$INSTANCE_NAME`_GAIN_16_0)    
    #define `$INSTANCE_NAME`_GAIN_32            (`$INSTANCE_NAME`_GAIN_32_0)
...
#define `$INSTANCE_NAME`_OA_SW_CLEAR_REG        (*(reg32 *) `$INSTANCE_NAME`_cy_psoc4_abuf__OA_SW_CLEAR)
#define `$INSTANCE_NAME`_OA_SW_CLEAR_PTR        ( (reg32 *) `$INSTANCE_NAME`_cy_psoc4_abuf__OA_SW_CLEAR)
...
#define `$INSTANCE_NAME`_RES_SWAP_SHIFT         (20u)   /* Resistor ladder swap (top <-> bottom) */
#define `$INSTANCE_NAME`_RES_SWAP               ((uint32)0x01u << `$INSTANCE_NAME`_RES_SWAP_SHIFT)
