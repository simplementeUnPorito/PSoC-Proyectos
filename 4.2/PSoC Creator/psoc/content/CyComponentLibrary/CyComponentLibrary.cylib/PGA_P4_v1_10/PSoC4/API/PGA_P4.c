...
*   * `$INSTANCE_NAME`_GAIN_1_00 - gain 1.00.
*   * `$INSTANCE_NAME`_GAIN_1_42 - gain 1.42.
*   * `$INSTANCE_NAME`_GAIN_2_00 - gain 2.00.
*   * `$INSTANCE_NAME`_GAIN_2_78 - gain 2.78.
*   * `$INSTANCE_NAME`_GAIN_4_00 - gain 4.00.
*   * `$INSTANCE_NAME`_GAIN_5_82 - gain 5.82.
*   * `$INSTANCE_NAME`_GAIN_8_00 - gain 8.00.
*   * `$INSTANCE_NAME`_GAIN_10_7 - gain 10.7.
*   * `$INSTANCE_NAME`_GAIN_16_0 - gain 16.0.
*   * `$INSTANCE_NAME`_GAIN_21_3 - gain 21.3.
*   * `$INSTANCE_NAME`_GAIN_32_0 - gain 32.0.
*
*  \internal
*   The `$INSTANCE_NAME`_internalGainPower variable is used to store the
*   current gain and power level to set appropriate compensation settings.
...
void `$INSTANCE_NAME`_SetGain(uint32 gainLevel)
{
    ...
    if(`$INSTANCE_NAME`_GAIN_1_00 == gainLevel)
    {
        /* Disconnect the resistor matrix bottom from the internal Vss */
        `$INSTANCE_NAME`_OA_SW_CLEAR_REG = `$INSTANCE_NAME`_RBOT_TO_VSSA;
    }
    else
    {
