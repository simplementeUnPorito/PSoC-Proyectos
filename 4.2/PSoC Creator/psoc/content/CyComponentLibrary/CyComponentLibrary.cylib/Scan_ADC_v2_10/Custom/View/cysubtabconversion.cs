...
namespace Scan_ADC_v2_10
{
    public class CyConversionSubtab : CyTabControlWrapper
    {
        ...
        public override string TabName
        {
            get
            {
                return global::Scan_ADC_v2_10.View.cytooltips.conversionTabName;
            }
        }
        #endregion
        ...
        private void InitializeComponent()
        {
            ...
            this.m_tlpTiming.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
            this.m_tlpTiming.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
            this.m_tlpTiming.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 20F));
            ...
            this.m_tlpTiming.Size = new System.Drawing.Size(634, 85);
            ...
            this.m_dgvcChannel.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelNumberToolTip;
            ...
            this.m_dgvcEnable.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.enableChannelToolTip;
            ...
            this.m_dgvcResolution.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelResolutionToolTip;
            // 
            // m_dgvcInputMode
            // 
            ...
            this.m_dgvcInputMode.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelInputModeToolTip;
            // 
            // m_dgvcAverage
            // 
            ...
            this.m_dgvcAverage.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelAveragingToolTip;
            ...
            this.m_dgvcAcqTime.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.minAcqTimeToolTip;
            // 
            // m_dgvcActualAcq
            // 
            ...
            this.m_dgvcActualAcq.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.actAcqTimeToolTip;
            // 
            // m_dgvcMaxInResist
            // 
            ...
            this.m_dgvcMaxInResist.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.maxInputResistanceToolTip;
            ...
            this.m_dgvcLimitInterrupt.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelUseLimitIntToolTip;
            // 
            ...
            this.m_dgvcSaturationInterrupt.ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelUseSaturationIntToolTip;
            // 
            // m_gbInputRange
            // 
        ...
        {
            CyConfigModel config = this.m_params.GetConfig(0);

            this.m_nudSampleRate.Maximum = new decimal(new int[] {
                config.Sar.MaxSarFrequency / CySarRanges.SAR_MIN_ADC_CLOCKS_PER_CONVERSION,
                0,
                0,
                0});
            ...
            if (m_params != null)
            {
                ...
                config.Sar.SetVrefComboBox(m_cmbVrefSource);
                m_cbVrefBypass.Visible = config.Sar.HasExtVrefConnection;
        ...
        private void SetDataGridViewState(){
            ...
            if (config.Sar.HasAltResolution == false)
            {
                m_dgvChannels.Columns[m_dgvcResolution.Index].Visible = false;
            }
        ...
        {
            this.m_convToolTip.SetToolTip(this.m_nudSampleRate, Scan_ADC_v2_10.View.cytooltips.sampleRateToolTip);                      
            this.m_convToolTip.SetToolTip(this.m_lVref, Scan_ADC_v2_10.View.cytooltips.vrefSourceToolTip);
            this.m_convToolTip.SetToolTip(this.m_cmbVrefSource, Scan_ADC_v2_10.View.cytooltips.vrefSourceToolTip);
            this.m_convToolTip.SetToolTip(this.m_nudVrefVoltage, Scan_ADC_v2_10.View.cytooltips.vrefValueToolTip);
            this.m_convToolTip.SetToolTip(this.m_cbVrefBypass, Scan_ADC_v2_10.View.cytooltips.vrefBypassToolTip);
            this.m_convToolTip.SetToolTip(this.m_lVneg, Scan_ADC_v2_10.View.cytooltips.vnegSourceToolTip);
            this.m_convToolTip.SetToolTip(this.m_cmbVnegSource, Scan_ADC_v2_10.View.cytooltips.vnegSourceToolTip);
            this.m_convToolTip.SetToolTip(this.m_lDiffResultFormat, Scan_ADC_v2_10.View.cytooltips.diffResultFormatToolTip);
            this.m_convToolTip.SetToolTip(this.m_cmbDiffResultFormat, Scan_ADC_v2_10.View.cytooltips.diffResultFormatToolTip);
            this.m_convToolTip.SetToolTip(this.m_lSEResultFormat, Scan_ADC_v2_10.View.cytooltips.seResultFormatToolTip);
            this.m_convToolTip.SetToolTip(this.m_cmbSEResultFormat, Scan_ADC_v2_10.View.cytooltips.seResultFormatToolTip);
            this.m_convToolTip.SetToolTip(this.m_lSamplesAveraged, Scan_ADC_v2_10.View.cytooltips.samplesAvgdToolTip);
            this.m_convToolTip.SetToolTip(this.m_cmbSamplesAveraged, Scan_ADC_v2_10.View.cytooltips.samplesAvgdToolTip);
            this.m_convToolTip.SetToolTip(this.m_lAveragingMode, Scan_ADC_v2_10.View.cytooltips.averageModeToolTip);
            this.m_convToolTip.SetToolTip(this.m_cmbAveragingMode, Scan_ADC_v2_10.View.cytooltips.averageModeToolTip);
            this.m_convToolTip.SetToolTip(this.m_lAlternateResolution, Scan_ADC_v2_10.View.cytooltips.altResolutionToolTip);
            this.m_convToolTip.SetToolTip(this.m_cmbAlternateResolution, Scan_ADC_v2_10.View.cytooltips.altResolutionToolTip);
            this.m_convToolTip.SetToolTip(this.m_lCompareMode, Scan_ADC_v2_10.View.cytooltips.compareModeToolTip);
            this.m_convToolTip.SetToolTip(this.m_cmbCompareMode, Scan_ADC_v2_10.View.cytooltips.compareModeToolTip);
            this.m_convToolTip.SetToolTip(this.m_lLowLimit, Scan_ADC_v2_10.View.cytooltips.lowLimitToolTip);
            this.m_convToolTip.SetToolTip(this.m_nudLowLimit, Scan_ADC_v2_10.View.cytooltips.lowLimitToolTip);
            this.m_convToolTip.SetToolTip(this.m_lHighLimit, Scan_ADC_v2_10.View.cytooltips.highLimitToolTip);
            this.m_convToolTip.SetToolTip(this.m_nudHighLimit, Scan_ADC_v2_10.View.cytooltips.highLimitToolTip);
            this.m_convToolTip.SetToolTip(this.m_lSequencedChannels, Scan_ADC_v2_10.View.cytooltips.sequencedChannelsToolTip);
            this.m_convToolTip.SetToolTip(this.m_nudSequencedChannels, Scan_ADC_v2_10.View.cytooltips.sequencedChannelsToolTip);
        }
        ...
        public void UpdateUI()
        {
            ...
            for (int chanNum = 0; chanNum < config.ChannelList.Count; chanNum++)
            {
                ...
                m_dgvChannels[m_dgvcChannel.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelNumberToolTip;
                m_dgvChannels[m_dgvcEnable.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.enableChannelToolTip;
                m_dgvChannels[m_dgvcResolution.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelResolutionToolTip;
                m_dgvChannels[m_dgvcInputMode.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelInputModeToolTip;
                m_dgvChannels[m_dgvcAverage.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelAveragingToolTip;
                m_dgvChannels[m_dgvcAcqTime.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.minAcqTimeToolTip;
                m_dgvChannels[m_dgvcActualAcq.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.actAcqTimeToolTip;
                m_dgvChannels[m_dgvcMaxInResist.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.maxInputResistanceToolTip;
                m_dgvChannels[m_dgvcLimitInterrupt.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelUseLimitIntToolTip;
                m_dgvChannels[m_dgvcSaturationInterrupt.Index, chanNum].ToolTipText = global::Scan_ADC_v2_10.View.cytooltips.channelUseSaturationIntToolTip;
            }
            ...
            UpdateRangeLabels();
            UpdateAltResolutionLabels(config);
        ...
        private void UpdateAdcClockRateDisplay(CyConfigModel config)
        {
            ...
            m_lValidClockFreq.Text = CyModelUtils.ClockRangeMHzText(
                config.Sar.MinSarFrequency, config.Sar.MaxSarFrequency);
        }
        ...
        private void UpdateGuiErrors()
        {
            ...
            message = ((m_params.IsFilterAllowed == false)
                ...
                ? string.Format(
                    global::Scan_ADC_v2_10.Controller.cydrcerrors.FilterNotSupportedNotice,
                    partNumber)
                    : string.Empty;
            ...
            for (int chanNum = 0; chanNum < config.ChannelList.Count; chanNum++)
            {
                message = (CyGuiChecks.IsAltResAverage(config, chanNum))
                    ? global::Scan_ADC_v2_10.View.cyguierrors.AltResolutionAverage
                    : string.Empty;
            ...
            message = !anyChanEnabled
                ? global::Scan_ADC_v2_10.Controller.cydrcerrors.AllChannelsDisabled
                : string.Empty;
            ...
            var minVref = config.Sar.MinVrefVoltage;
            message = config.VrefVoltage > maxVref
                    ? string.Format(Scan_ADC_v2_10.View.cyguierrors.VrefTooHigh, maxVref.ToString("N3"))
                    : config.VrefVoltage < minVref
                    ? string.Format(Scan_ADC_v2_10.View.cyguierrors.VrefTooLow, minVref.ToString("N3"))
                    : "";
            m_errorProvider.SetError(m_lVrefErr, message);

            if ((config.Sar.VrefSource == CyEVrefSource.VREFSOURCE_VDDA) && config.Sar.VrefBypass)
            {
                m_noteProvider.SetError(m_cbVrefBypass, Scan_ADC_v2_10.View.cyguierrors.VrefBypassNotice);
            }
            else
            {
            ...
            {
                m_warningProvider.SetError(m_cmbSEResultFormat, Scan_ADC_v2_10.View.cyguierrors.VnegResultNotice);
            }
            else
            {
            ...
            {
                if (m_params.SarType == CyESarType.SAR_MXS40PASS)
                    m_errorProvider.SetError(m_cmbSamplesAveraged, Scan_ADC_v2_10.View.cyguierrors.AverageOverflowError);
                else
                    m_warningProvider.SetError(m_cmbSamplesAveraged, Scan_ADC_v2_10.View.cyguierrors.AverageOverflowNotice);
            }
            else
            {
                if (m_params.SarType == CyESarType.SAR_MXS40PASS)
                    m_errorProvider.SetError(m_cmbSamplesAveraged, "");
                else
            ...
            var convTimeNotice
                ...
                ? Scan_ADC_v2_10.View.cyguierrors.ExternalClockNotice
                : CyModelUtils.InvalidInternalAdcClock(m_params)
                ? Scan_ADC_v2_10.View.cyguierrors.InternalClockNotice
                : "";
            m_errorProvider.SetError(m_lConversionTimeNum, convTimeNotice);

            var adcClockNotice
                = CyModelUtils.AdcClockOutOfRange(m_params, this.ConfigNumber)
                ? string.Format(Scan_ADC_v2_10.View.cyguierrors.AdcClockOutOfRange,
                CyModelUtils.ClockFreqMHzText(config.ActualAdcClockHz),
        ...
        private void UpdateVrefControls()
        {
            ...
            if (displayValue != null)
            {
                ...
                if (   displayValue.Value == CyEVrefSource.VREFSOURCE_EXTERNAL
                    ...
                    || (m_params.SarType == CyESarType.SAR_MXS40PASS
                    && displayValue.Value == CyEVrefSource.VREFSOURCE_VBGR
                    && (double.IsNaN(m_params.InstQuery.VoltageQuery.SystemReference))))
                {
        ...
        private void UpdateAltResolutionLabels(CyConfigModel config)
        {
            if(config.Sar.HasAltResolution == false)
            {
                m_lAlternateResolution.Visible = false;
                m_cmbAlternateResolution.Visible = false;
            }
        }
            ...
            if (m_blockParamUpdate == false)
            {
                ...
                else if (sender == m_cmbVrefSource)
                {
                    ...
                    if (displayValue != null)
                    {
                        ...
                        config.Sar.VrefSource = config.VrefSource;
                        updateScanSchedule = true;
                    }
                }
                else
        ...
        private void nud_TextChanged(object sender, EventArgs e)
        {
            ...
            if (m_blockParamUpdate == false)
            {
                ...
                else if (sender == m_nudSequencedChannels)
                {
                    ...
                    config.NumChannels = Math.Max(config.NumChannels, CySarRanges.NUM_CHANNEL_MIN);
                    config.NumChannels = Math.Min(config.NumChannels, CySarRanges.NUM_CHANNEL_MAX);
                    while (config.ChannelList.Count < config.NumChannels)
                    {
                        config.ChannelList.Add(new CyChannelModel(config.Sar.MinAcqTime_ns));
                    }
                    while (config.ChannelList.Count > config.NumChannels)
                    {
        ...
        private void cb_CheckedChanged(object sender, EventArgs e)
        {
            if (m_blockParamUpdate == false)
            {
                ...
                if (sender == m_cbVrefBypass)
                {
                    config.VrefBypass = m_cbVrefBypass.Checked;
                    config.Sar.VrefBypass = config.VrefBypass;
                    updateScanSchedule = true;
                }
        ...
        private void dgv_ElementChanged(object sender, EventArgs e)
        {
            if (m_blockParamUpdate == false)
            {
                ...
                for (int row = 0; row < m_dgvChannels.Rows.Count; row++)
                {
                    ...
                    if (acqTime <  config.Sar.MinAcqTime_ns)
                    {
                        acqTime = config.Sar.MinAcqTime_ns;
                    }
                    if (inputMode == CyEInputMode.FILTER_CHAN)
                    {
                        if (acqTime < CySarRanges.APERTURE_FILTER_MIN_NS)
                        {
                            acqTime = CySarRanges.APERTURE_FILTER_MIN_NS;
                        }
                    }
