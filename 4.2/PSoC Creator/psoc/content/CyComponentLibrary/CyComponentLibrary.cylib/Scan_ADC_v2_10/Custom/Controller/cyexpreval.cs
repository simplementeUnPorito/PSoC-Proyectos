...
namespace Scan_ADC_v2_10
{
    ...
    public static class CyExprEval
    {
        ...
        /// <summary>
        /// Determine if the soc input is edge or level sensitive
        /// </summary>
        /// <param name="parameters">Scan_ADC symbol parameters</param>
        /// <returns>true if a Sample Mode is single-shot, false if not</returns>
        public static bool IsEdgeTrigger(CyParameters parameters)
        {
            ...
            return (CyModelUtils.IsConfigZeroSingleShot(parameters));
        }
