...
#define `$INSTANCE_NAME`_BULK_VDDA_MV_THRESHOLD        (2000)
...
*******************************************************************************/
    ...
    #define `$INSTANCE_NAME`_CFG0_TRANSFERTYPE      `$INSTANCE_NAME`_TRANSFERTYPE_`$Cfg0TransferType`
...
*******************************************************************************/
    ...
    #define `$INSTANCE_NAME`_CFG1_TRANSFERTYPE      `$INSTANCE_NAME`_TRANSFERTYPE_`$Cfg1TransferType`
    /* Capacitors that can be fractional should have *
     * a numerator 0-63 and a denominator 1 or 64.   *
     * CA may have a value 1-127.                    *
     * CB may only have a value 2-64                 */
...
*******************************************************************************/
    ...
    #define `$INSTANCE_NAME`_CFG2_TRANSFERTYPE      `$INSTANCE_NAME`_TRANSFERTYPE_`$Cfg2TransferType`
    /* Capacitors that can be fractional should have *
     * a numerator 0-63 and a denominator 1 or 64.   *
     * CA may have a value 1-127.                    *
     * CB may only have a value 2-64                 */
...
*******************************************************************************/
    ...
    #define `$INSTANCE_NAME`_CFG3_TRANSFERTYPE      `$INSTANCE_NAME`_TRANSFERTYPE_`$Cfg3TransferType`
    /* Capacitors that can be fractional should have *
     * a numerator 0-63 and a denominator 1 or 64.   *
     * CA may have a value 1-127.                    *
     * CB may only have a value 2-64                 */
