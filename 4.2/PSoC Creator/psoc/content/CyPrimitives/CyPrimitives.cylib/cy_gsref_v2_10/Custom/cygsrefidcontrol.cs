...
namespace Cypress.Components.System.cy_gsref_v2_10
{
    public partial class CyGlobalSignalRefIDControl : UserControl, ICyParamEditingControl
    {
        ...
        public CyGlobalSignalRefIDControl(ICyInstEdit_v1 edit, IEnumerable<CyGlobalSignalRef> gsRefs, 
                                          string selectedGSRefID)
        {
            ...
            if (SelectedGSRef != null)
            { 
                labelDescription.Text = SelectedGSRef.Description; 
            }
            else
            {
        ...
        void m_gsRefComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (gsRef != null)
            {
                labelDescription.Text = gsRef.Description;
    ...
    public class CyGlobalSignalRef
    {
        ...
        public CyGlobalSignalRef(string id, string name, string descr)
        {
            m_id = id;
            m_name = name;
            m_description = descr;

            if (m_id == null || m_name == null || m_description == null)
            {
