...
#define DmShift(shift)					(PC_DRIVE_MODE_BITS * shift)
#define SetP4PinDriveMode(shift, mode)	`$INSTANCE_NAME`_PC = (`$INSTANCE_NAME`_PC & ~(PC_DRIVE_MODE_IND_MASK << DmShift(shift))) | (mode << DmShift(shift));
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		uint8 maskedStatus = `$INSTANCE_NAME`_INTSTAT & `$INSTANCE_NAME`_MASK;;
