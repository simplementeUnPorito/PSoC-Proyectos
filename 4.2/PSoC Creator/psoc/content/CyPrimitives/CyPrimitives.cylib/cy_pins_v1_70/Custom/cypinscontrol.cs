...
namespace Cypress.Comps.PinsAndPorts.cy_pins_v1_70
{
    ...
    public partial class CyPinsControl : UserControl, ICyParamEditingControl
    {
        ...
        public CyPinsControl(ICyInstEdit_v1 instEdit, bool isM0S8, bool isGen4)
        {
            InitializeComponent();
            ...
            m_perPinDataControl = new CyPerPinDataControl(this, isM0S8, isGen4);
    ...
    public class CyPerPinDataControl : UserControl
    {
        ...
        public CyPerPinDataControl(CyPinsControl pinControl, bool isM0S8, bool isGen4)
        {
            this.Dock = DockStyle.Fill;
            ...
            m_typeTab.Text = "Type";
            m_typeControl = new CyTypeControl(isGen4);
            ...
            m_generalControl = new CyGeneralControl(isM0S8);
            ...
            m_inputControl = new CyInputControl(isM0S8);
