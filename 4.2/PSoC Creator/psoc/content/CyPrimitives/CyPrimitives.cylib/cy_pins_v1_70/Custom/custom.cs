...
using Cypress.Comps.PinsAndPorts.Common_v1_70;
using Cypress.Comps.PinsAndPorts.cy_pins_v1_70;

namespace Cypress.Comps.PinsAndPorts.cy_pins_v1_70
{
        ...
        ICyParamEditHook_v1
    {
        ...
        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery, ICyExpressMgr_v1 mgr)
        {
            ...
            CyPinsControl pinsControl = new CyPinsControl(edit, edit.DeviceQuery.IsPSoC4, edit.DeviceQuery.IsTSG4);
            ...
            bool isPorSettable = !edit.DeviceQuery.IsTSG4 &&
            ...
            ICyTerminalEdit_v1 termEdit)
        {
            ...
            if (displayAsBus && isHomogeneous)
            {
                err = drawer.DrawAsBus(isHomogeneous, numPins, sioGroupCnt, usesInterrupts,
                    pinTypes, sioInfoData, sioRefSelData, displayInputsData, displayOutputsData, showAnnotData);
            }
            else
            {
        ...
        class CyPinsDrawer
        {
            ...
            public CyCustErr DrawSWOnly()
            {
                ...
                RectangleF bodyBounds = DrawPinBody(reservedLoc, true);
                ...
                CyStringArrayParamData showAnnotData)
            {
                ...
                err = GetDrawAsSinglePin(isHomogeneous, false, width, usesInterrupts, pinTypes,
                    sioInfos, sioRefSels, showAnnotData, out drawAsSinglePin);
                if (err.IsNotOk) return err;
            ...
            /// <returns></returns>
            CyCustErr GetDrawAsSinglePin(bool isHomogeneous, bool drawAsBus,
                ...
                CyStringArrayParamData showAnnotData, out bool drawAsSinglePin)
            {
                CyCustErr err;
            ...
            private CyCustErr CalculateAndDrawAnnotation(PointF reservedLoc, CyPinTypeData pinTypeData, int indexOfLeftMostBit, int width, out bool annotationClobbersName)
            {
                ...
                termIsOnLeft = (numTermsOnLeft <= numTermsOnRight);
                termRow = termIsOnLeft ? numTermsOnLeft : numTermsOnRight;
                annotationClobbersName = (termRow == 0);

                err = DrawAnnotation(reservedLoc, indexOfLeftMostBit, width, termRow, termIsOnLeft, pinTypeData.SIOVRefUsed);
                return err;
            }
...
namespace Cypress.Comps.PinsAndPorts.Common_v1_70
{
    #region Constants
        ...
        ICyDesignClient_v2
    {
        ...
        public static CyCustErr GetParamValue<T>(ICyInstQuery_v1 query, string paramName, out T value)
        {
            ...
            if (param == null)
            {
                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnknownParam, paramName));
            }
            ...
            int index, out bool isSIO)
        {
            ...
            switch (thresholdLevelValue)
            {
                ...
                default:
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledThreshold, thresholdLevelValue));
            }
        ...
        public virtual CyExprEvalFunc GetFunction(string exprFuncName)
        {
            switch (exprFuncName)
            {
                ...
                case "CreateOutputEnableConnVisibleBitVector":
                    return new CyExprEvalFunc(CreateOutputEnableConnVisibleBitVector);
        ...
        {
            return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.CustFunctError, errorParam, functName, errorMsg));
        }
        ...
        object CreateSIOInfoCSV(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            if (args.Length != 7)
            {
                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.ParamCntErr_CreateSIOInfoCVS, exprFuncName));
            }
            else
            {
                CyCustErr err;
                ...
                for (int i = 0; i < width; i++)
                {
                    ...
                    if (isSIO)
                    {
                        ...
                        switch (sioGroupValue)
                        {
                            ...
                            default:
                                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledSIOGroup, sioGroupValue));
                        }
                    }
                    else
                    {
        ...
        object CreateHysteresisCSV(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            if (args.Length != 4)
            {
                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.ParamCntErr_CreateHysteresisCSV, exprFuncName));
            }
            else
            {
                ...
                for (int i = 0; i < width; i++)
                {
                    ...
                    switch (sioInfoType)
                    {
                        ...
                        default:
                            return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledSIOInfo, sioInfoType));
                    }
                    ...
                    if (threshold != null)
                    {
                        switch (threshold)
                        {
                            ...
                            default:
                                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledThreshold, threshold));
                        }
                    }
                    else
                    {
        ...
        object CreateVTripCSV(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            if (args.Length != 3)
            {
                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.ParamCntErr_CreateVTripCSV, exprFuncName));
            }
            else
            {
        ...
        object CreateSIOVTripBitVector(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            if (args.Length != 4)
            {
                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.ParamCntErr_CreateSIOVTripBitVector, exprFuncName));
            }
            else
            {
                List<string> vtripValues = new List<string>();
        ...
        object CreateSIORefSelCSV(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            if (args.Length != 5)
            {
                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.ParamCntErr_CreateSIORefSelCSV, exprFuncName));
            }
            else
            {
        ...
        CyCustErr _vrefUsed(string outputDriveLevel, string thresholdLevel, out bool vrefUsed)
        {
            ...
            switch (outputDriveLevel)
            {
                ...
                default:
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledOutputDriveLevel, outputDriveLevel));
            }
            ...
            switch (thresholdLevel)
            {
                ...
                default:
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledThreshold, thresholdLevel));
            }
        ...
        object CreateOutputBufferBitVector(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            if (args.Length != 4)
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateOutputBufferBitVector, exprFuncName));
            }
            else
            {
                ...
                for (int i = 0; i < width; i++)
                {
                    ...
                    if (outputDriveLevelFirst != null)
                    {
                        switch (outputDriveLevel)
                        {
                            ...
                            default:
                                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledOutputDriveLevel,
                                    outputDriveLevel));
                        }
                    }
                }
        ...
        object CreateInputBufferBitVector(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateInputBufferBitVector, exprFuncName));
            }
            else
            {
        ...
        object CalculateSIOGroupCount(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CalculateSIOGroupCount, exprFuncName));
            }
            else
            {
                CyCustErr err;
                ...
                for (int i = 0; i < width; i++)
                {
                    ...
                    switch (sioInfoValue)
                    {
                        ...
                        default:
                            return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledSIOInfo, sioInfoValue));
                    }
                }
                return sioGroupCnt;
            }
        ...
        object CreatePinModeString(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreatePinModeString, exprFuncName));
            }
            else
            {
                CyCustErr err;
                ...
                for (int i = 0; i < width; i++)
                {
                    ...
                    {
                        return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledPinType, pinType));
                    }
                }
        ...
        object UsesInterrupts(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_UsesInterrupts, exprFuncName));
            }
            else
            {
                CyCustErr err;
        ...
        object IsHomogeneous_v2(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            if (args.Length != 7)
            {
                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.ParamCntErr_IsHomogeneous_v2, exprFuncName));
            }
            else
            {
                CyCustErr err;
                ...
                if (width > 1)
                {
                    for (int i = 0; i < width - 1; i++)
                    {
                        ...
                        switch (sioInfo1)
                        {
                            ...
                            default:
                                return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledSIOInfo, sioInfo1));
                        }
                    }
                }
        ...
        object CreateDriveModesCSV(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateDriveModesCSV, exprFuncName));
            }
            else
            {
                CyCustErr err;
        ...
        object CreateInputBufferesEnabledCSV(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateInputBufferesEnabledCSV, exprFuncName));
            }
            else
            {
                CyCustErr err;
        ...
        object CreateInitialDriveStatesCSV(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateInitialDriveStatesCSV, exprFuncName));
            }
            else
            {
                CyCustErr err;
        ...
        object CreateCSVFromBitVector(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateCSVFromBitVector, exprFuncName));
            }
            else
            {
                CyCustErr err;
        ...
        object CreateCSVFromInputOnlyBitVector(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateCSVFromInputOnlyBitVector, exprFuncName));
            }
            else
            {
                CyCustErr err;
        ...
        object CreateCSVFromOutputOnlyBitVector(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateCSVFromOutputOnlyBitVector, exprFuncName));
            }
            else
            {
                CyCustErr err;
        ...
        object CreateIOVoltagesCSV(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateIOVoltagesCSV, exprFuncName));
            }
            else
            {
                CyCustErr err;
        ...
        object CreatePinAliasesCSV(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreatePinAliasesCSV, exprFuncName));
            }
            else
            {
                CyCustErr err;
        ...
        object CreateOutputConnVisibleBitVector(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateOutputConnVisibleBitVector, exprFuncName));
            }
            else
            {
        ...
        object CreateOutputEnableConnVisibleBitVector(string exprFuncName, object[] args, ICyExprTypeConverter typeConverter)
        {
            ...
            {
                return new CyCustErr(string.Format(
                    cy_pins_v1_70.Resource1.ParamCntErr_CreateOutputEnableConnVisibleBitVector, exprFuncName));
            }
            else
            {
        ...
        public CyCustErr CustomizeVerilog(ICyInstQuery_v1 query, ICyTerminalQuery_v1 termQuery, out string codeSnippet)
        {
            ...
            foreach (string paramName in query.GetParamNames())
            {
                ...
                {
                    CyStringArrayParamData data;
                    err = CyStringArrayParamData.CreateStringArrayData(query, CyParamInfo.Formal_ParamName_ShowAnnotationTerm, out data);
                    byte width = numPins;
        ...
        private void CheckCannotBeResistivePullAndVrefOut(ICyInstValidate_v1 instVal, byte numPins)
        {
        ...
        private void CheckNotAnalogGen4(ICyInstValidate_v1 instVal, byte numPins)
        {
            CyStringArrayParamData pinTypesData;
                ...
                for (int i = 0; i < numPins; i++)
                {
                        ...
                        pinType == CyPortConstants.PinTypesValue_DIGOUT_OE_DIGIN_ANALOG)
                    {
                        instVal.AddError(CyParamInfo.Formal_ParamName_PinTypes,
                           new CyCustErr(String.Format(cy_pins_v1_70.Resource1.Err_Gen4_Analog, i)));
        ...
        private void CheckPORM0S8(ICyInstValidate_v1 instVal)
        {
            int porValue;
            CyCustErr err = CyPortCustomizer.GetParamValue<int>(instVal, CyParamInfo.Formal_ParamName_PowerOnReset, out porValue);
            if (porValue != CyParamInfo.PORValue_HiZAnalog && porValue != CyParamInfo.PORValue_Unspecified)
            {
                instVal.AddError(CyParamInfo.Formal_ParamName_PowerOnReset,
                                   new CyCustErr(cy_pins_v1_70.Resource1.Err_M0S8_Invalid_POR));
            }
        }

        private void CheckSlewRateSameIfContiguousM0S8(ICyInstValidate_v1 instVal, byte numPins)
        {
            if (numPins > 1)
            {
                CyCustErr err;
                            ...
                            for (; pinNum < numPins; pinNum++)
                            {
                                ...
                                if (firstSlewRate != currSlewRate)
                                {
                                    instVal.AddError(CyParamInfo.Formal_ParamName_SlewRate,
                                        new CyCustErr(cy_pins_v1_70.Resource1.Err_M0S8_SlewRateContiguousMismatch));
        ...
        private void CheckInputThresholdSameIfContiguous(ICyInstValidate_v1 instVal, byte numPins)
        {
            if (numPins > 1)
            {
                CyCustErr err;
                ...
                if (err.IsOk)
                {
                    ...
                    out pinTypesData);
                        if (err.IsOk)
                        {
                            ...
                            int pinNum = 0;
                            while (!CyPortConstants.IsInput(pinTypesData.GetValue(pinNum)) && !CyPortConstants.IsBidir(pinTypesData.GetValue(pinNum)))
                            {
                                pinNum++;
                            ...
                            for (; pinNum < numPins; pinNum++)
                            {
                                ...
                                if (firstThreshold == currThreshold)
                                {
                                    continue;
                                }
                                    ...
                                    currThreshold == CyPortConstants.ThresholdLevelValue_VREF_HYST))
                                {
                                    ...
                                    instVal.AddError(CyParamInfo.Formal_ParamName_ThresholdLevels,
                                        new CyCustErr(cy_pins_v1_70.Resource1.Err_ThresholdContiguousMismatch));
                                    instVal.AddError(CyParamInfo.Formal_ParamName_LayoutMode,
                                        new CyCustErr(cy_pins_v1_70.Resource1.Err_ThresholdContiguousMismatch));
                                    break;
                                }
                ...
                if (err.IsOk)
                {
                    for (int i = 0; i < numPins; i++)
                    {
                        ...
                        switch (sioInfo)
                        {
                                            ...
                                            case CyPortConstants.ThresholdLevelValue_LVTTL:
                                                if (threshold1 != threshold2)
                                                {
                                                    instVal.AddError(CyParamInfo.Formal_ParamName_ThresholdLevels,
                                                        ...
                                                        cy_pins_v1_70.Resource1.Err_SIOPairInputsDontMatch, i)));
                                                    instVal.AddError(CyParamInfo.Formal_ParamName_ThresholdLevels,
                                                        new CyCustErr(string.Format(
                                                        cy_pins_v1_70.Resource1.Err_SIOPairInputsDontMatch, i + 1)));
                                                }
                                                break;
                                ...
                                if (CyPortConstants.IsOutput(pinType1) && CyPortConstants.IsOutput(pinType2))
                                {
                                    ...
                                    if (err.IsOk)
                                    {
                                        ...
                                        if (driveLevel1 != driveLevel2)
                                        {
                                            instVal.AddError(CyParamInfo.Formal_ParamName_OutputDriveLevels,
                                                        new CyCustErr(string.Format(
                                                        cy_pins_v1_70.Resource1.Err_SIOPairOutputsDontMatch, i)));
                                            instVal.AddError(CyParamInfo.Formal_ParamName_OutputDriveLevels,
                                                new CyCustErr(string.Format(
                                                cy_pins_v1_70.Resource1.Err_SIOPairOutputsDontMatch, i + 1)));
                                        }
                                    }
                                }
                                break;
                            ...
                            default:
                                Debug.Fail(string.Format(cy_pins_v1_70.Resource1.UnhandledSIOInfo, sioInfo));
                                break;
                        }
                    }
                }
                    ...
                    if (err.IsOk)
                    {
                        for (int i = 0; i < numPins; i++)
                        {
                                ...
                                pinType == CyPortConstants.PinTypesValue_DIGOUT_OE_DIGIN_ANALOG)
                            {
                                instVal.AddError(CyParamInfo.Formal_ParamName_PinTypes,
                                   new CyCustErr(string.Format(
                                       cy_pins_v1_70.Resource1.Err_CannotBeContiguousAndAnalog, i)));
                    ...
                    for (int i = 0; i < numPins; i++)
                    {
                        ...
                        if (runOfSingleSIOs == 2 && foundPair)
                        {
                            instVal.AddError(CyParamInfo.Formal_ParamName_SIOGroups,
                                new CyCustErr(cy_pins_v1_70.Resource1.Err_TooManySingleSIONextToSIOPair));
                            instVal.AddError(CyParamInfo.Formal_ParamName_LayoutMode,
                               new CyCustErr(cy_pins_v1_70.Resource1.Err_TooManySingleSIONextToSIOPair));
                        }
                        ...
                        {
                            instVal.AddError(CyParamInfo.Formal_ParamName_SIOGroups,
                                new CyCustErr(cy_pins_v1_70.Resource1.Err_TooManySingleSIOInARow));
                            instVal.AddError(CyParamInfo.Formal_ParamName_LayoutMode,
                                new CyCustErr(cy_pins_v1_70.Resource1.Err_TooManySingleSIOInARow));
                            break;
                        }
            ...
            for (int i = 0; i < numPins; i++)
            {
                    ...
                    (CyPortConstants.IsInput(pinTypesData.GetValue(i)) || CyPortConstants.IsBidir(pinTypesData.GetValue(i))))
                {
                    instVal.AddError(CyParamInfo.Formal_ParamName_InputBuffersEnabled,
                        new CyCustErr(string.Format(
                            cy_pins_v1_70.Resource1.Err_CannotEnableIBufAndAnalogHiZ, i)));
                ...
                for (int i = 0; i < numPins; i++)
                {
                    ...
                    if (err.IsOk)
                    {
                        ...
                        if (isSIO && (pinType == CyPortConstants.PinTypesValue_ANALOG ||
                            ...
                            pinType == CyPortConstants.PinTypesValue_DIGOUT_OE_DIGIN_ANALOG))
                        {
                            string errMsg = string.Format(cy_pins_v1_70.Resource1.Err_CannotUseAnalogAndSIO, i);
                        ...
                        {
                            string errMsg = string.Format(cy_pins_v1_70.Resource1.Err_CannotUseLVTTLAndSIO, i);
        ...
        public CyCustErr GetPinType(ICyInstQuery_v1 instQuery, int index, out CyPinDataPinType_v1 pinType)
        {
            ...
            switch (pinTypeString)
            {
                ...
                default:
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledPinType, pinTypeString));
            }
        }
        ...
        public CyCustErr GetSIOInfo(ICyInstQuery_v1 instQuery, int index, out CyPinDataSIOType_v1 sioInfo)
        {
            ...
            switch (sioInfoString)
            {
                ...
                default:
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledSIOInfo, sioInfoString));
            }
        }
        ...
        public CyCustErr GetInputThreshold(ICyInstQuery_v1 instQuery, int index, out CyPinDataInputThreshold_v1 threshold)
        {
            ...
            switch (thresholdString)
            {
                ...
                default:
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledInputThreshold, thresholdString));
            }
        }
            ...
            out string termName, out int offset)
        {
            ...
            termName = null;
            offset = default(int);
            return new CyCustErr(cy_pins_v1_70.Resource1.TermNotFound);
        }
        ...
        public CyCustErr GetDriveMode(ICyInstQuery_v1 instQuery, int index, out CyPinDataDriveMode_v1 driveMode)
        {
            ...
            switch (driveModeString)
            {
                ...
                default:
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledDriveMode, driveModeString));
            }
        }
        ...
        public CyCustErr GetSlewRate(ICyInstQuery_v1 instQuery, int index, out CyPinDataSlewRate_v1 slewRate)
        {
            ...
            switch (slewRateString)
            {
                ...
                default:
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledSlewRate, slewRateString));
            }
        }
        ...
        string ToString(List<CyPinAssignmentInfo_v1> value)
        {
        ...
        List<CyPinAssignmentInfo_v1> FromString(string value)
        {
            ...
            IEnumerable<CyAPICustomizer> apis)
        {
            ...
            string setDriveModeImplP4ParamName = "SetDriveModeImplP4_API_GEN";
    ...
    class CyTermInfo
    {
        ...
        public static CyCustErr GetExpectedTerminalWidth(ICyInstQuery_v1 query, string rootTermName, out byte numPins)
        {
            ...
            return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnknownTerm, rootTermName));
        }
    ...
    class CyParamInfo
    {
        ...
        public static CyCustErr GetIsContiguousValue(ICyInstQuery_v1 query, out bool isContiguous)
        {
            ...
            switch (mode.ToString())
            {
                ...
                default:
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledLayoutMode, mode));
            }
            return err;
        }
    ...
    internal abstract class CyStringArrayParamData
    {
        ...
        static string GetBitVectorParamDefaultValue(CyBitVectorParam paramType)
        {
            switch (paramType)
            {
                ...
                default:
                    Debug.Fail(string.Format(cy_pins_v1_70.Resource1.UnhandledBitVectorParamType, paramType));
                    return null;
            }
        }
        ...
        static string GetInputOnlyBitVectorParamDefaultValue(CyInputOnlyBitVectorParam paramType)
        {
            switch (paramType)
            {
                ...
                default:
                    Debug.Fail(string.Format(cy_pins_v1_70.Resource1.UnhandledInputOnlyBitVectorParamType, paramType));
                    return null;
            }
        }
        ...
        static string GetOutputOnlyBitVectorParamDefaultValue(CyOutputOnlyBitVectorParam paramType)
        {
            switch (paramType)
            {
                ...
                default:
                    Debug.Fail(string.Format(cy_pins_v1_70.Resource1.UnhandledOutputBitVectorParamType, paramType));
                    return null;
            }
        }
        ...
        public static CyCustErr GetBitVectorParamType(string paramName, out CyBitVectorParam paramType)
        {
            switch (paramName)
            {
                ...
                default:
                    ...
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.UnhandledParamName, paramName));
            }
        }
            ...
            public override CyCustErr ValidateAt(int index)
            {
                ...
                if (value.Length != ExampleValue.Length)
                {
                    return new CyCustErr(
                        string.Format(cy_pins_v1_70.Resource1.Err_BitVectorValueIncorrectLength,
                        index,
                        ExampleValue.Length,
                        value,
                        value.Length));
                ...
                for (int i = 0; i < value.Length; i++)
                {
                    ...
                    {
                        return new CyCustErr(string.Format(
                        cy_pins_v1_70.Resource1.Err_BitVectorValueOnlyOnesAndZeros,
                        index,
                        value[i]));
                    }
                }
                ...
                {
                    return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.Err_BitVectorValueInvalidOption,
                        index, value));
                }
        ...
        class CyInitialDriveStateParamData : CyBitVectorParamData
        {
            ...
            protected override string GetDefaultValue(int index)
            {
                ...
                switch (driveMode)
                {
                    ...
                    default:
                        Debug.Fail(string.Format(cy_pins_v1_70.Resource1.UnhandledDriveMode, driveMode));
                        return string.Format(cy_pins_v1_70.Resource1.UnhandledDriveMode, driveMode);
                }
            }
        }
        ...
        class CyDriveModeParamData : CyBitVectorParamData
        {
            ...
            protected override string GetDefaultValue(int index)
            {
                ...
                switch (pinType)
                {
                    ...
                    default:
                        return string.Format(cy_pins_v1_70.Resource1.UnhandledPinType, pinType);
                }
            }
        }
        ...
        class CyInputBuffersEnabledParamData : CyBitVectorParamData
        {
            ...
            public static string GetDefaultValue(CyStringArrayParamData pinTypes, int index)
            {
                ...
                switch (pinType)
                {
                    ...
                    default:
                        Debug.Fail(string.Format(cy_pins_v1_70.Resource1.UnhandledPinType, pinType));
                        return string.Format(cy_pins_v1_70.Resource1.UnhandledPinType, pinType);
                }
            }
        ...
        internal class CyAliasParamData : CyStringArrayParamData
        {
            ...
            public override CyCustErr ValidateAt(int index)
            {
                ...
                if (string.IsNullOrEmpty(value) == false)
                {
                    ...
                    {
                        return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.Err_NotValidCIdentifier,
                            index, value, msg));
                    }
                }
                return CyCustErr.Ok;
            ...
            public override CyCustErr Validate()
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    if (string.IsNullOrEmpty(val) == false)
                    {
                        ...
                        if (num > 1)
                        {
                            return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.Err_AliasRepeated, val, num));
                        }
                    }
                }
        ...
        public class CyIOVoltagesParamData : CyStringArrayParamData
        {
            ...
            public override CyCustErr ValidateAt(int index)
            {
                    ...
                    CyPortConstants.DefaultIOVolatageValue.Equals(value, StringComparison.OrdinalIgnoreCase) == false)
                {
                    ...
                    if (result == false)
                    {
                        return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.Err_InvalidNumFormat,
                            index, value));
                    }
                    ...
                    if (value.Contains("."))
                    {
                        ...
                        {
                            return new CyCustErr(string.Format(cy_pins_v1_70.Resource1.Err_InvalidIOVoltagePercision,
                                index,
                                value));
                        }
                    }
