...
#define `$INSTANCE_NAME`_INTC_VECTOR            ((reg16 *) `$INSTANCE_NAME`__INTC_VECT)
...
#define `$INSTANCE_NAME`_INTC_SET_EN            ((reg8 *) `$INSTANCE_NAME`__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the `$INSTANCE_NAME` interrupt. */
#define `$INSTANCE_NAME`_INTC_CLR_EN            ((reg8 *) `$INSTANCE_NAME`__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the `$INSTANCE_NAME` interrupt state to pending. */
#define `$INSTANCE_NAME`_INTC_SET_PD            ((reg8 *) `$INSTANCE_NAME`__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the `$INSTANCE_NAME` interrupt. */
#define `$INSTANCE_NAME`_INTC_CLR_PD            ((reg8 *) `$INSTANCE_NAME`__INTC_CLR_PD_REG)
