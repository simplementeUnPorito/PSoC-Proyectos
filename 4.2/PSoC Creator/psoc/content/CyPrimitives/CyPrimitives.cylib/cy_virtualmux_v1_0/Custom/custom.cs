...
namespace Cypress.Semiconductor.CyDesigner.cy_virtualmux_v1_0
{
        ...
        ICyShapeCustomize_v1
    {
            ...
            ICyTerminalEdit_v1 termEdit)
        {
            ...
            // Output terminal
            termEdit.TerminalAdd(GetOutputTermName(terminalWidth), CyCompDevTermDir.OUTPUT,
            ...
            shapeEdit.SetFillColor(MUX_BASE_SHAPE_TAG, Color.PaleGreen);
