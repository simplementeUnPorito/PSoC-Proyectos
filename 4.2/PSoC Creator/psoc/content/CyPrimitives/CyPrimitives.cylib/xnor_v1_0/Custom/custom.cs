...
namespace Cypress.Semiconductor.CyDesigner.xnor_v1_0
{
        ...
        ICyShapeCustomize_v1
    {
            ...
            out string codeSnippet)
        {
            ...
            CyCustErr err = CyGateVerilogBuilder.BuildVerilog(CyGateType.XNOR, termQuery, out generatedCodeSnippet);
        ...
        {
            return CyShapeCustomizer.CustomizeGateShapesWithArcs(query, shapeEdit, termEdit, CyGateType.XNOR);
        }
