...
namespace Cypress.Comps.PinsAndPorts.cy_pins_v1_90
{
    public partial class CyGeneralControl : UserControl
    {
        ...
        public CyGeneralControl(bool isTSG4)
        {
            m_isTSG4 = isTSG4;
            InitializeComponent();
        ...
        void m_driveModeComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //Drive Mode determines input buffer for TSG4
            if (m_isTSG4)
            {
        ...
        public string DriveMode
        {
            ...
            {
                CyDriveMode driveMode = m_driveModeComboBox.SelectedItem as CyDriveMode;
                return driveMode == null ? null : driveMode.ParamValue;
            }
        ...
        public string InitialDriveState
        {
            get
            {
                ...
                return state == null ? null : state.ParamValue;
            }
