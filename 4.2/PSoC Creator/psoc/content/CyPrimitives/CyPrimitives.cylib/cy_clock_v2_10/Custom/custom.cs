...
namespace Cypress.Components.System.cy_clock_v2_10
{
        ...
        ICyAdvClockControlData_v1<ICyInstEdit_v1>
    {
        ...
        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery, ICyExpressMgr_v1 mgr)
        {
            ...
            ICyClockControl_v1 control = design.CreateClockCustomizerControl(this, edit);
            ...
            byte frequencyUnit)
        {
            if (edit != null)
            {
                ...
                bool succeded = edit.CommitParamExprs();
                Debug.Assert(succeded);
            }
        }
