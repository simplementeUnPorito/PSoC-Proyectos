...
namespace Cypress.Comps.PinsAndPorts.cy_pins_v2_0
{
    public partial class CyClockingControl : UserControl, ICyParamEditingControl
    {
        ...
        {
            CyPinData.Key.CLOCK_INPUT,
            CyPinData.Key.CLOCK_INPUT_ENABLE,
            CyPinData.Key.CLOCK_INPUT_ENABLE_ON,
            CyPinData.Key.CLOCK_INPUT_RESET,
            CyPinData.Key.CLOCK_OUTPUT,
            CyPinData.Key.CLOCK_OUTPUT_ENABLE,
            CyPinData.Key.CLOCK_OUTPUT_ENABLE_ON,
            CyPinData.Key.CLOCK_OUTPUT_RESET,
            CyPinData.Key.CLOCK_OUTPUT_RESET_ENABLE,
            CyPinData.Key.CLOCK_OE_RESET_ENABLE,
        };
        ...
        public CyClockingControl(CyDeviceSupport deviceSupport, CyErrorManager errMgr, CyPinData pins)
        {
            ...
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_INPUT, m_errorProvider, m_inClockComboBox);
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_INPUT_ENABLE, m_errorProvider, m_inClockEnComboBox);
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_INPUT_ENABLE_ON, m_errorProvider, m_inEnableModeComboBox);
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_INPUT_RESET, m_errorProvider, m_inResetComboBox);
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_OUTPUT, m_errorProvider, m_outClockComboBox);
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_OUTPUT_ENABLE, m_errorProvider, m_outClockEnComboBox);
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_OUTPUT_ENABLE_ON, m_errorProvider, m_outEnableModeComboBox);
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_OUTPUT_RESET, m_errorProvider, m_outResetComboBox);
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_OUTPUT_RESET_ENABLE, m_errorProvider, m_outputResetCheckBox);
            errMgr.RegisterSettingOwner(CyPinData.Key.CLOCK_OE_RESET_ENABLE, m_errorProvider, m_oeResetCheckBox);
        }
