...
namespace Cypress.Components.Primitives.cy_mux_constraint_v1_50
{
        ...
        ICyToolTipCustomize_v1
    {
        ...
        {
            return m_helper.EditParams(CyGlobalAnalogLocType.MuxConstraint, edit, termQuery, mgr);
        }
        ...
        {
            return m_helper.CustomizeVerilog(CyGlobalAnalogLocType.MuxConstraint, query, termQuery, out codeSnippet);
        }
        ...
        {
            return m_helper.CustomizeShapes(CyGlobalAnalogLocType.MuxConstraint, query, shapeEdit, termEdit);
        }
        ...
        {
            return m_helper.CustomizeToolTip(CyGlobalAnalogLocType.MuxConstraint, query, termQuery);
        }
