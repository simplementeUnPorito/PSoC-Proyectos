...
using CyCustomizer.CyStatusReg_v1_90;
    ...
    public class CyCustomizer : ICyParamEditHook_v1, ICyShapeCustomize_v1
    {
        ...
        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery, ICyExpressMgr_v1 mgr)
        {
            ...
            CyParamExprDelegate ParamCommitted = delegate(ICyParamEditor custEditor, CyCompDevParam comp)
            {
                ...
                if (comp.Name == CyStatusReg_v1_90.StatusRegParameters.NUMINPUTS)
                {
                    int inputs;

                    if(!Int32.TryParse(
                                m_Component.GetCommittedParam(CyStatusReg_v1_90.StatusRegParameters.NUMINPUTS).Value,
                                out inputs))
                    {
                    ...
                    m_Component.SetParamExpr(CyStatusReg_v1_90.StatusRegParameters.BIT0MODE, Resource.TRANSPARENT);
                    m_Component.SetParamExpr(CyStatusReg_v1_90.StatusRegParameters.BIT1MODE, Resource.TRANSPARENT);                         
                    m_Component.SetParamExpr(CyStatusReg_v1_90.StatusRegParameters.BIT2MODE, Resource.TRANSPARENT);
                    m_Component.SetParamExpr(CyStatusReg_v1_90.StatusRegParameters.BIT3MODE, Resource.TRANSPARENT);
                    m_Component.SetParamExpr(CyStatusReg_v1_90.StatusRegParameters.BIT4MODE, Resource.TRANSPARENT);
                    m_Component.SetParamExpr(CyStatusReg_v1_90.StatusRegParameters.BIT5MODE, Resource.TRANSPARENT);
                    m_Component.SetParamExpr(CyStatusReg_v1_90.StatusRegParameters.BIT6MODE, Resource.TRANSPARENT);
                    m_Component.SetParamExpr(CyStatusReg_v1_90.StatusRegParameters.BIT7MODE, Resource.TRANSPARENT);
                }
            };
        ...
        {
            CyCompDevParam busDisplay = instQuery.GetCommittedParam(CyStatusReg_v1_90.StatusRegParameters.BUS);
            int inputs = Convert.ToInt16(
                                    instQuery.GetCommittedParam(CyStatusReg_v1_90.StatusRegParameters.NUMINPUTS).Value);
