...
namespace Cypress.Semiconductor.CyDesigner.nor_v1_0
{
        ...
        ICyShapeCustomize_v1
    {
            ...
            out string codeSnippet)
        {
            ...
            CyCustErr err = CyGateVerilogBuilder.BuildVerilog(CyGateType.NOR, termQuery, out generatedCodeSnippet);
        ...
        {
            return CyShapeCustomizer.CustomizeGateShapesWithArcs(query, shapeEdit, termEdit, CyGateType.NOR);
        }
