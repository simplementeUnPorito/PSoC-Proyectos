...
#define `$INSTANCE_NAME`_DM_ALG_HIZ         (0x00u)
#define `$INSTANCE_NAME`_DM_DIG_HIZ         (0x01u)
#define `$INSTANCE_NAME`_DM_RES_UP          (0x02u)
#define `$INSTANCE_NAME`_DM_RES_DWN         (0x03u)
#define `$INSTANCE_NAME`_DM_OD_LO           (0x04u)
#define `$INSTANCE_NAME`_DM_OD_HI           (0x05u)
#define `$INSTANCE_NAME`_DM_STRONG          (0x06u)
#define `$INSTANCE_NAME`_DM_RES_UPDWN       (0x07u)
