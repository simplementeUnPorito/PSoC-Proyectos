...
namespace Cypress.Comps.PinsAndPorts.cy_pins_v2_10
{
    public partial class CyGeneralControl : UserControl
    {
        ...
        private void UpdateDriveMode()
        {
            ...
            {
                // If we are a digital output and either HW connection and OE are checked, gray out initial state
                // as both Output and OE are controlled by the DSI. 
                bool enableInitialState = !IsDigitalHwOutput && !IsHwOutputEnable;
