...
namespace Cypress.Comps.PinsAndPorts.cy_pins_v2_10
{
    public class CyPinData
    {
        ...
        internal const string SlewRateValue_I2C_HS = "3";
        ...
        internal const string OVTSlewRate_HSLowVDDIO = "10"; // HS <= 3V
        internal const string OVTSlewRate_HSHighVddio = "00"; // HS > 3V
        #endregion
        ...
        public class PerPin
        {
            ...
            public CyInputThreshold InputThreshold
            {
                get
                {
                    ...
                    else
                    {
                        ...
                        {
                            int otherIdx = GetOtherSIOIndex(this);
            ...
            {
                string thresholdValue = ConvertInputThreshold(threshold, hysteresis);
                ...
                get
                {
                    ...
                    else
                    {
                        if(SIOPairID >= 0) // SIO and paired - check the other half
                        {
                            ...
                            {
                                string driveLevelStr = m_getPinSetting(Formal_ParamName_OutputDriveLevels, GetOtherSIOIndex(this), otherType);
            ...
            private static CyOutputSlewRate ConvertSlewRate(string slewRate)
            {
                switch (slewRate)
                {
                    ...
                    case SlewRateValue_I2C_HS:
                        return CyOutputSlewRate.I2CHS;
                    default:
            ...
            {
                return (driveLevel == CyOutputDriveLevel.VREF);
            }
        ...
        public bool SysBuilderInterruptInternal 
        {
            get
            {
                // Don't cache; this can change out from under us, and is only accessed once or twice
                int interruptMode = m_query(Formal_ParamName_TermModeInterrupt).GetValueAs<int>();
                return interruptMode == (int)CyTermMode_v1.Internal;
            }
        }
        ...
        string[] m_sioPaired = null, m_pinAlias = null, m_pinType = null, m_dispInHw = null, m_dispOutHw = null,
            ...
            m_hysteresisMode = null, m_isrMode = null, m_generalHotSwap = null, m_inputBuffer = null, m_inputSync = null, 
            m_inputSyncMode = null, m_slewRate = null, m_driveLevel = null, m_driveCurrent = null, m_outputSync = null, 
            m_outputMode = null, m_outputClockMode = null, m_oeSync = null;
        ...
        private string GetPinSetting(string key, int index, CyPinType pinType)
        {
            ...
            switch (key)
            {
                ...
                case Formal_ParamName_InputsSynchronized:
                    string inputSync = (!m_deviceSupport.IsPSoC4 || m_deviceSupport.HasPortAdapter)
                        ? ParamValue_ENABLED
                        : ParamValue_DISABLED;
        ...
        private void CheckI2CSlewRequirements(ICyErrorHandler errHandler)
        {
            ...
            {
                PerPin pin = m_pins[i];
                if (pin.OutputSlewRate == CyOutputSlewRate.I2CHS || pin.OutputSlewRate == CyOutputSlewRate.I2CFM)
                {
